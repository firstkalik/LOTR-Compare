...
public enum LOTRShields {
    ...
    public String getShieldName() {
        return StatCollector.translateToLocal((String)("lotr.shields." + this.name() + ".name"));
    }

    public String getShieldDesc() {
        return StatCollector.translateToLocal((String)("lotr.shields." + this.name() + ".desc"));
    }
    ...
    public static enum ShieldType {
        ...
        public String getDisplayName() {
            return StatCollector.translateToLocal((String)("lotr.shields.category." + this.name()));
        }
    }
