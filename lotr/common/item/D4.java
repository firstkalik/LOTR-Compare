...
extends LOTRItemBaseRing2 {
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            boolean hasRing = player1.inventory.hasItemStack(itemstack);
            player1.stepHeight = !hasRing ? (player1.onGround && player1.moveForward > 0.0f ? 0.5f : 0.5f) : (player1.onGround && player1.moveForward > 0.0f ? 1.0f : 0.5f);
