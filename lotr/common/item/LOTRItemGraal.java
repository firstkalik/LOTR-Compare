...
extends Item {
    ...
    private void applyPotionEffects(EntityPlayer entityplayer, String potionKey, float strength) {
        if (potionKey.contains("AthelasBrew")) {
            ...
            this.combinePotionEffect(entityplayer, Potion.regeneration, (int)(1200.0f * strength), 0);
            this.combinePotionEffect(entityplayer, Potion.resistance, (int)(2400.0f * strength), 0);
            this.combinePotionEffect(entityplayer, Potion.fireResistance, (int)(2400.0f * strength), 0);
