...
public class LOTRMaterial {
    ...
    public static LOTRMaterial MITHRILD = new LOTRMaterial("MITHRILD").setUses(3500).setDamage(3.0f).setProtection(0.8f).setHarvestLevel(2).setSpeed(7.0f).setEnchantability(8);
    ...
    public static LOTRMaterial GULDUR1 = new LOTRMaterial("GULDUR1").setUses(580).setDamage(3.0f).setProtection(0.7f).setHarvestLevel(2).setSpeed(6.5f).setEnchantability(6).setManFlesh();
    ...
    public static LOTRMaterial GONDOR_MITHRIL = new LOTRMaterial("GONDOR_MITHRIL").setUses(2600).setDamage(3.0f).setProtection(0.8f).setHarvestLevel(3).setSpeed(7.0f).setEnchantability(10);
    ...
    public static void setCraftingItems() {
        ...
        BLUE_DWARVENMITHRIL.setCraftingItems(LOTRMod.dwarfSteel, LOTRMod.mithrilNugget);
        ...
        GULDUR1.setCraftingItems(LOTRMod.orcSteel, LOTRMod.urukSteel);
