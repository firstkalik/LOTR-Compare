...
extends LOTRItemBaseRing2 {
    ...
    protected boolean growBlock(EntityPlayer playerEntity, World world, int targetX, int targetY, int targetZ) {
        ...
        if (targetBlock == LOTRMod.oreMithril) {
            world.setBlock(targetX, targetY, targetZ, LOTRMod.oreMithril2);
            return true;
        }
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            if (entity instanceof EntityLivingBase) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(3, 240, 2));
            }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List list, boolean advanced) {
        list.add(StatCollector.translateToLocal((String)"mining.name"));
