...
public class LOTRItemNPCRespawner
extends Item {
    ...
    private boolean placeSpawnerAt(World world, int i, int j, int k) {
        ...
        double f = 0.1;
        double f1 = 1.0 - f;
        List entities = world.getEntitiesWithinAABB(LOTREntityNPCRespawner.class, AxisAlignedBB.getBoundingBox((double)((double)i + f), (double)((double)j + f), (double)((double)k + f), (double)((double)i + f1), (double)((double)j + f1), (double)((double)k + f1)));
        if (entities.isEmpty()) {
            spawner.setLocationAndAngles((double)i + 0.5, (double)j, (double)k + 0.5, 0.0f, 0.0f);
            double c = 0.01;
