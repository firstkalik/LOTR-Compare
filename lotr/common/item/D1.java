...
import lotr.common.item.LOTRItemBaseRing4;
...
extends LOTRItemBaseRing4 {
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            if (entity instanceof EntityLivingBase) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(5, 240, 2));
            }
            ...
            if (entity instanceof EntityPlayer && (equipped = (player1 = (EntityPlayer)entity).getCurrentEquippedItem()) == itemstack) {
                ...
                high_elf4 = LOTRLevelData.getData((EntityPlayer)entity).getAlignment(LOTRFaction.MORDOR);
            ...
            world.playSoundEffect((double)i + 0.5, (double)j + 0.5, (double)k + 0.5, "lotr:item.pooff", 0.5f, 1.0f);
            ...
            high_elf4 = LOTRLevelData.getData((EntityPlayer)entity).getAlignment(LOTRFaction.GUNDABAD);
            ...
            if (high_elf4 <= -3000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(10, 1200, 0));
            }
            if (high_elf5 <= -3000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(10, 1200, 0));
            }
            if (high_elf6 <= -3000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(10, 1200, 0));
            }
            if (high_elf7 <= -3000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(10, 1200, 0));
            }
            if (high_elf4 <= -10000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(32, 1200, 1));
            }
            if (high_elf5 <= -10000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(32, 1200, 1));
            }
            if (high_elf6 <= -10000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(32, 1200, 1));
            }
            if (high_elf7 <= -10000.0f) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(32, 1200, 1));
            }
            if (high_elf4 >= 500.0f) {
                entity.setFire(2);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List list, boolean advanced) {
        list.add(StatCollector.translateToLocal((String)"power.name"));
