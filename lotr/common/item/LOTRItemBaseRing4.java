...
extends Item {
    ...
    public boolean onDroppedByPlayer(ItemStack itemstack, EntityPlayer player) {
        boolean hasRing;
        if (itemstack.getItem() instanceof LOTRItemBaseRing4 && !(hasRing = player.inventory.hasItemStack(itemstack))) {
