...
extends LOTRItemBaseRing2 {
    ...
    public static int defaultCharges = 150;
    ...
    public ItemStack onEaten(ItemStack srcItemStack, World world, EntityPlayer playerEntity) {
        ...
        if (!(world.isRemote || srcItemStack.hasTagCompound() && srcItemStack.getTagCompound().getBoolean("activated"))) {
            playerEntity.addPotionEffect(new PotionEffect(11, 1200, 1));
            playerEntity.addPotionEffect(new PotionEffect(2, 1200, 0));
            playerEntity.addPotionEffect(new PotionEffect(5, 1200, 1));
            playerEntity.addPotionEffect(new PotionEffect(16, 1200, 0));
