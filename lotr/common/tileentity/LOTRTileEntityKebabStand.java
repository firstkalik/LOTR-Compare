...
public class LOTRTileEntityKebabStand
extends TileEntity
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (this.worldObj.rand.nextInt(4) == 0) {
                ...
                double d1 = (float)this.yCoord + this.worldObj.rand.nextFloat() * 0.2f;
    ...
    private int takeFuelFromBelow() {
        ...
        if (belowTE instanceof IInventory) {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i) {
                ...
                if (itemstack == null || !TileEntityFurnace.isItemFuel((ItemStack)itemstack)) continue;
                int fuel = TileEntityFurnace.getItemBurnTime((ItemStack)itemstack);
                --itemstack.stackSize;
