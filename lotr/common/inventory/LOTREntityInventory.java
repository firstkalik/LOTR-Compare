...
public class LOTREntityInventory
    ...
    public boolean addItemToInventory(ItemStack itemstack) {
        ...
        if (itemstack != null && itemstack.stackSize > 0) {
            for (int i = 0; i < this.getSizeInventory() && itemstack.stackSize > 0; ++i) {
                ...
                if (itemInSlot != null && (itemInSlot.stackSize >= itemInSlot.getMaxStackSize() || !itemstack.isItemEqual(itemInSlot) || !ItemStack.areItemStackTagsEqual((ItemStack)itemInSlot, (ItemStack)itemstack))) continue;
                if (itemInSlot == null) {
