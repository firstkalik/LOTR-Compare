...
@Mod(modid="lotr", name="The Lord of the Rings Mod", version="Update v36.0 for Minecraft 1.7.10", dependencies="required-after:Forge@[10.13.4.1558,);before:Botania;before:DragonAPI;before:TwilightForest", guiFactory="lotr.client.gui.config.LOTRGuiFactory")
public class LOTRMod {
    ...
    /*
     * Opcode count of 16712 triggered aggressive code reduction.  Override with --aggressivesizethreshold.
     */
    @Mod.EventHandler
