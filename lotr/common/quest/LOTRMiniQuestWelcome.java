...
extends LOTRMiniQuest {
    ...
    public String getQuestObjective() {
        if (this.stage == 2) {
            return StatCollector.translateToLocal((String)"lotr.miniquest.welcome.book");
        }
        if (this.stage == 5) {
            KeyBinding keyMenu = LOTRKeyHandler.keyBindingMenu;
            return StatCollector.translateToLocalFormatted((String)"lotr.miniquest.welcome.map", (Object[])new Object[]{GameSettings.getKeyDisplayString((int)keyMenu.getKeyCode())});
        }
        if (this.stage == 8) {
            ...
            return StatCollector.translateToLocalFormatted((String)"lotr.miniquest.welcome.align", (Object[])new Object[]{GameSettings.getKeyDisplayString((int)keyLeft.getKeyCode()), GameSettings.getKeyDisplayString((int)keyRight.getKeyCode())});
        }
        if (this.stage == 9) {
            ...
            return StatCollector.translateToLocalFormatted((String)"lotr.miniquest.welcome.alignRegions", (Object[])new Object[]{GameSettings.getKeyDisplayString((int)keyUp.getKeyCode()), GameSettings.getKeyDisplayString((int)keyDown.getKeyCode())});
        }
        if (this.stage == 11) {
            KeyBinding keyMenu = LOTRKeyHandler.keyBindingMenu;
            return StatCollector.translateToLocalFormatted((String)"lotr.miniquest.welcome.factions", (Object[])new Object[]{GameSettings.getKeyDisplayString((int)keyMenu.getKeyCode())});
        }
        return StatCollector.translateToLocal((String)"lotr.miniquest.welcome.speak");
    }
    ...
    public String getQuestProgressShorthand() {
        return StatCollector.translateToLocalFormatted((String)"lotr.miniquest.progressShort", (Object[])new Object[]{this.stage, 15});
    }
    ...
    public String getQuestFailure() {
        if (this.movedOn) {
            return StatCollector.translateToLocalFormatted((String)"lotr.gui.redBook.mq.diary.movedOn", (Object[])new Object[]{this.entityName});
        }
    ...
    public String getQuestFailureShorthand() {
        if (this.movedOn) {
            return StatCollector.translateToLocal((String)"lotr.gui.redBook.mq.movedOn");
        }
