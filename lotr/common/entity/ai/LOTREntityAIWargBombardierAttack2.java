...
public class LOTREntityAIWargBombardierAttack2
extends EntityAIBase {
    private World worldObj;
    private LOTREntityWargBombardier2 theWarg;
    private EntityLivingBase entityTarget;
    private double moveSpeed;
    private PathEntity entityPathEntity;
    private int randomMoveTick;

    public LOTREntityAIWargBombardierAttack2(LOTREntityWargBombardier2 lotrEntityWargBombardier2, double speed) {
        this.theWarg = lotrEntityWargBombardier2;
        this.worldObj = lotrEntityWargBombardier2.worldObj;
    ...
    private void createWitherExplosion() {
        this.worldObj.createExplosion((Entity)this.theWarg, this.theWarg.posX, this.theWarg.posY, this.theWarg.posZ, (float)(this.theWarg.getBombStrengthLevel() + 1) * 2.0f, true);
        double explosionRadius = (float)(this.theWarg.getBombStrengthLevel() + 1) * 2.0f;
        double effectRadius = explosionRadius + 10.0;
        ...
        int maxEntities = 15;
        entities.parallelStream().limit(maxEntities).forEach(entity -> {
            Random random = new Random();
            int fireDuration = random.nextInt(81) + 80;
