...
public class LOTREntityAIWargBombardierAttack5
extends EntityAIBase {
    private World worldObj;
    private LOTREntitySpiderBase3 theWarg;
    private EntityLivingBase entityTarget;
    private double moveSpeed;
    private PathEntity entityPathEntity;
    private int randomMoveTick;

    public LOTREntityAIWargBombardierAttack5(LOTREntitySpiderBase3 lotrEntitySpiderBase3, double speed) {
        this.theWarg = lotrEntitySpiderBase3;
        this.worldObj = lotrEntitySpiderBase3.worldObj;
