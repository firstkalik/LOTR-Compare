...
import lotr.common.entity.npc.LOTREntityWargBombardier3;
...
public class LOTREntityAIWargBombardierAttack3
extends EntityAIBase {
    private World worldObj;
    private LOTREntityWargBombardier3 theWarg;
    private EntityLivingBase entityTarget;
    private double moveSpeed;
    private PathEntity entityPathEntity;
    private int randomMoveTick;

    public LOTREntityAIWargBombardierAttack3(LOTREntityWargBombardier3 lotrEntityWargBombardier3, double speed) {
        this.theWarg = lotrEntityWargBombardier3;
        this.worldObj = lotrEntityWargBombardier3.worldObj;
