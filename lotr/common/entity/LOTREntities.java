...
public class LOTREntities {
    ...
    public static void registerEntities() {
        ...
        LOTREntities.registerCreature(LOTREntityPolarBear.class, "WhiteBear", 2142, 16381172, 394254);
        ...
        LOTREntities.registerCreature(LOTREntityDurmethOrcWarrior.class, "DurmethOrcWarrior", 2177, 4466722, 8548435);
        LOTREntities.registerCreature(LOTREntityDurmethWarriorBannerBearer.class, "DurmethWarriorBannerBearer", 2178, 4466722, 8548435);
        LOTREntities.registerCreature(LOTREntityDurmethOrcWarriorArcher.class, "DurmethOrcWarriorArcher", 2179, 4466722, 8548435);
        LOTREntities.registerCreature(LOTREntityZebra2.class, "UtumnoHorse", 2180, 15000804, 4340020);
        LOTREntities.registerCreature(LOTREntityZebra3.class, "SkeletonHorse", 2181, 15000804, 4340020);
        LOTREntities.registerCreature(LOTREntityZebra4.class, "ZombieHorse", 2182, 15000804, 4340020);
        LOTREntities.registerCreature(LOTREntityZebra5.class, "NazgulHorse", 2183, 15000804, 4340020);
        LOTREntities.registerCreature(LOTREntityHobbitBounder2.class, "HobbitShirriffPan", 2184, 16752511, 8010275);
        LOTREntities.registerCreature(LOTREntityRadaghast.class, "Radaghast", 2185, 2638384, 15357472);
        LOTREntities.registerCreature(LOTREntityTroll2.class, "TrollMinion", 2186, 10848082, 4796702);
        LOTREntities.registerCreature(LOTREntityMountainTroll2.class, "MountainTroll2", 2187, 10848082, 4796702);
        LOTREntities.registerCreature(LOTREntityFox.class, "Fox", 2188, 12477756, 16381172);
        LOTREntities.registerCreature(LOTREntityFrog.class, "Frog", 2189, 6524974, 12496234);
        LOTREntities.registerCreature(LOTREntityBreeGuardCrossbow.class, "BreeGuardCrossbow", 2190, 9335640, 3681573);
        LOTREntities.registerEntity(LOTREntityThrowingAxe2.class, "ThrowingAxe", 2192, 64, Integer.MAX_VALUE, false);
        LOTREntities.registerCreature(LOTREntityCaveSpider.class, "CaveSpider", 2193, 16376764, 11772801);
        LOTREntities.registerCreature(LOTREntityDragonScout.class, "DragonNimrat", 2194, 2124800, 0);
        LOTREntities.registerCreature(LOTREntityDragonHunter.class, "DragonDraugrit", 2195, 9988352, 0);
        LOTREntities.registerCreature(LOTREntityDragonAlpha.class, "DragonFeldrag", 2196, 9699328, 0);
        LOTREntities.registerCreature(LOTREntityDragonAnkalagon.class, "DragonGorhaul", 2197, 5518, 0);
        LOTREntities.registerCreature(LOTREntityDragonSmaug.class, "DragonSmaug", 2198, 8267264, 15633152);
        LOTREntities.registerEntity(LOTREntityArrowDragon.class, "ArrowDragon", 2199, 64, 20, false);
        LOTREntities.registerCreature(LOTREntityEreborDwarfMerchant.class, "EreborDwarfMerchant", 2200, 2671422, 3289650);
    }
