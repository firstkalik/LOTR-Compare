...
public class LOTREntityDragonScout
extends EntityDragon {
    private Entity target;
    private static final Random RANDOM = new Random();

    public LOTREntityDragonScout(World p_i1700_1_) {
        super(p_i1700_1_);
        this.setSize(4.0f, 2.0f);
        float randomHealth = 400 + RANDOM.nextInt(200);
    ...
    public void onDeath(DamageSource damagesource) {
        ...
        if (damagesource.getEntity() instanceof EntityPlayer) {
            ...
            LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.killDragonScout);
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote) {
            ItemStack[] drops = new ItemStack[]{new ItemStack(LOTRMod.DragonScoutScale), new ItemStack(LOTRMod.DragonTalon), new ItemStack(LOTRMod.magicClover), new ItemStack(LOTRMod.totemOfUndying)};
            int[] amounts = new int[]{1, 2, 1, 1};
