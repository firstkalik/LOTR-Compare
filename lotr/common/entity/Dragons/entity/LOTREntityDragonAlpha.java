...
public class LOTREntityDragonAlpha
extends EntityDragon {
    private Entity target;
    private static final Random RANDOM = new Random();

    public LOTREntityDragonAlpha(World p_i1700_1_) {
        super(p_i1700_1_);
        this.setSize(8.0f, 4.0f);
        float randomHealth = 1500 + RANDOM.nextInt(200);
    ...
    public void onDeath(DamageSource damagesource) {
        ...
        if (damagesource.getEntity() instanceof EntityPlayer) {
            ...
            LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.killDragonAlpha);
    ...
    private void attackEntitiesInList(List<Entity> p_70971_1_) {
        for (int i = 0; i < p_70971_1_.size(); ++i) {
            ...
            entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), damageDealt);
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote) {
            ItemStack[] drops = new ItemStack[]{new ItemStack(LOTRMod.DragonAlphaScale), new ItemStack(LOTRMod.DragonTalon), new ItemStack(LOTRMod.magicClover), new ItemStack(LOTRMod.totemOfUndyingPlus)};
            int[] amounts = new int[]{1, 4, 2, 1};
