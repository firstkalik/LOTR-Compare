...
public class LOTREntityDragonSmaug
extends EntityDragon {
    private Entity target;
    private static final Random RANDOM = new Random();

    public LOTREntityDragonSmaug(World p_i1700_1_) {
        super(p_i1700_1_);
        this.setSize(14.0f, 7.0f);
    ...
    private void setNewTarget() {
        ...
        List list = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, this.boundingBox.copy().expand(50.0, 50.0, 50.0));
        if (list.isEmpty()) {
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote) {
            ...
            ItemStack[] drops = new ItemStack[]{new ItemStack(LOTRMod.DragonTalon), new ItemStack(LOTRMod.magicClover), new ItemStack(LOTRMod.totemOfUndyingPlus)};
            int[] amounts = new int[]{5, 1, 5};
