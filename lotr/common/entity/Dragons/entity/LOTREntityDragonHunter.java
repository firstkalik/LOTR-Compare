...
public class LOTREntityDragonHunter
extends EntityDragon {
    private Entity target;
    private static final Random RANDOM = new Random();

    public LOTREntityDragonHunter(World p_i1700_1_) {
        super(p_i1700_1_);
        this.setSize(8.0f, 4.0f);
        float randomHealth = 800 + RANDOM.nextInt(400);
    ...
    public void onDeath(DamageSource damagesource) {
        ...
        if (damagesource.getEntity() instanceof EntityPlayer) {
            ...
            LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.killDragonHunter);
    ...
    private void attackEntitiesInList(List<Entity> p_70971_1_) {
        for (int i = 0; i < p_70971_1_.size(); ++i) {
            ...
            entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 16.0f);
        }
    }
    ...
    private void collideWithEntities(List<Entity> p_70970_1_) {
        ...
        for (Entity entity : p_70970_1_) {
            ...
            if (!(livingEntity instanceof EntityPlayer && ((EntityPlayer)livingEntity).capabilities.isCreativeMode || (duration = (difficulty = this.worldObj.difficultySetting.getDifficultyId()) * (difficulty + 5) / 2) <= 0 || entity instanceof EntityDragon)) {
                ...
                livingEntity.addPotionEffect(new PotionEffect(LOTRPotions.infection.id, duration * 20, 0));
                entity.setFire(4);
            }
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote) {
            ItemStack[] drops = new ItemStack[]{new ItemStack(LOTRMod.DragonHunterScale), new ItemStack(LOTRMod.DragonTalon), new ItemStack(LOTRMod.magicClover), new ItemStack(LOTRMod.totemOfUndying)};
            int[] amounts = new int[]{1, 4, 1, 1};
