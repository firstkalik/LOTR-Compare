    ...
    public static void loadRegisteredNPCs(FMLPreInitializationEvent event) {
        ...
        try {
            ...
            if (!config.exists()) {
                ...
                BufferedReader bufferedreader = new BufferedReader(new InputStreamReader((InputStream)new BOMInputStream((InputStream)new FileInputStream(config))));
                String s = "";
                while ((s = bufferedreader.readLine()) != null) {
                    ...
                    FMLLog.info((String)("Successfully registered entity " + name + " with the LOTR alignment system as " + line), (Object[])new Object[0]);
                }
