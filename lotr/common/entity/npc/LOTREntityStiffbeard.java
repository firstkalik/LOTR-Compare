    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.hiredNPCInfo.getHiringPlayer() == entityplayer) {
                return "stiffbeard/dwarf/hired";
            }
            return this.isChild() ? "stiffbeard/child/friendly" : "stiffbeard/dwarf/friendly";
        }
        return this.isChild() ? "stiffbeard/child/hostile" : "stiffbeard/dwarf/hostile";
    }
