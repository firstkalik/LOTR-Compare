...
public class LOTREntityDurmethOrcMercenaryCaptain
extends LOTREntityDurmethOrc
implements LOTRUnitTradeable {
    public LOTREntityDurmethOrcMercenaryCaptain(World world) {
        super(world);
    ...
    public LOTRUnitTradeEntries getUnits() {
        return LOTRUnitTradeEntries.DURMETH_ORC_MERCENARY_CAPTAIN;
    }

    @Override
    public LOTRInvasions getConquestHorn() {
        return LOTRInvasions.DURMETH;
    }
    ...
    public void onUnitTrade(EntityPlayer entityplayer) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.tradeDurmethOrc);
    }
    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.canTradeWith(entityplayer)) {
                return "durmeth/chieftain/friendly";
            }
            return "durmeth/chieftain/neutral";
        }
