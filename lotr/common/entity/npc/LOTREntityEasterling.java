...
public class LOTREntityEasterling
extends LOTREntityMan {
    ...
    public LOTREntityEasterling(World world) {
        ...
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIEat(this, LOTRFoods.RHUN, 8000));
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIDrink(this, LOTRFoods.RHUN_DRINK, 8000));
