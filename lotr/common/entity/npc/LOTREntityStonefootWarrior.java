...
public class LOTREntityStonefootWarrior
extends LOTREntityStonefoot {
    public LOTREntityStonefootWarrior(World world) {
        super(world);
        this.npcShield = LOTRShields.ALIGNMENT_OROCARNI;
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        if (this.rand.nextInt(10) != 0) {
            this.setCurrentItemOrArmor(4, new ItemStack(LOTRMod.helmetStonefoot));
        }
        return data;
    }
}
