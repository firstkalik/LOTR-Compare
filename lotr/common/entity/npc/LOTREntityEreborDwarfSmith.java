...
public class LOTREntityEreborDwarfSmith
extends LOTREntityDwarf
implements LOTRTradeable.Smith {
    public LOTREntityEreborDwarfSmith(World world) {
        super(world);
    ...
    public LOTRTradeEntries getBuyPool() {
        return LOTRTradeEntries.EREBOR_SMITH_BUY;
    }

    @Override
    public LOTRTradeEntries getSellPool() {
        return LOTRTradeEntries.EREBOR_SMITH_SELL;
    }
