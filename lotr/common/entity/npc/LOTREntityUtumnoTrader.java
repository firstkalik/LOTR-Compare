...
public class LOTREntityUtumnoTrader
extends LOTREntityAngbandUruc
implements LOTRTradeable.Smith {
    public LOTREntityUtumnoTrader(World world) {
        super(world);
    ...
    public LOTRTradeEntries getBuyPool() {
        return LOTRTradeEntries.ANGBAND_TRADER_BUY;
    }

    @Override
    public LOTRTradeEntries getSellPool() {
        return LOTRTradeEntries.ANGBAND_TRADER_SELL;
    }
