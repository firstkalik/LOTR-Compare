...
extends LOTREntityNPC {
    ...
    public LOTREntityAngbandBalrog(World world) {
        ...
        this.setSize(2.4f * f, 5.0f * f);
        this.getNavigator().setAvoidsWater(true);
        this.tasks.addTask(0, (EntityAIBase)new EntityAISwimming((EntityLiving)this));
        this.tasks.addTask(1, (EntityAIBase)new LOTREntityAIBalrogCharge2(this, 3.0, 20.0f, 200));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue((double)MathHelper.getRandomIntegerInRange((Random)this.rand, (int)120, (int)150));
