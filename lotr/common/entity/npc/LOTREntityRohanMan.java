...
public class LOTREntityRohanMan
extends LOTREntityMan {
    ...
    public LOTREntityRohanMan(World world) {
        ...
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIEat(this, LOTRFoods.ROHAN, 8000));
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIDrink(this, LOTRFoods.ROHAN_DRINK, 8000));
    ...
    public String getNPCFormattedName(String npcName, String entityName) {
        if (this.getClass() == LOTREntityRohanMan.class) {
            return StatCollector.translateToLocalFormatted((String)"entity.lotr.RohanMan.entityName", (Object[])new Object[]{npcName});
        }
