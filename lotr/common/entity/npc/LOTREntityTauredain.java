...
public class LOTREntityTauredain
extends LOTREntityMan {
    public LOTREntityTauredain(World world) {
        ...
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIEat(this, LOTRFoods.TAUREDAIN, 8000));
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIDrink(this, LOTRFoods.TAUREDAIN_DRINK, 8000));
    ...
    public String getNPCFormattedName(String npcName, String entityName) {
        if (this.getClass() == LOTREntityTauredain.class) {
            return StatCollector.translateToLocalFormatted((String)"entity.lotr.Tauredain.entityName", (Object[])new Object[]{npcName});
        }
