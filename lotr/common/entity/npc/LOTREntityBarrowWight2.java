...
extends LOTREntityNPC {
    ...
    protected void dropFewItems(boolean flag, int i) {
        ...
        if (this.rand.nextBoolean()) {
            this.dropChestContents(LOTRChestContents.LOTRChestContents2.BARROW_DOWNS, 1, 2 + i + 1);
        }
    }
