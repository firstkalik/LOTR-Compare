...
public class LOTREntityAvariElfScout
extends LOTREntityAvariElf {
    ...
    public LOTREntityAvariElfScout(World world) {
        super(world);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.setCurrentItemOrArmor(1, new ItemStack(LOTRMod.bootsAvariElfScout));
        this.setCurrentItemOrArmor(2, new ItemStack(LOTRMod.legsAvariElfScout));
        this.setCurrentItemOrArmor(3, new ItemStack(LOTRMod.bodyAvariElfScout));
        if (this.rand.nextInt(10) != 0) {
            this.setCurrentItemOrArmor(4, new ItemStack(LOTRMod.helmetAvariElfScout));
        }
        return data;
    }
