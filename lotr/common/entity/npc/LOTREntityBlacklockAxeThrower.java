...
public class LOTREntityBlacklockAxeThrower
extends LOTREntityBlacklockWarrior {
    public LOTREntityBlacklockAxeThrower(World world) {
        super(world);
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.npcItemsInv.setRangedWeapon(new ItemStack(LOTRMod.throwingAxeRed));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
        ...
        if (axeItem == null) {
            axeItem = new ItemStack(LOTRMod.throwingAxeRed);
        }
