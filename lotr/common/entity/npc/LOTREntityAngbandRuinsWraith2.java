...
public class LOTREntityAngbandRuinsWraith2
extends LOTREntitySkeletalWraith {
    public LOTREntityAngbandRuinsWraith2(World world) {
        super(world);
    }
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue((double)MathHelper.getRandomIntegerInRange((Random)this.rand, (int)30, (int)40));
