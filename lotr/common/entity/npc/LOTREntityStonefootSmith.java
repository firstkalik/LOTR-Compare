...
public class LOTREntityStonefootSmith
extends LOTREntityStonefoot
implements LOTRTradeable.Smith {
    public LOTREntityStonefootSmith(World world) {
        super(world);
    ...
    public LOTRTradeEntries getBuyPool() {
        return LOTRTradeEntries.RED1_SMITH_BUY;
    }

    @Override
    public LOTRTradeEntries getSellPool() {
        return LOTRTradeEntries.RED1_SMITH_SELL;
    }
    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.canTradeWith(entityplayer)) {
                return "stonefoot/smith/friendly";
            }
            return "stonefoot/smith/neutral";
        }
