...
public class LOTREntityBlacklock
    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.hiredNPCInfo.getHiringPlayer() == entityplayer) {
                return "blacklock/dwarf/hired";
            }
            return this.isChild() ? "blacklock/child/friendly" : "blacklock/dwarf/friendly";
        }
        return this.isChild() ? "blacklock/child/hostile" : "blacklock/dwarf/hostile";
    }
