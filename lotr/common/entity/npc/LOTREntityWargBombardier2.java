...
import lotr.common.entity.ai.LOTREntityAIWargBombardierAttack2;
...
public abstract class LOTREntityWargBombardier2
extends LOTREntityWarg {
    public LOTREntityWargBombardier2(World world) {
        super(world);
    }

    @Override
    public EntityAIBase getWargAttackAI() {
        return new LOTREntityAIWargBombardierAttack2(this, 1.7);
    }
