...
import lotr.common.entity.ai.LOTREntityAIOrcAvoidGoodPlayer2;
import lotr.common.entity.ai.LOTREntityAIOrcSkirmish2;
...
public abstract class LOTREntityOrc2
extends LOTREntityNPC {
    ...
    public LOTREntityOrc2(World world) {
        super(world);
        ...
        this.tasks.addTask(3, (EntityAIBase)new LOTREntityAIOrcAvoidGoodPlayer2(this, 8.0f, 1.5));
        ...
        this.targetTasks.addTask(target + 1, (EntityAIBase)new LOTREntityAIOrcSkirmish2(this, true));
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote && this.isOrcSkirmishing()) {
            ...
            } else if (!(this.getAttackTarget() instanceof LOTREntityOrc2)) {
