...
public class LOTREntityStonefootCap
extends LOTREntityStonefootWarrior
implements LOTRUnitTradeable {
    public LOTREntityStonefootCap(World world) {
        super(world);
    ...
    public LOTRUnitTradeEntries getUnits() {
        return LOTRUnitTradeEntries.RED_STONEFOOT;
    }

    @Override
    public LOTRInvasions getConquestHorn() {
        return LOTRInvasions.STONEFOOT;
    }
    ...
    public void onUnitTrade(EntityPlayer entityplayer) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.tradeStonefoot);
    }
    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.canTradeWith(entityplayer)) {
                return "stonefoot/commander/friendly";
            }
            return "stonefoot/commander/neutral";
        }
        return "stonefoot/dwarf/hostile";
    }
}
