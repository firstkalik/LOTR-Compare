...
public class LOTREntityEasterlingLevyman
extends LOTREntityEasterling {
    ...
    private static ItemStack[] levyBodies = new ItemStack[]{new ItemStack((Item)Items.leather_chestplate), new ItemStack(LOTRMod.bodyBronze)};
    private static ItemStack[] levyLegs = new ItemStack[]{new ItemStack((Item)Items.leather_leggings), new ItemStack(LOTRMod.legsBronze)};
    private static ItemStack[] levyBoots = new ItemStack[]{new ItemStack((Item)Items.leather_boots), new ItemStack(LOTRMod.bootsBronze)};
