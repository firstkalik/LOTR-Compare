...
public class LOTREntityDolGuldurUrukArcher
extends LOTREntityDolGuldurUruk {
    public LOTREntityDolGuldurUrukArcher(World world) {
        super(world);
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.npcItemsInv.setRangedWeapon(new ItemStack(LOTRMod.DolGuldurUrukBow));
