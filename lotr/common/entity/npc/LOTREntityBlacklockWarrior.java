...
public class LOTREntityBlacklockWarrior
extends LOTREntityBlacklock {
    public LOTREntityBlacklockWarrior(World world) {
        super(world);
        this.npcShield = LOTRShields.ALIGNMENT_RED_MOUNTAINS1;
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        if (this.rand.nextInt(10) != 0) {
            this.setCurrentItemOrArmor(4, new ItemStack(LOTRMod.helmetBlacklock));
        }
        return data;
    }
}
