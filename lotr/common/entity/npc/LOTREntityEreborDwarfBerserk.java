...
public class LOTREntityEreborDwarfBerserk
extends LOTREntityEreborDwarfWarrior {
    public static float BERSERKER_SCALE = 1.03f;

    public LOTREntityEreborDwarfBerserk(World world) {
        super(world);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.setCurrentItemOrArmor(4, new ItemStack(LOTRMod.helmetEreborGold));
        return data;
    }
}
