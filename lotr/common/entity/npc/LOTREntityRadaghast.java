...
implements LOTRTravellingTrader {
    ...
    public void setupNPCName() {
        this.familyInfo.setName(LOTRNames.getBrownMagName(this.rand, this.familyInfo.isMale()));
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.setCurrentItemOrArmor(1, new ItemStack(LOTRMod.radagasthat));
        this.setCurrentItemOrArmor(2, new ItemStack(LOTRMod.radagastlegs));
        this.setCurrentItemOrArmor(3, new ItemStack(LOTRMod.radagastbody));
        this.setCurrentItemOrArmor(4, new ItemStack(LOTRMod.radagastboots));
        return data;
    }
    ...
    public ItemStack getHeldItemLeft() {
        ...
        if (heldItem != null && heldItem.getItem() == LOTRMod.daggerWoodElvenPoisoned) {
    ...
    public void onPlayerTrade(EntityPlayer entityplayer, LOTRTradeEntries.TradeType type, ItemStack itemstack) {
        ...
        if (type == LOTRTradeEntries.TradeType.SELL && itemstack.getItem() == Item.getItemFromBlock((Block)Blocks.red_mushroom) && itemstack.getItemDamage() == 0) {
