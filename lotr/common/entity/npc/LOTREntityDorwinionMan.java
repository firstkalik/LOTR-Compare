...
public class LOTREntityDorwinionMan
extends LOTREntityMan {
    public LOTREntityDorwinionMan(World world) {
        ...
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIEat(this, LOTRFoods.DORWINION, 8000));
        this.tasks.addTask(6, (EntityAIBase)new LOTREntityAIDrink(this, LOTRFoods.DORWINION_DRINK, 8000));
    ...
    public String getNPCFormattedName(String npcName, String entityName) {
        if (this.getClass() == LOTREntityDorwinionMan.class) {
            return StatCollector.translateToLocalFormatted((String)"entity.lotr.DorwinionMan.entityName", (Object[])new Object[]{npcName});
        }
