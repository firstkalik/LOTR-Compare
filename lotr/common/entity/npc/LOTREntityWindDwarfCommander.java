...
public class LOTREntityWindDwarfCommander
...
implements LOTRUnitTradeable {
    ...
    public LOTRUnitTradeEntries getUnits() {
        return LOTRUnitTradeEntries.WIND_COMMANDER;
    }

    @Override
    public LOTRInvasions getConquestHorn() {
        return LOTRInvasions.WIND;
    }
    ...
    public void onUnitTrade(EntityPlayer entityplayer) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.hireWind);
    }
    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.canTradeWith(entityplayer)) {
                return "wind/commander/friendly";
            }
            return "wind/commander/neutral";
        }
        return "wind/dwarf/hostile";
    }
}
