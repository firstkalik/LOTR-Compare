...
public class LOTREntityBanditDwarf
extends LOTREntityDwarf
implements IBandit {
    private static ItemStack[] weapons = new ItemStack[]{new ItemStack(LOTRMod.daggerWickedDwarf), new ItemStack(LOTRMod.daggerWickedDwarfPoisoned)};
    private LOTRInventoryNPC banditInventory = IBandit.Helper.createInv(this);

    public LOTREntityBanditDwarf(World world) {
        super(world);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue((double)MathHelper.getRandomIntegerInRange((Random)this.rand, (int)26, (int)30));
    ...
    protected LOTRChestContents getLarderDrops() {
        return LOTRChestContents.LOTRChestContents2.BANDITDWARF;
    }
