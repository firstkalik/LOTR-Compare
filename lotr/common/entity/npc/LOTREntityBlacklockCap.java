...
public class LOTREntityBlacklockCap
extends LOTREntityBlacklockWarrior
implements LOTRUnitTradeable {
    public LOTREntityBlacklockCap(World world) {
        super(world);
    ...
    public LOTRUnitTradeEntries getUnits() {
        return LOTRUnitTradeEntries.RED_BLACKLOCK;
    }

    @Override
    public LOTRInvasions getConquestHorn() {
        return LOTRInvasions.BLACKLOCK;
    }
    ...
    public void onUnitTrade(EntityPlayer entityplayer) {
        LOTRLevelData.getData(entityplayer).addAchievement(LOTRAchievement.tradeBlacklock);
    }
    ...
    public String getSpeechBank(EntityPlayer entityplayer) {
        if (this.isFriendly(entityplayer)) {
            if (this.canTradeWith(entityplayer)) {
                return "blacklock/commander/friendly";
            }
            return "blacklock/commander/neutral";
        }
