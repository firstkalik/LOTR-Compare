...
public class LOTREntityAngmarHillmanBerserker
extends LOTREntityAngmarHillmanWarrior {
    public LOTREntityAngmarHillmanBerserker(World world) {
        super(world);
        this.npcShield = null;
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        this.rand.nextInt(2);
        this.npcItemsInv.setMeleeWeapon(new ItemStack(DRRegistry.battleaxe_rhudaur));
        ...
        this.setCurrentItemOrArmor(4, new ItemStack(DRRegistry.helmet_rhudaur));
        return data;
    }
}
