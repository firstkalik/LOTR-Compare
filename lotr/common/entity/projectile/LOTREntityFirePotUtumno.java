...
public class LOTREntityFirePotUtumno
extends EntityThrowable {
    public LOTREntityFirePotUtumno(World world) {
        super(world);
    }

    public LOTREntityFirePotUtumno(World world, EntityLivingBase entityliving) {
        super(world, entityliving);
    }

    public LOTREntityFirePotUtumno(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
    }
