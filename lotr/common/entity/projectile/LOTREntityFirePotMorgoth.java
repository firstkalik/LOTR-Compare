...
public class LOTREntityFirePotMorgoth
extends EntityThrowable {
    public LOTREntityFirePotMorgoth(World world) {
        super(world);
    }

    public LOTREntityFirePotMorgoth(World world, EntityLivingBase entityliving) {
        super(world, entityliving);
    }

    public LOTREntityFirePotMorgoth(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
    }
    ...
    protected void onImpact(MovingObjectPosition m) {
        if (!this.worldObj.isRemote) {
            ...
            for (Object obj : entities) {
                ...
                int fire = 4 + this.rand.nextInt(3);
                if (entity == hitEntity) {
                    fire += 4 + this.rand.nextInt(3);
                }
                entity.setFire(fire);
            }
