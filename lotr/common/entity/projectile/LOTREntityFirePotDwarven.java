...
public class LOTREntityFirePotDwarven
extends EntityThrowable {
    public LOTREntityFirePotDwarven(World world) {
        super(world);
    }

    public LOTREntityFirePotDwarven(World world, EntityLivingBase entityliving) {
        super(world, entityliving);
    }

    public LOTREntityFirePotDwarven(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
    }
