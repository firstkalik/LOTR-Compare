...
public class LOTREntityPebble2
extends EntityThrowable {
    private boolean isSling = false;

    public LOTREntityPebble2(World world) {
        super(world);
    }

    public LOTREntityPebble2(World world, EntityLivingBase entityliving) {
        super(world, entityliving);
    }

    public LOTREntityPebble2(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
    }

    public LOTREntityPebble2 setSling() {
        this.isSling = true;
        return this;
    }
    ...
    protected void onImpact(MovingObjectPosition m) {
        if (m.entityHit != null) {
            float damage = this.isSling ? 4.0f : 1.0f;
