...
public class LOTREntityThrowingAxe2
extends LOTREntityProjectileBase {
    private int axeRotation;

    public LOTREntityThrowingAxe2(World world) {
        super(world);
    }

    public LOTREntityThrowingAxe2(World world, ItemStack item, double d, double d1, double d2) {
        super(world, item, d, d1, d2);
    }

    public LOTREntityThrowingAxe2(World world, EntityLivingBase entityliving, ItemStack item, float charge) {
        super(world, entityliving, item, charge);
    }

    public LOTREntityThrowingAxe2(World world, EntityLivingBase entityliving, EntityLivingBase target, ItemStack item, float charge, float inaccuracy) {
