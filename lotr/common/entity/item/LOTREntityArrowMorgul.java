...
public class LOTREntityArrowMorgul
extends EntityArrow
implements IEntityAdditionalSpawnData {
    protected boolean isInGround = false;

    public LOTREntityArrowMorgul(World world) {
        super(world);
    }

    public LOTREntityArrowMorgul(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
    }

    public LOTREntityArrowMorgul(World world, EntityLivingBase shooter, EntityLivingBase target, float charge, float inaccuracy) {
        super(world, shooter, target, charge, inaccuracy);
    }

    public LOTREntityArrowMorgul(World world, EntityLivingBase shooter, float charge) {
