...
public class LOTREntityPolarBear
...
LOTRBiomeGenNearHarad.ImmuneToFrost {
    ...
    public IEntitySelector polarBearAttackRange = new IEntitySelector(){

        public boolean isEntityApplicable(Entity entity) {
            return entity instanceof EntityLivingBase && entity.isEntityAlive() && LOTREntityPolarBear.this.getDistanceSqToEntity(entity) < 16.0;
        }
    };

    public LOTREntityPolarBear(World world) {
        super(world);
        ...
        this.targetTasks.addTask(1, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, LOTREntityFox.class, 0, true, false, this.polarBearAttackRange));
        this.targetTasks.addTask(1, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, LOTREntityFish.class, 0, true, false, this.polarBearAttackRange));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(6.0);
    }
    ...
    protected void dropFewItems(boolean flag, int i) {
        ...
        for (l = 0; l < furs; ++l) {
            this.dropItem(LOTRMod.blubber, 1);
        }
        for (l = 0; l < furs; ++l) {
        ...
        int meat = this.rand.nextInt(2) + this.rand.nextInt(1 + i);
    ...
    public EntityAgeable createChild(EntityAgeable entity) {
        LOTREntityPolarBear mate = (LOTREntityPolarBear)entity;
        LOTREntityPolarBear child = new LOTREntityPolarBear(this.worldObj);
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float f) {
        ...
        if (flag && (attacker = damagesource.getEntity()) instanceof EntityLivingBase) {
            if (this.isChild()) {
                ...
                for (Object obj : list) {
                    LOTREntityPolarBear bear;
                    Entity entity = (Entity)obj;
                    if (!(entity instanceof LOTREntityPolarBear) || (bear = (LOTREntityPolarBear)entity).isChild()) continue;
    ...
    public boolean getCanSpawnHere() {
        ...
        return j > 20 && (blockBelow == Blocks.snow || blockBelow == Blocks.ice);
    }
