...
public class LOTREntityRaccoon
extends LOTREntityAnimalMF
implements LOTRRandomSkinEntity {
    public LOTREntityRaccoon(World world) {
        super(world);
    ...
    public void writeEntityToNBT(NBTTagCompound nbt) {
        ...
        nbt.setBoolean("RaccoonMale", this.isMale());
    }

    public void readEntityFromNBT(NBTTagCompound nbt) {
        super.readEntityFromNBT(nbt);
        this.setMale(nbt.getBoolean("RaccoonMale"));
    }
    ...
    public EntityAgeable createChild(EntityAgeable entity) {
        LOTREntityRaccoon raccoon = new LOTREntityRaccoon(this.worldObj);
        raccoon.setMale(this.rand.nextBoolean());
        return raccoon;
    }

    protected void dropFewItems(boolean flag, int i) {
        int hide = this.rand.nextInt(2) + this.rand.nextInt(1 + i);
    ...
    protected String getLivingSound() {
        return "lotr:raccoon.say";
    }

    protected String getHurtSound() {
        return "lotr:raccoon.hurt";
    }

    protected String getDeathSound() {
        return "lotr:raccoon.death";
    }
}
