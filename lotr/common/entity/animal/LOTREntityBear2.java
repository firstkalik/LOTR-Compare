...
LOTRBiomeGenNearHarad.ImmuneToFrost {
    ...
    public LOTREntityBear2(World world) {
        super(world);
    ...
    public EntityAgeable createChild(EntityAgeable entity) {
        LOTREntityBear2 mate = (LOTREntityBear2)entity;
        LOTREntityBear2 child = new LOTREntityBear2(this.worldObj);
    ...
    public boolean attackEntityFrom(DamageSource damagesource, float f) {
        ...
        if (flag && (attacker = damagesource.getEntity()) instanceof EntityLivingBase) {
            if (this.isChild()) {
                ...
                for (Object obj : list) {
                    LOTREntityBear2 bear;
                    Entity entity = (Entity)obj;
                    if (!(entity instanceof LOTREntityBear2) || (bear = (LOTREntityBear2)entity).isChild()) continue;
    ...
    public boolean getCanSpawnHere() {
        ...
        return j > 20 && this.worldObj.getBlock(i, j - 1, k) == Blocks.snow;
    }
