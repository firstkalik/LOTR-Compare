...
public class LOTREnchantmentCombining {
    ...
    public static CombineRecipe getCombinationResult(ItemStack item1, ItemStack item2) {
        ...
        LOTREnchantment mod2;
        if (item1 != null && item2 != null && item1.getItem() instanceof LOTRItemModifierTemplate && item2.getItem() instanceof LOTRItemModifierTemplate && (mod1 = LOTRItemModifierTemplate.getModifier(item1)) == (mod2 = LOTRItemModifierTemplate.getModifier(item2))) {
