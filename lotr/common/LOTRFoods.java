...
public class LOTRFoods {
    ...
    public static LOTRFoods DWARF = new LOTRFoods(new ItemStack[]{new ItemStack(Items.cooked_porkchop), new ItemStack(LOTRMod.baconCooked), new ItemStack(Items.cooked_fished), new ItemStack(Items.cooked_chicken), new ItemStack(Items.cooked_beef), new ItemStack(LOTRMod.muttonCooked), new ItemStack(LOTRMod.gammon), new ItemStack(Items.bread), new ItemStack(LOTRMod.cram), new ItemStack(LOTRMod.cram), new ItemStack(LOTRMod.kham)});
    public static LOTRFoods BLUE_DWARF = new LOTRFoods(new ItemStack[]{new ItemStack(Items.cooked_porkchop), new ItemStack(LOTRMod.kham), new ItemStack(LOTRMod.baconCooked), new ItemStack(Items.cooked_fished), new ItemStack(Items.cooked_chicken), new ItemStack(Items.cooked_beef), new ItemStack(LOTRMod.muttonCooked), new ItemStack(LOTRMod.gammon), new ItemStack(Items.bread)});
    public static LOTRFoods DWARF_DRINK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugKhamBrew), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenTonic)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.MUG_CLAY, LOTRItemMug.Vessel.GOBLET_WOOD, LOTRItemMug.Vessel.HORN);
    public static LOTRFoods EREBOR_DWARF_DRINK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugKhamBrew), new ItemStack(LOTRMod.mugBlueDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenTonic)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.MUG_CLAY, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.GOBLET_GOLD, LOTRItemMug.Vessel.HORN);
    public static LOTRFoods WIND_DRINK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugKhamBrew), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugDwarvenTonic)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.MUG_CLAY, LOTRItemMug.Vessel.GOBLET_WOOD, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.SKULL, LOTRItemMug.Vessel.HORN);
    public static LOTRFoods REDDWARF_DRINK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugRedDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugKhamBrew), new ItemStack(LOTRMod.mugDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenTonic)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.MUG_CLAY, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.HORN);
    public static LOTRFoods REDDWARF_DRINK_BLACLLOCK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugRedDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugKhamBrew), new ItemStack(LOTRMod.mugDwarvenTonic)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.MUG_CLAY, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.GOBLET_GOLD, LOTRItemMug.Vessel.HORN);
    public static LOTRFoods REDDWARF_DRINK_STONEFOOT = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugRedDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenTonic), new ItemStack(LOTRMod.mugDwarvenAle), new ItemStack(LOTRMod.mugKhamBrew), new ItemStack(LOTRMod.mugDwarvenTonic)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.MUG_CLAY, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.GOBLET_GOLD, LOTRItemMug.Vessel.GOBLET_MITHRIL, LOTRItemMug.Vessel.HORN);
    ...
    public static LOTRFoods ORC_DRINK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugOrcDraught), new ItemStack(LOTRMod.mugUrukDraught)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.SKULL, LOTRItemMug.Vessel.SKIN);
    public static LOTRFoods WICKED_DRINK = new LOTRFoods(new ItemStack[]{new ItemStack(LOTRMod.mugOrcDraught), new ItemStack(LOTRMod.mugUrukDraught)}).setDrinkVessels(LOTRItemMug.Vessel.MUG, LOTRItemMug.Vessel.SKULL, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.GOBLET_GOLD, LOTRItemMug.Vessel.SKIN);
    ...
    public LOTRFoods setDrinkVessels(LOTRItemMug.Vessel ... vessels) {
        ...
        this.drinkVesselsPlaceable = !placeable.isEmpty() ? placeable.toArray((T[])new LOTRItemMug.Vessel[0]) : new LOTRItemMug.Vessel[]{LOTRItemMug.Vessel.MUG};
        return this;
    }
