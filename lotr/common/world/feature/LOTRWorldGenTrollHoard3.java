...
public class LOTRWorldGenTrollHoard3
extends WorldGenerator {
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        block0: for (l = 0; l < 64; ++l) {
            ...
            Block treasureBlock = random.nextInt(5) == 0 ? (random.nextBoolean() ? LOTRMod.treasureMithril : LOTRMod.treasureCopper) : (random.nextBoolean() ? LOTRMod.treasureSilver : LOTRMod.treasureGold);
        ...
        for (l = 0; l < 48; ++l) {
            ...
            if (j1 > maxCaveHeight || !world.isAirBlock(i1, j1, k1) || world.getBlock(i1, j1 - 1, k1) != Blocks.stone) continue;
            this.setBlockAndNotifyAdequately(world, i1, j1, k1, LOTRMod.chestStone, 0);
            LOTRChestContents.fillChest(world, random, i1, j1, k1, LOTRChestContents.LOTRChestContents2.TROLL_HOARD_MORIA);
