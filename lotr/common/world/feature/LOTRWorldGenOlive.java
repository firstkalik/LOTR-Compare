                ...
                for (j1 = leafStart; j1 <= leafTop; ++j1) {
                    ...
                    for (int i13 = i - leafRange; i13 <= i + this.extraTrunk + leafRange; ++i13) {
                        for (int k13 = k - leafRange; k13 <= k + this.extraTrunk + leafRange; ++k13) {
                            ...
                            if ((dCh = i2 + k2) > 4 || (i2 >= leafRange || k2 >= leafRange) && random.nextInt(3) == 0 || !(block = world.getBlock(i13, j1, k13)).isReplaceable((IBlockAccess)world, i13, j1, k13) && !block.isLeaves((IBlockAccess)world, i13, j1, k13)) continue;
                ...
                if (this.extraTrunk > 0) {
                    for (i1 = i - 1; i1 <= i + this.extraTrunk + 1; ++i1) {
                        for (k1 = k - 1; k1 <= k + this.extraTrunk + 1; ++k1) {
                            ...
                            if (random.nextInt(4) != 0 || i2 != 0 && k2 != 0 || !(block = world.getBlock(i1, j12 = leafStart, k1)).isReplaceable((IBlockAccess)world, i1, j12, k1) && !block.isLeaves((IBlockAccess)world, i1, j12, k1)) continue;
