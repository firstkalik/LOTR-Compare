...
extends WorldGenAbstractTree {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        int height = fullWidth * MathHelper.getRandomIntegerInRange((Random)random, (int)15, (int)20);
        if (fullWidth > 1) {
            height += (fullWidth - 1) * MathHelper.getRandomIntegerInRange((Random)random, (int)0, (int)8);
        }
        boolean flag = true;
        if (j >= 1 && j + height + 1 <= 256) {
            ...
            if (canGrow) {
                ...
                int narrowHeight = -1;
                if (fullWidth > 3) {
                    narrowHeight = j + (int)((float)height * MathHelper.randomFloatClamp((Random)random, (float)0.3f, (float)0.4f));
                }
                int leafStart = j + (int)((float)height * MathHelper.randomFloatClamp((Random)random, (float)0.45f, (float)0.6f));
                ...
                for (j1 = leafTop; j1 >= leafStart; --j1) {
                    ...
                    for (i13 = i - trunkWidthHere - maxRange; i13 <= i + trunkWidthHere + this.extraTrunkWidth + maxRange; ++i13) {
                        for (k13 = k - trunkWidthHere - maxRange; k13 <= k + trunkWidthHere + this.extraTrunkWidth + maxRange; ++k13) {
                            ...
                            if (d > leafRange || !(block = world.getBlock(i13, j1, k13)).isReplaceable((IBlockAccess)world, i13, j1, k13) && !block.isLeaves((IBlockAccess)world, i13, j1, k13)) continue;
