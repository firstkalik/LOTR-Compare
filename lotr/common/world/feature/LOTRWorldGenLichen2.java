...
public class LOTRWorldGenLichen2
extends WorldGenerator {
        ...
        while (j < 60) {
            if (world.isAirBlock(i, j, k)) {
                for (int j1 = 2; j1 <= 5; ++j1) {
                    ...
                    world.setBlock(i, j, k, LOTRMod.glow_lichen, 1 << Direction.facingToDirection[Facing.oppositeSide[j1]], 2);
                    break;
                }
            } else {
    ...
    extends Thread {
        ...
        @Override
        public void run() {
            LOTRWorldGenLichen2.this.generateLichen(this.world, this.random, this.i, this.j, this.k);
        }
    }
