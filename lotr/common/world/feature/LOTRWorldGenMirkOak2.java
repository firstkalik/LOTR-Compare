...
public class LOTRWorldGenMirkOak2
extends WorldGenAbstractTree {
    ...
    private Block woodBlock = LOTRMod.wood3;
    private int woodMeta = 1;
    private Block leafBlock = LOTRMod.leaves3;
    private int leafMeta = 1;

    public LOTRWorldGenMirkOak2(boolean flag, int i, int j, int k, boolean mirk) {
        super(flag);
        this.minHeight = i;
        this.maxHeight = j;
        this.trunkWidth = k;
    ...
    public LOTRWorldGenMirkOak2 setBlocks(Block b1, int m1, Block b2, int m2) {
        this.woodBlock = b1;
        this.woodMeta = m1;
        this.leafBlock = b2;
        this.leafMeta = m2;
    ...
    public LOTRWorldGenMirkOak2 setGreenOak() {
        return this.setBlocks(Blocks.brown_mushroom_block, 0, Blocks.brown_mushroom_block, 14);
    }

    public LOTRWorldGenMirkOak2 setRedOak() {
        return this.setBlocks(Blocks.red_mushroom_block, 15, Blocks.brown_mushroom_block, 14);
    }

    public LOTRWorldGenMirkOak2 setGreenOak1() {
        return this.setBlocks(LOTRMod.wood3, 1, LOTRMod.leaves3, 1);
    }

    public LOTRWorldGenMirkOak2 setRedOak2() {
        return this.setBlocks(Blocks.red_mushroom_block, 15, Blocks.brown_mushroom_block, 14);
    }

    public LOTRWorldGenMirkOak2 disableRestrictions() {
        this.restrictions = false;
        return this;
    }

    public LOTRWorldGenMirkOak2 setDead() {
        this.isDead = true;
        return this;
    }

    public LOTRWorldGenMirkOak2 disableRoots() {
        this.hasRoots = false;
        return this;
    }
            ...
            if (this.trunkWidth >= 1) {
                ...
                while (deg < 360) {
                    ...
                    for (int l = 0; l < (length *= 1 + random.nextInt(this.trunkWidth)); ++l) {
                        ...
                        if (!(block = world.getBlock(i14, j12, k14)).isReplaceable((IBlockAccess)world, i14, j12, k14) && !block.isWood((IBlockAccess)world, i14, j12, k14) && !block.isLeaves((IBlockAccess)world, i14, j12, k14)) break;
                ...
                if (this.trunkWidth == 2) {
                    ...
                    for (int l = 0; l < platforms; ++l) {
                        int j13 = j + MathHelper.getRandomIntegerInRange((Random)random, (int)10, (int)height);
