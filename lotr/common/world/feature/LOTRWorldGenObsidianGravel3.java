...
public class LOTRWorldGenObsidianGravel3
extends WorldGenerator {
    private Block genBlock = LOTRMod.susGravel;
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        for (int l = 0; l <= numBlocks; ++l) {
            ...
            int j1 = MathHelper.floor_double((double)(yLerp - d11 / 2.0));
            int k1 = MathHelper.floor_double((double)(zLerp - d10 / 2.0));
            int l1 = MathHelper.floor_double((double)(xLerp + d10 / 2.0));
            int i2 = MathHelper.floor_double((double)(yLerp + d11 / 2.0));
