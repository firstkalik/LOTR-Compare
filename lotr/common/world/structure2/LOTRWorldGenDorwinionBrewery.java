    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i1 = -6; i1 <= 6; ++i1) {
            for (k1 = 0; k1 <= 19; ++k1) {
                ...
                if (i1 < -5 || i1 > 5 || k1 < 1 || k1 > 18) continue;
                if (!(i1 != -5 && i1 != 5 || k1 != 1 && k1 != 18)) {
                    for (j1 = 0; j1 <= 5; ++j1) {
        ...
        for (i1 = -1; i1 <= 1; ++i1) {
            this.setBlockAndMetadata(world, i1, 0, 1, this.floorBlock, this.floorMeta);
            for (int j12 = 1; j12 <= 3; ++j12) {
                this.setBlockAndMetadata(world, i1, j12, 1, LOTRMod.gateWooden, 2);
            }
        }
        ...
        for (i1 = -4; i1 <= 4; ++i1) {
            if (Math.abs(i1) == 4) {
                this.setBlockAndMetadata(world, i1, 1, 19, this.brickStairBlock, 3);
        ...
        for (i1 = -4; i1 <= 4; ++i1) {
            if (Math.abs(i1) == 4 || Math.abs(i1) == 2) {
                this.setBlockAndMetadata(world, i1, 1, 0, this.brickStairBlock, 2);
                this.setGrassToDirt(world, i1, 0, 0);
                continue;
            }
            if (Math.abs(i1) != 3) continue;
            this.setBlockAndMetadata(world, i1, 1, 0, this.leafBlock, this.leafMeta);
        }
        for (i1 = -5; i1 <= 5; ++i1) {
            this.setBlockAndMetadata(world, i1, 5, 0, this.brickStairBlock, 6);
            this.setBlockAndMetadata(world, i1, 5, 19, this.brickStairBlock, 7);
        }
        ...
        for (i1 = -3; i1 <= 3; ++i1) {
            if (Math.abs(i1) == 3) {
                this.setBlockAndMetadata(world, i1, 2, 1, this.brickSlabBlock, this.brickSlabMeta);
                this.setAir(world, i1, 3, 1);
            }
            if (Math.abs(i1) == 2) {
                this.placeWallBanner(world, i1, 4, 1, LOTRItemBanner.BannerType.DORWINION, 2);
            }
            if (IntMath.mod((int)i1, (int)2) != 1) continue;
            this.setBlockAndMetadata(world, i1, 2, 18, this.brickSlabBlock, this.brickSlabMeta);
            this.setAir(world, i1, 3, 18);
        }
        ...
        for (k1 = 2; k1 <= 17; ++k1) {
            for (i12 = -4; i12 <= 4; ++i12) {
                ...
                if (k1 % 3 == 0) {
                    this.setBlockAndMetadata(world, i12, 1, k1, Blocks.spruce_stairs, 6);
                    this.setBlockAndMetadata(world, i12, 2, k1, Blocks.spruce_stairs, 2);
                    continue;
                }
                if (k1 % 3 != 1) continue;
                this.setBlockAndMetadata(world, i12, 1, k1, Blocks.spruce_stairs, 7);
                this.setBlockAndMetadata(world, i12, 2, k1, Blocks.spruce_stairs, 3);
            }
        ...
        for (i13 = -2; i13 <= 2; ++i13) {
            ...
            this.setBlockAndMetadata(world, i13, 1, 17, (Block)Blocks.chest, 2);
