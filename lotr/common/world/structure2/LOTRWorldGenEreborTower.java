...
public class LOTRWorldGenEreborTower
extends LOTRWorldGenStructureBase2 {
    ...
    protected Block tableBlock = LOTRMod.erebortable;
    ...
    protected LOTREntityNPC getCommanderNPC(World world) {
        return new LOTREntityEreborDwarfCommander(world);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (int l = 0; l <= sections; ++l) {
            ...
            LOTREntityEreborDwarfWarrior dwarf = random.nextInt(3) == 0 ? new LOTREntityEreborDwarfAxeThrower(world) : new LOTREntityEreborDwarfWarrior(world);
        ...
        if (!this.ruined) {
            ...
            respawner.setSpawnClasses(LOTREntityEreborDwarfWarrior.class, LOTREntityEreborDwarfAxeThrower.class);
