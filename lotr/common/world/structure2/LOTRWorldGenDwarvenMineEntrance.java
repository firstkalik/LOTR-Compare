    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i1 = -4; i1 <= 4; ++i1) {
            for (k1 = -4; k1 <= 4; ++k1) {
                ...
                for (j12 = 1; j12 <= 3; ++j12) {
                    this.setBlockAndMetadata(world, i1, j12, k1, LOTRMod.pillar, 0);
                }
                ...
                for (int k12 = -4; k12 <= 4; ++k12) {
                    ...
                    if (i2 == 4 || k2 == 4) {
                        ...
                        if (this.isRuined && random.nextInt(4) == 0) {
                            this.setBlockAndMetadata(world, i12, j1, k12, LOTRMod.brick4, 5);
                            continue;
                        }
                        this.setBlockAndMetadata(world, i12, j1, k12, LOTRMod.brick, 6);
                        continue;
                    }
                    this.setAir(world, i12, j1, k12);
                }
                ...
                for (k1 = -2; k1 <= 2; ++k1) {
                    ...
                    for (int j13 = 0; j13 <= h; ++j13) {
                        if (random.nextBoolean()) {
                            this.setBlockAndMetadata(world, i1, relDepth + h, k1, LOTRMod.pillar, 0);
                            continue;
                        }
