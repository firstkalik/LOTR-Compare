...
public class LOTRWorldGenDwarvenTower3
extends LOTRWorldGenStructureBase2 {
    protected Block brickBlock = LOTRMod.brick9;
    protected int brickMeta = 4;
    protected Block brickSlabBlock = LOTRMod.slabSingle120;
    protected int brickSlabMeta = 0;
    protected Block brickStairBlock = LOTRMod.stairsWindDwarf;
    protected Block brickWallBlock = LOTRMod.wallStone9;
    ...
    protected Block barsBlock = LOTRMod.winddwarfBars;
    ...
    public LOTRWorldGenDwarvenTower3(boolean flag) {
        super(flag);
    }
