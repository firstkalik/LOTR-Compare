...
extends LOTRWorldGenBreeStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (int i13 = -2; i13 <= 2; ++i13) {
            if (i13 == 0) continue;
            for (int step = 0; step < 12 && !this.isOpaque(world, i13, j1 = 0 - step, k12 = -5 - step); ++step) {
        ...
        for (int step = 0; step < 12 && !this.isOpaque(world, i12 = 5 + step, j1 = 0 - step, k12 = 6); ++step) {
            this.setBlockAndMetadata(world, i12, j1, k12, Blocks.stone_stairs, 0);
        ...
        this.addBlockMetaAliasOption("GROUND", 1, (Block)Blocks.grass, 0);
    ...
    private void spawnHorse(World world, Random random, int i, int j, int k) {
        ...
        for (int l = 0; l < horses; ++l) {
            ...
            this.spawnNPCAndSetHome((EntityCreature)horse, world, i, j, k, 0);
