...
extends LOTRWorldGenDaleStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (reference k16 : new int[]{0, 4, 8}) {
        ...
        int[][] i17 = new int[]{-2, 2};
        k1 = i17.length;
        for (int fillBlock22 = 0; fillBlock22 < k1; ++fillBlock22) {
            int[] i132 = i17[fillBlock22];
            this.setBlockAndMetadata(world, (int)i132, 3, 1, this.brickStairBlock, 7);
            this.setBlockAndMetadata(world, (int)i132, 3, 3, this.brickStairBlock, 6);
            this.setBlockAndMetadata(world, (int)i132, 3, 5, this.brickStairBlock, 7);
            this.setBlockAndMetadata(world, (int)i132, 3, 7, this.brickStairBlock, 6);
        }
        ...
        for (int i142 = -2; i142 <= 2; ++i142) {
            ...
            if (IntMath.mod((int)i142, (int)2) != 1) continue;
        ...
        int[] i18 = new int[]{0, 4, 8};
        int fillBlock221 = i18.length;
        for (reference k16 = (reference)false; k16 < fillBlock221; ++k16) {
            int k14 = i18[k16];
            for (i1 = -1; i1 <= 1; ++i1) {
        ...
        if (random.nextInt(3) == 0) {
            ...
            k1 = MathHelper.getRandomIntegerInRange((Random)random, (int)0, (int)4);
