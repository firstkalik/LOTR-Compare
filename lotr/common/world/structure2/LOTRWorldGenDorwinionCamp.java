...
public class LOTRWorldGenDorwinionCamp
extends LOTRWorldGenDorwinionTent {
    ...
    private boolean tryGenerateTent(World world, Random random, int[] i, int[] k, int r) {
        ...
        for (int l = 0; l < attempts; ++l) {
            int i1 = MathHelper.getRandomIntegerInRange((Random)random, (int)i[0], (int)i[1]);
            int k1 = MathHelper.getRandomIntegerInRange((Random)random, (int)k[0], (int)k[1]);
            int j1 = this.getTopBlock(world, i1, k1);
