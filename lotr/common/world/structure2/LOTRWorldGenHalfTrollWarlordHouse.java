    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i12 = -radius; i12 <= radius; ++i12) {
            for (k12 = -radius; k12 <= radius; ++k12) {
                for (j1 = 0; j1 <= height; ++j1) {
                    double f = (double)(i12 * i12 + k12 * k12) / 4.0 - (double)(8 - j1);
                    if (f >= 8.0) continue;
                    if (j1 == 0) {
        ...
        for (i12 = -2; i12 <= 2; ++i12) {
            for (k12 = -2; k12 <= 2; ++k12) {
                ...
                this.setBlockAndMetadata(world, i12, -3, k12, (Block)Blocks.fire, 0);
        ...
        for (int l = 0; l < 8; ++l) {
            i1 = (3 + (l + 1) / 2 % 2) * IntMath.pow((int)-1, (int)(l / 4));
            k1 = (3 + (l + 3) / 2 % 2) * IntMath.pow((int)-1, (int)((l + 2) / 4));
        ...
        for (i12 = -4; i12 <= 4; i12 += 8) {
            this.setBlockAndMetadata(world, i12, 1, -2, (Block)Blocks.stone_slab, 11);
            this.setBlockAndMetadata(world, i12, 1, -1, (Block)Blocks.stone_slab, 11);
            this.setBlockAndMetadata(world, i12, 1, 1, (Block)Blocks.stone_slab, 11);
            this.setBlockAndMetadata(world, i12, 1, 2, (Block)Blocks.stone_slab, 11);
