...
public class LOTRWorldGenNearHaradDesertCamp
extends LOTRWorldGenStructureBase2 {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (int l = 0; l < camels; ++l) {
            ...
            EntityLeashKnot leash = EntityLeashKnot.func_110129_a((World)world, (int)this.getX(camelX, camelZ), (int)this.getY(camelY), (int)this.getZ(camelX, camelZ));
