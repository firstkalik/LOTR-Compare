...
extends LOTRWorldGenDaleStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if (this.restrictions) {
            ...
            for (i132 = -12; i132 <= 12; ++i132) {
                for (int k13 = -12; k13 <= 12; ++k13) {
                    int j12 = this.getTopBlock(world, i132, k13) - 1;
                    Block block = this.getBlock(world, i132, j12, k13);
        ...
        this.setBlockAndMetadata(world, 5, 3, 6, Blocks.torch, 1);
        for (k12 = -8; k12 <= -4; ++k12) {
            this.setBlockAndMetadata(world, -3, 0, k12, (Block)Blocks.grass, 0);
            this.setBlockAndMetadata(world, -2, 0, k12, (Block)Blocks.grass, 0);
            this.setBlockAndMetadata(world, 2, 0, k12, (Block)Blocks.grass, 0);
            this.setBlockAndMetadata(world, 3, 0, k12, (Block)Blocks.grass, 0);
        }
        for (k12 = 4; k12 <= 8; ++k12) {
        ...
        for (i1 = -1; i1 <= 1; ++i1) {
            for (k1 = -1; k1 <= 1; ++k1) {
                ...
                this.setBlockAndMetadata(world, i1, 5, k1, (Block)Blocks.fire, 0);
            }
        }
