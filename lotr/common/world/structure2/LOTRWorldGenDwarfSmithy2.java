...
public class LOTRWorldGenDwarfSmithy2
extends LOTRWorldGenStructureBase2 {
    ...
    public LOTRWorldGenDwarfSmithy2(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.setBlockAndMetadata(world, 0, 1, -1, Blocks.air, 1);
        for (int i13 : new int[]{-3, 3}) {
            this.setBlockAndMetadata(world, i13, 1, -1, Blocks.air, 0);
            this.setBlockAndMetadata(world, i13, 1, 0, this.tableBlock, 0);
            this.setBlockAndMetadata(world, i13, 1, 2, Blocks.air, 0);
        }
        this.setBlockAndMetadata(world, -3, 1, -2, Blocks.air, 4);
        this.setBlockAndMetadata(world, 3, 1, -2, Blocks.air, 5);
        ...
        this.setBlockAndMetadata(world, 0, 1, 3, Blocks.air, 0);
        return true;
    }
