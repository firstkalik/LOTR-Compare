...
import lotr.common.world.structure2.LOTRWorldGenDwarfHouse5;
...
public class LOTRWorldGenRedMountainsHouseStiffbeard
extends LOTRWorldGenDwarfHouse5 {
    public LOTRWorldGenRedMountainsHouseStiffbeard(boolean flag) {
        super(flag);
    }

    @Override
    protected LOTREntityDwarf createDwarf(World world) {
        return new LOTREntityStiffbeard(world);
    }
