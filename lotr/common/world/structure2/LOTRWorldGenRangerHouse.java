...
public class LOTRWorldGenRangerHouse
        ...
        block54: {
            ...
            for (int i15 = -2; i15 <= 7; ++i15) {
                for (k13 = -3; k13 <= 3; ++k13) {
                    ...
                    if (i15 >= 5 && k2 <= 1) {
                        for (j13 = 5; !(j13 < 0 && this.isOpaque(world, i15, j13, k13) || this.getY(j13) < 0); --j13) {
                            this.setBlockAndMetadata(world, i15, j13, k13, this.brickBlock, this.brickMeta);
                    ...
                    boolean beam = false;
                    boolean wall = false;
                    if (i15 == -2 && IntMath.mod((int)k13, (int)3) == 0) {
                        beam = true;
                    }
                    if (k2 == 3 && (i15 == 2 || i15 == 5)) {
                        beam = true;
            ...
            for (k2 = 0; k2 < k13; ++k2) {
                k122 = i15[k2];
                if (k122 >= 0) {
                    this.setBlockAndMetadata(world, 0, 2, k122, this.fenceBlock, this.fenceMeta);
                }
                this.setBlockAndMetadata(world, 3, 2, k122, this.fenceBlock, this.fenceMeta);
            }
            for (i13 = -2; i13 <= 5; ++i13) {
            ...
            for (int k122 : new int[]{-2, 2}) {
                for (i1 = -1; i1 <= 4; ++i1) {
                    this.setBlockAndMetadata(world, i1, 5, k122, this.roofBlock, this.roofMeta);
                }
            }
            for (int i122 : new int[]{-1, 4}) {
                for (k1 = -1; k1 <= 1; ++k1) {
                    this.setBlockAndMetadata(world, i122, 5, k1, this.fenceBlock, this.fenceMeta);
                }
            }
            ...
            for (int k122 : new int[]{-2, 2}) {
                this.setBlockAndMetadata(world, 3, 1, k122, this.bedBlock, 1);
                this.setBlockAndMetadata(world, 4, 1, k122, this.bedBlock, 9);
                this.setBlockAndMetadata(world, 5, 1, k122, this.plankBlock, this.plankMeta);
                for (j1 = 2; j1 <= 4; ++j1) {
                    this.setBlockAndMetadata(world, 5, j1, k122, this.fenceBlock, this.fenceMeta);
                }
            }
            ...
            for (i122 = -5; i122 <= -5; ++i122) {
                k1 = -4;
                if (this.isValidGatePos(world, i122, 1, k1)) {
                    gateX = i122;
                    gateZ = k1 + 1;
                    gateMeta = 0;
                } else {
                    k1 = 4;
                    if (!this.isValidGatePos(world, i122, 1, k1)) continue;
                    gateX = i122;
                    gateZ = k1 - 1;
                    gateMeta = 2;
                }
            ...
            for (k122 = -2; k122 <= 2; ++k122) {
                i1 = -7;
                if (!this.isValidGatePos(world, i1, 1, k122)) continue;
                gateX = i1 + 1;
                gateZ = k122;
                gateMeta = 3;
                break;
        ...
        if (gateMeta != -1) {
            for (i122 = -6; i122 <= -3; ++i122) {
                for (k1 = -3; k1 <= 3; ++k1) {
                    ...
                    int k2 = Math.abs(k1);
                    for (j1 = 1; j1 <= 3; ++j1) {
                        this.setAir(world, i122, j1, k1);
                    }
                    for (j1 = 0; !(j1 < 0 && this.isOpaque(world, i122, j1, k1) || this.getY(j1) < 0); --j1) {
                        if (j1 == 0) {
                            this.setBlockAndMetadata(world, i122, j1, k1, (Block)Blocks.grass, 0);
                        } else {
                            this.setBlockAndMetadata(world, i122, j1, k1, Blocks.dirt, 0);
                        }
                        this.setGrassToDirt(world, i122, j1 - 1, k1);
                    }
                    if (i122 != -6 && k2 != 3) continue;
                    this.setBlockAndMetadata(world, i122, 1, k1, this.fenceBlock, this.fenceMeta);
                }
            }
            ...
            for (k122 = -2; k122 <= 2; ++k122) {
                this.setBlockAndMetadata(world, -5, 0, k122, LOTRMod.dirtPath, 0);
                for (i1 = -4; i1 <= -3; ++i1) {
                    if (k122 == 0 && i1 == -3) continue;
                    this.setBlockAndMetadata(world, i1, 0, k122, Blocks.farmland, 7);
                    this.setBlockAndMetadata(world, i1, 1, k122, this.cropBlock, this.cropMeta);
                }
            }
