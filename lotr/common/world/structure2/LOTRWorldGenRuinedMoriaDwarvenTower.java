...
public class LOTRWorldGenRuinedMoriaDwarvenTower
extends LOTRWorldGenDwarvenTower {
    private boolean isGundabad;

    public LOTRWorldGenRuinedMoriaDwarvenTower(boolean flag) {
        super(flag);
        this.ruined = true;
    ...
    protected LOTREntityNPC getCommanderNPC(World world) {
        if (this.isGundabad) {
            return new LOTREntityMoriaOrcMercenaryCaptain(world);
        }
        return null;
    }
