...
public class LOTRWorldGenHaradRuinedFort
extends LOTRWorldGenStructureBase2 {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (int[] coords : chestCoords) {
            this.placeChest(world, random, coords[0], coords[1], coords[2], LOTRMod.chestBasket, MathHelper.getRandomIntegerInRange((Random)random, (int)2, (int)4), LOTRChestContents.NEAR_HARAD_PYRAMID);
        }
        return true;
    }
}
