...
public class LOTRWorldGenAvariElfHouse
extends LOTRWorldGenStructureBase2 {
    private WorldGenerator treeGen = new LOTRWorldGenMirkOak2(true, 3, 4, 0, false).setGreenOak1().disableRestrictions().disableRoots();
    ...
    public LOTRWorldGenAvariElfHouse(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if (random.nextInt(2) == 0) {
            ...
            this.plank1Meta = 13;
            this.wood1Block = LOTRMod.wood3;
            this.wood1Meta = 1;
            this.fence1Block = LOTRMod.fence;
            this.fence1Meta = 13;
            this.doorBlock = LOTRMod.doorLarch;
        } else {
            this.plank1Block = LOTRMod.planks;
            this.plank1Meta = 13;
            this.wood1Block = LOTRMod.wood3;
        ...
        if (randomWood2 == 0) {
            ...
            this.fence2Meta = 13;
            this.stair2Block = LOTRMod.stairsLarch;
        } else {
            this.plank2Block = LOTRMod.planks;
            this.plank2Meta = 13;
            this.fence2Block = LOTRMod.fence;
        ...
        this.barsBlock = LOTRMod.avariElfWoodBars;
        ...
        for (i12 = -4; i12 <= 4; ++i12) {
            for (k13 = -4; k13 <= 4; ++k13) {
                this.setBlockAndMetadata(world, i12, 0, k13, LOTRMod.brick10, 1);
            }
        }
        for (i12 = -4; i12 <= 4; ++i12) {
            for (k13 = -4; k13 <= 4; ++k13) {
        ...
        for (i12 = -5; i12 <= 5; ++i12) {
            ...
            for (int k14 : new int[]{-5, 5}) {
                ...
                this.setBlockAndMetadata(world, i12, 1, k14, LOTRMod.leaves3, 1);
            }
        }
        for (k12 = -4; k12 <= 4; ++k12) {
            ...
            for (int i14 : new int[]{-5, 5}) {
                ...
                this.setBlockAndMetadata(world, i14, 1, k12, LOTRMod.leaves3, 1);
            }
        }
        for (i12 = -3; i12 <= 3; ++i12) {
        ...
        for (i12 = -5; i12 <= 5; ++i12) {
            for (int k15 = -5; k15 <= 5; ++k15) {
                ...
                if (i2 == 5 && k2 == 5) {
                    this.setBlockAndMetadata(world, i12, 6, k15, LOTRMod.avariTorch, 5);
                }
                if (!(i2 == 5 && k2 == 0 || k2 == 5 && i2 == 0)) continue;
                this.setBlockAndMetadata(world, i12, 6, k15, this.fence1Block, this.fence1Meta);
                this.setBlockAndMetadata(world, i12, 7, k15, LOTRMod.avariTorch, 5);
            }
        }
        this.setBlockAndMetadata(world, -3, 2, -1, LOTRMod.avariTorch, 2);
        this.setBlockAndMetadata(world, -3, 2, 1, LOTRMod.avariTorch, 2);
        this.setBlockAndMetadata(world, 3, 2, -1, LOTRMod.avariTorch, 1);
        this.setBlockAndMetadata(world, 3, 2, 1, LOTRMod.avariTorch, 1);
        this.setBlockAndMetadata(world, -1, 2, -3, LOTRMod.avariTorch, 3);
        this.setBlockAndMetadata(world, 1, 2, -3, LOTRMod.avariTorch, 3);
        this.setBlockAndMetadata(world, -1, 2, 3, LOTRMod.avariTorch, 4);
        this.setBlockAndMetadata(world, 1, 2, 3, LOTRMod.avariTorch, 4);
        ...
        for (i13 = -4; i13 <= 4; ++i13) {
            for (int k16 = -4; k16 <= 4; ++k16) {
                ...
                this.setBlockAndMetadata(world, i13, -5, k16, LOTRMod.brick10, 1);
        ...
        for (k1 = 2; k1 <= 3; ++k1) {
            for (i1 = -2; i1 <= 2; ++i1) {
                ...
                for (int j14 = -4; j14 < -4 + stairHeight; ++j14) {
                    this.setBlockAndMetadata(world, i1, j14, k1, LOTRMod.brick10, 1);
                }
                this.setBlockAndMetadata(world, i1, -4 + stairHeight, k1, LOTRMod.stairsAvariBrick, 1);
            }
            for (int j15 = -4; j15 <= -1; ++j15) {
                this.setBlockAndMetadata(world, 3, j15, k1, LOTRMod.brick10, 1);
            }
        }
        this.setBlockAndMetadata(world, -3, -2, -3, LOTRMod.avariTorch, 3);
        this.setBlockAndMetadata(world, 3, -2, -3, LOTRMod.avariTorch, 3);
        this.setBlockAndMetadata(world, -3, -2, 3, LOTRMod.avariTorch, 4);
        this.setBlockAndMetadata(world, 3, -2, 1, LOTRMod.avariTorch, 4);
        ...
        this.setBlockAndMetadata(world, 0, 0, -2, LOTRMod.brick10, 6);
        this.setBlockAndMetadata(world, -2, 0, 0, LOTRMod.brick10, 6);
        this.setBlockAndMetadata(world, 2, 0, 0, LOTRMod.brick10, 6);
        this.setBlockAndMetadata(world, 3, 0, 3, LOTRMod.brick10, 6);
        ...
        this.setBlockAndMetadata(world, -1, 2, -5, LOTRMod.avariTorch, 4);
        this.setBlockAndMetadata(world, 1, 2, -5, LOTRMod.avariTorch, 4);
        ...
        this.setBlockAndMetadata(world, 3, 1, -2, LOTRMod.avariTable, 0);
        this.setBlockAndMetadata(world, -3, 1, -3, this.plank2Block, this.plank2Meta);
        ...
        this.placeChest(world, random, -3, 1, -2, 0, LOTRChestContents.LOTRChestContents2.AVARI_ELF_HOUSE);
        ...
        for (j1 = -4; j1 <= 4; ++j1) {
            this.setBlockAndMetadata(world, 0, j1, 0, LOTRMod.wood3, 1);
        }
        this.treeGen.generate(world, random, this.getX(0, 0), this.getY(5), this.getZ(0, 0));
        LOTREntityAvariElf elf = new LOTREntityAvariElf(world);
    ...
    private void placeWoodElfItemFrame(World world, int i, int j, int k, int direction, Random random) {
        ...
        switch (l) {
            case 0: {
                item = new ItemStack(LOTRMod.bowAvariElf);
                break;
            }
            case 1: {
            ...
            case 2: {
                item = new ItemStack(LOTRMod.sapling5, 1, 0);
                break;
            }
            case 3: {
