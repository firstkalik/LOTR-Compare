...
public class LOTRWorldGenDwarvenMineEntrance2
extends LOTRWorldGenStructureBase2 {
    ...
    public LOTRWorldGenDwarvenMineEntrance2(boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (int k13 = -1; k13 <= 1; ++k13) {
            this.setBlockAndMetadata(world, -4, relDepth + 1, k13, LOTRMod.slabSingle3, 6);
            this.setBlockAndMetadata(world, 4, relDepth + 1, k13, LOTRMod.slabSingle3, 6);
        }
        for (i12 = -1; i12 <= 1; ++i12) {
            this.setBlockAndMetadata(world, i12, relDepth + 1, -4, LOTRMod.slabSingle3, 6);
        }
