...
public class LOTRWorldGenHighElvenTower
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if (this.restrictions) {
            ...
            for (int i17 = -radiusPlusOne; i17 <= radiusPlusOne; ++i17) {
                for (k19 = -radiusPlusOne; k19 <= radiusPlusOne; ++k19) {
                    distSq = i17 * i17 + k19 * k19;
                    if (distSq >= wallThresholdMax) continue;
                    j12 = this.getTopBlock(world, i17, k19) - 1;
                    if (!this.isSurface(world, i17, j12, k19)) {
                        return false;
                    }
                    if (j12 < minHeight) {
                        minHeight = j12;
        ...
        for (i15 = -radius; i15 <= radius; ++i15) {
            for (k15 = -radius; k15 <= radius; ++k15) {
                i2 = Math.abs(i15);
                k2 = Math.abs(k15);
                distSq = i15 * i15 + k15 * k15;
                if (distSq >= wallThresholdMax) continue;
                this.layFoundation(world, i15, k15);
                if (distSq >= wallThresholdMin) {
                    this.setBlockAndMetadata(world, i15, 1, k15, this.pillarBlock, this.pillarMeta);
                    for (j12 = 2; j12 <= 6; ++j12) {
                        if (i2 == 5 && k2 == 5 || i2 == radius && k2 == 2 || k2 == radius && i2 == 2) {
                            this.setBlockAndMetadata(world, i15, j12, k15, this.pillarBlock, this.pillarMeta);
                            continue;
                        }
                        this.setBlockAndMetadata(world, i15, j12, k15, this.brickBlock, this.brickMeta);
                    }
                    this.setBlockAndMetadata(world, i15, 7, k15, this.pillarBlock, this.pillarMeta);
                    continue;
                }
                this.setBlockAndMetadata(world, i15, 1, k15, this.brickBlock, this.brickMeta);
                for (j12 = 2; j12 <= 6; ++j12) {
                    this.setAir(world, i15, j12, k15);
                }
        ...
        for (i15 = -4; i15 <= 4; ++i15) {
            for (k15 = -4; k15 <= 4; ++k15) {
                ...
                k2 = Math.abs(k15);
                if (i2 == 4 || k2 == 4) {
                    this.setBlockAndMetadata(world, i15, 1, k15, this.floorBlock, this.floorMeta);
                    continue;
                }
                this.setBlockAndMetadata(world, i15, 1, k15, this.pillarBlock, this.pillarMeta);
            }
        ...
        for (i15 = -1; i15 <= 1; ++i15) {
            for (int j13 = 2; j13 <= 4; ++j13) {
                this.setBlockAndMetadata(world, i15, j13, -radius, LOTRMod.gateHighElven, 2);
            }
            for (k15 = -radius; k15 <= -4; ++k15) {
                this.setBlockAndMetadata(world, i15, 1, k15, this.pillarBlock, this.pillarMeta);
            }
        }
        ...
        for (i2 = 0; i2 < k15; ++i2) {
            k19 = i19[i2];
            this.setBlockAndMetadata(world, -4, 2, k19, this.plankStairBlock, 4);
            this.setBlockAndMetadata(world, -3, 2, k19, this.plankStairBlock, 5);
            this.setBlockAndMetadata(world, 3, 2, k19, this.plankStairBlock, 4);
            this.setBlockAndMetadata(world, 4, 2, k19, this.plankStairBlock, 5);
        }
        for (i14 = -radius; i14 <= radius; ++i14) {
            for (k15 = -radius; k15 <= radius; ++k15) {
                i2 = Math.abs(i14);
                k2 = Math.abs(k15);
                if ((i2 == radius - 1 && k2 <= 2 || k15 == radius - 1 && i2 <= 2 || i2 == radius - 2 && k2 >= 3 && k2 <= 4 || k2 == radius - 2 && i2 >= 3 && i2 <= 4) && random.nextInt(3) == 0) {
                    if (random.nextInt(3) == 0) {
                        this.placeMug(world, random, i14, 3, k15, random.nextInt(4), LOTRFoods.ELF_DRINK);
                    } else {
                        this.placePlate(world, random, i14, 3, k15, this.plateBlock, LOTRFoods.ELF);
                    }
                }
                if (k15 == -radius + 1 && i2 == 2) {
                    for (int j14 = 2; j14 <= 4; ++j14) {
                        this.setBlockAndMetadata(world, i14, j14, k15, this.brickWallBlock, this.brickWallMeta);
                    }
                    this.setBlockAndMetadata(world, i14, 5, k15, LOTRMod.highElvenTorch, 5);
                }
                if (i2 == radius && k2 == 0 || k15 == radius && i2 == 0) {
                    this.setBlockAndMetadata(world, i14, 3, k15, LOTRMod.highElfWoodBars, 0);
                    this.setBlockAndMetadata(world, i14, 4, k15, LOTRMod.highElfWoodBars, 0);
                }
                if ((i2 != radius - 1 || k2 != 1) && (k15 != radius - 1 || i2 != 1)) continue;
                this.setBlockAndMetadata(world, i14, 4, k15, this.fenceBlock, this.fenceMeta);
                this.setBlockAndMetadata(world, i14, 5, k15, LOTRMod.highElvenTorch, 5);
            }
        }
        for (i14 = -2; i14 <= 2; ++i14) {
            this.setBlockAndMetadata(world, i14, 6, -radius + 1, this.brickStairBlock, 7);
            this.setBlockAndMetadata(world, i14, 6, radius - 1, this.brickStairBlock, 6);
        }
        ...
        for (i14 = -4; i14 <= -3; ++i14) {
            this.setBlockAndMetadata(world, i14, 6, -radius + 2, this.brickStairBlock, 7);
            this.setBlockAndMetadata(world, i14, 6, radius - 2, this.brickStairBlock, 6);
        }
        for (i14 = 3; i14 <= 4; ++i14) {
            this.setBlockAndMetadata(world, i14, 6, -radius + 2, this.brickStairBlock, 7);
            this.setBlockAndMetadata(world, i14, 6, radius - 2, this.brickStairBlock, 6);
        ...
        this.setBlockAndMetadata(world, radius - 2, 6, 3, this.brickStairBlock, 5);
        this.setBlockAndMetadata(world, radius - 2, 6, 4, this.brickStairBlock, 6);
        for (int k19 : new int[]{-radius + 2, radius - 2}) {
            this.setBlockAndMetadata(world, -2, 6, k19, this.brickStairBlock, 4);
            this.setBlockAndMetadata(world, 2, 6, k19, this.brickStairBlock, 5);
        }
        for (int i18 : new int[]{-radius + 2, radius - 2}) {
        ...
        for (int k19 : new int[]{-4, 4}) {
            this.setBlockAndMetadata(world, -4, 6, k19, this.brickStairBlock, 4);
            this.setBlockAndMetadata(world, 4, 6, k19, this.brickStairBlock, 5);
        }
        for (i12 = -2; i12 <= 2; ++i12) {
        ...
        for (int k110 = -2; k110 <= 2; ++k110) {
            this.setBlockAndMetadata(world, -radius, 8, k110, this.roofStairBlock, 1);
            this.setBlockAndMetadata(world, radius, 8, k110, this.roofStairBlock, 0);
        }
        for (i12 = -4; i12 <= -3; ++i12) {
        ...
        double sRadiusD = (double)sRadius - 0.7;
        ...
        for (int l = 0; l < sections; ++l) {
            ...
            for (i110 = -sRadius; i110 <= sRadius; ++i110) {
                for (k13 = -sRadius; k13 <= sRadius; ++k13) {
                    int i23 = Math.abs(i110);
                    int k22 = Math.abs(k13);
                    int distSq2 = i110 * i110 + k13 * k13;
                        ...
                        for (int j15 = sectionBase + 1; j15 <= sectionBase + sectionHeight; ++j15) {
                            if (distSq2 >= sWallThresholdMin) {
                                if (i23 == 4 && k22 == 4 || i23 == sRadius && k22 == 1 || k22 == sRadius && i23 == 1) {
                                    this.setBlockAndMetadata(world, i110, j15, k13, this.pillarBlock, this.pillarMeta);
                                    continue;
                                }
                                this.setBlockAndMetadata(world, i110, j15, k13, this.brickBlock, this.brickMeta);
                                continue;
                            }
                            ...
                            this.setAir(world, i110, j15, k13);
                        }
                    }
                    if (i23 == 0 && k22 == sRadius || k22 == 0 && i23 == sRadius) {
                        this.setBlockAndMetadata(world, i110, sectionBase + 1, k13, this.pillarBlock, this.pillarMeta);
                        this.setBlockAndMetadata(world, i110, sectionBase + 3, k13, LOTRMod.highElfWoodBars, 0);
                        this.setBlockAndMetadata(world, i110, sectionBase + 4, k13, LOTRMod.highElfWoodBars, 0);
                        this.setBlockAndMetadata(world, i110, sectionBase + 6, k13, this.pillarBlock, this.pillarMeta);
                    }
                    if (i23 == 1 && k22 == sRadius - 1 || k22 == 1 && i23 == sRadius - 1) {
                        this.setBlockAndMetadata(world, i110, sectionBase + 4, k13, this.fenceBlock, this.fenceMeta);
                        this.setBlockAndMetadata(world, i110, sectionBase + 5, k13, LOTRMod.highElvenTorch, 5);
                    }
                    if ((i23 != 3 || k22 != 4) && (k22 != 3 || i23 != 4)) continue;
                    this.setBlockAndMetadata(world, i110, sectionBase + 1, k13, this.plankBlock, this.plankMeta);
                    if (random.nextInt(4) == 0) {
                        if (random.nextBoolean()) {
                            this.placeMug(world, random, i110, sectionBase + 2, k13, random.nextInt(4), LOTRFoods.ELF_DRINK);
                        } else {
                            this.placePlate(world, random, i110, sectionBase + 2, k13, this.plateBlock, LOTRFoods.ELF);
                        }
                    }
                    this.setBlockAndMetadata(world, i110, sectionBase + 6, k13, this.fenceBlock, this.fenceMeta);
                    this.setBlockAndMetadata(world, i110, sectionBase + 7, k13, this.leafBlock, this.leafMeta);
                }
            }
            ...
            for (int k111 = -1; k111 <= 1; ++k111) {
                this.setBlockAndMetadata(world, -sRadius + 1, sectionBase + 1, k111, this.brickStairBlock, 0);
                this.setBlockAndMetadata(world, sRadius - 1, sectionBase + 1, k111, this.brickStairBlock, 1);
                this.setBlockAndMetadata(world, -sRadius + 1, sectionBase + 7, k111, this.plankStairBlock, 4);
                this.setBlockAndMetadata(world, sRadius - 1, sectionBase + 7, k111, this.plankStairBlock, 5);
            }
        ...
        for (int j16 = 2; j16 <= sectionTopHeight; ++j16) {
            ...
            if (step == 1) {
                for (k13 = 1; k13 <= 2; ++k13) {
                    this.setBlockAndMetadata(world, 0, j16, k13, this.brickSlabBlock, this.brickSlabMeta);
                    this.setBlockAndMetadata(world, 1, j16, k13, this.brickSlabBlock, this.brickSlabMeta | 8);
                    this.setBlockAndMetadata(world, 2, j16, k13, this.brickSlabBlock, this.brickSlabMeta | 8);
                    for (j2 = j16 + 1; j2 <= j16 + 3; ++j2) {
                        this.setAir(world, 0, j2, k13);
                        this.setAir(world, 1, j2, k13);
                        this.setAir(world, 2, j2, k13);
                    }
                }
                continue;
            }
        ...
        for (i1 = -radius; i1 <= radius; ++i1) {
            for (int k112 = -radius; k112 <= radius; ++k112) {
                int j17;
                i22 = Math.abs(i1);
                int k23 = Math.abs(k112);
                int distSq3 = i1 * i1 + k112 * k112;
                if (distSq3 >= wallThresholdMax) continue;
                if (distSq3 >= wallThresholdMin) {
                    this.setBlockAndMetadata(world, i1, sectionTopHeight + 1, k112, this.pillarBlock, this.pillarMeta);
                    for (j17 = sectionTopHeight + 2; j17 <= sectionTopHeight + 5; ++j17) {
                        if (i22 == 5 && k23 == 5 || i22 == radius && k23 == 2 || k23 == radius && i22 == 2) {
                            this.setBlockAndMetadata(world, i1, j17, k112, this.pillarBlock, this.pillarMeta);
                            continue;
                        }
                        this.setBlockAndMetadata(world, i1, j17, k112, this.brickBlock, this.brickMeta);
                    }
                    this.setBlockAndMetadata(world, i1, sectionTopHeight + 6, k112, this.pillarBlock, this.pillarMeta);
                    this.setBlockAndMetadata(world, i1, sectionTopHeight + 7, k112, this.roofBlock, this.roofMeta);
                    this.setBlockAndMetadata(world, i1, sectionTopHeight + 8, k112, this.roofBlock, this.roofMeta);
                } else {
                    for (j17 = sectionTopHeight + 1; j17 <= sectionTopHeight + 6; ++j17) {
                        this.setAir(world, i1, j17, k112);
                    }
                }
                if (i22 == 2 && k23 == radius - 1 || k23 == 2 && i22 == radius - 1) {
                    this.setBlockAndMetadata(world, i1, sectionTopHeight + 4, k112, this.fenceBlock, this.fenceMeta);
                    this.setBlockAndMetadata(world, i1, sectionTopHeight + 5, k112, LOTRMod.highElvenTorch, 5);
                }
                if (!(i22 <= 1 && k23 == radius - 1 || k23 <= 1 && i22 == radius - 1 || i22 >= 3 && i22 <= 4 && k23 == radius - 2) && (k23 < 3 || k23 > 4 || i22 != radius - 2)) continue;
                this.setBlockAndMetadata(world, i1, sectionTopHeight + 6, k112, this.fenceBlock, this.fenceMeta);
                this.setBlockAndMetadata(world, i1, sectionTopHeight + 7, k112, this.leafBlock, this.leafMeta);
            }
        }
        ...
        for (k12 = -2; k12 <= 2; ++k12) {
            this.setBlockAndMetadata(world, -radius, sectionTopHeight, k12, this.roofStairBlock, 5);
            this.setBlockAndMetadata(world, radius, sectionTopHeight, k12, this.roofStairBlock, 4);
        }
        for (i1 = -4; i1 <= -3; ++i1) {
        ...
        for (k12 = -2; k12 <= 2; ++k12) {
            this.setBlockAndMetadata(world, -radius + 1, sectionTopHeight + 1, k12, this.brickStairBlock, 0);
            this.setBlockAndMetadata(world, radius - 1, sectionTopHeight + 1, k12, this.brickStairBlock, 1);
        }
        for (i1 = -4; i1 <= -3; ++i1) {
        ...
        this.setBlockAndMetadata(world, radius - 2, sectionTopHeight + 1, 3, this.brickStairBlock, 1);
        this.setBlockAndMetadata(world, radius - 2, sectionTopHeight + 1, 4, this.brickStairBlock, 2);
        for (int k113 : new int[]{-radius + 2, radius - 2}) {
            this.setBlockAndMetadata(world, -2, sectionTopHeight + 1, k113, this.brickStairBlock, 0);
            this.setBlockAndMetadata(world, 2, sectionTopHeight + 1, k113, this.brickStairBlock, 1);
        }
        ...
        int k112 = i113.length;
        for (i22 = 0; i22 < k112; ++i22) {
            int k113;
            k113 = i113[i22];
            this.setBlockAndMetadata(world, -4, sectionTopHeight + 1, k113, this.brickStairBlock, 0);
            this.setBlockAndMetadata(world, 4, sectionTopHeight + 1, k113, this.brickStairBlock, 1);
        }
        for (i13 = -1; i13 <= 1; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 2, -radius, this.brickStairBlock, 3);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 3, -radius, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 4, -radius, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 5, -radius, this.brickStairBlock, 7);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 2, radius, this.brickStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 3, radius, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 4, radius, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 5, radius, this.brickStairBlock, 6);
        }
        for (k14 = -1; k14 <= 1; ++k14) {
            this.setBlockAndMetadata(world, -radius, sectionTopHeight + 2, k14, this.brickStairBlock, 0);
            this.setBlockAndMetadata(world, -radius, sectionTopHeight + 3, k14, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, -radius, sectionTopHeight + 4, k14, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, -radius, sectionTopHeight + 5, k14, this.brickStairBlock, 4);
            this.setBlockAndMetadata(world, radius, sectionTopHeight + 2, k14, this.brickStairBlock, 1);
            this.setBlockAndMetadata(world, radius, sectionTopHeight + 3, k14, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, radius, sectionTopHeight + 4, k14, LOTRMod.highElfWoodBars, 0);
            this.setBlockAndMetadata(world, radius, sectionTopHeight + 5, k14, this.brickStairBlock, 5);
        }
        ...
        this.placeWallBanner(world, radius - 1, sectionTopHeight + 4, 4, LOTRItemBanner.BannerType.HIGH_ELF, 3);
        for (i13 = -3; i13 <= 3; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 7, -radius - 1, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 7, radius + 1, this.roofStairBlock, 3);
        }
        for (k14 = -3; k14 <= 3; ++k14) {
            this.setBlockAndMetadata(world, -radius - 1, sectionTopHeight + 7, k14, this.roofStairBlock, 1);
            this.setBlockAndMetadata(world, radius + 1, sectionTopHeight + 7, k14, this.roofStairBlock, 0);
        }
        ...
        this.setBlockAndMetadata(world, -1, sectionTopHeight + 8, -radius + 2, this.roofStairBlock, 4);
        for (i13 = -2; i13 <= 2; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, -radius, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, radius, this.roofStairBlock, 3);
        }
        for (k14 = -2; k14 <= 2; ++k14) {
            this.setBlockAndMetadata(world, -radius, sectionTopHeight + 9, k14, this.roofStairBlock, 1);
            this.setBlockAndMetadata(world, radius, sectionTopHeight + 9, k14, this.roofStairBlock, 0);
        }
        for (i13 = -4; i13 <= -3; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, -radius + 1, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, radius - 1, this.roofStairBlock, 3);
        }
        for (i13 = 3; i13 <= 4; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, -radius + 1, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, radius - 1, this.roofStairBlock, 3);
        ...
        for (j1 = sectionTopHeight + 9; j1 <= sectionTopHeight + 10; ++j1) {
            for (i16 = -1; i16 <= 1; ++i16) {
                this.setBlockAndMetadata(world, i16, j1, -radius + 1, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, i16, j1, radius - 1, this.roofBlock, this.roofMeta);
            }
            for (k112 = -1; k112 <= 1; ++k112) {
                this.setBlockAndMetadata(world, -radius + 1, j1, k112, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, radius - 1, j1, k112, this.roofBlock, this.roofMeta);
            }
            for (i16 = -3; i16 <= 3; ++i16) {
                this.setBlockAndMetadata(world, i16, j1, -radius + 2, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, i16, j1, radius - 2, this.roofBlock, this.roofMeta);
            }
            for (k112 = -3; k112 <= 3; ++k112) {
                this.setBlockAndMetadata(world, -radius + 2, j1, k112, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, radius - 2, j1, k112, this.roofBlock, this.roofMeta);
            }
            this.setBlockAndMetadata(world, -4, j1, -3, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, -4, j1, -4, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, -3, j1, -4, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 4, j1, -3, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 4, j1, -4, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 3, j1, -4, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, -4, j1, 3, this.roofBlock, this.roofMeta);
        ...
        for (i13 = -2; i13 <= 2; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 10, -4, this.roofStairBlock, 7);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 10, 4, this.roofStairBlock, 6);
        }
        for (k14 = -1; k14 <= 1; ++k14) {
            this.setBlockAndMetadata(world, -4, sectionTopHeight + 10, k14, this.roofStairBlock, 4);
            this.setBlockAndMetadata(world, 4, sectionTopHeight + 10, k14, this.roofStairBlock, 5);
        }
        ...
        for (j1 = sectionTopHeight + 11; j1 <= sectionTopHeight + 12; ++j1) {
            for (i16 = -2; i16 <= 2; ++i16) {
                this.setBlockAndMetadata(world, i16, j1, -4, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, i16, j1, 4, this.roofBlock, this.roofMeta);
            }
            for (k112 = -2; k112 <= 2; ++k112) {
                this.setBlockAndMetadata(world, -4, j1, k112, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, 4, j1, k112, this.roofBlock, this.roofMeta);
            }
            this.setBlockAndMetadata(world, -3, j1, -2, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, -3, j1, -3, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, -2, j1, -3, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 3, j1, -2, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 3, j1, -3, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 2, j1, -3, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, -3, j1, 2, this.roofBlock, this.roofMeta);
        ...
        this.setBlockAndMetadata(world, -1, sectionTopHeight + 12, -3, this.roofStairBlock, 7);
        for (i13 = -2; i13 <= 2; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 13, -4, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 13, 4, this.roofStairBlock, 3);
        }
        for (k14 = -1; k14 <= 1; ++k14) {
            this.setBlockAndMetadata(world, -4, sectionTopHeight + 13, k14, this.roofStairBlock, 1);
            this.setBlockAndMetadata(world, 4, sectionTopHeight + 13, k14, this.roofStairBlock, 0);
        }
        ...
        for (j1 = sectionTopHeight + 13; j1 <= sectionTopHeight + 14; ++j1) {
            for (i16 = -1; i16 <= 1; ++i16) {
                this.setBlockAndMetadata(world, i16, j1, -3, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, i16, j1, 3, this.roofBlock, this.roofMeta);
            }
            for (i16 = -2; i16 <= 2; ++i16) {
                this.setBlockAndMetadata(world, i16, j1, -2, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, i16, j1, 2, this.roofBlock, this.roofMeta);
            }
            for (k112 = -1; k112 <= 1; ++k112) {
                this.setBlockAndMetadata(world, -3, j1, k112, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, -2, j1, k112, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, 2, j1, k112, this.roofBlock, this.roofMeta);
                this.setBlockAndMetadata(world, 3, j1, k112, this.roofBlock, this.roofMeta);
            }
        }
        for (i13 = -1; i13 <= 1; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 14, -1, this.roofStairBlock, 7);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 14, 1, this.roofStairBlock, 6);
        }
        ...
        for (i13 = -1; i13 <= 1; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 15, -3, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 15, 3, this.roofStairBlock, 3);
        }
        ...
        for (j1 = sectionTopHeight + 15; j1 <= sectionTopHeight + 16; ++j1) {
            for (i16 = -1; i16 <= 1; ++i16) {
                for (k13 = -1; k13 <= 1; ++k13) {
                    this.setBlockAndMetadata(world, i16, j1, k13, this.roofBlock, this.roofMeta);
                }
            }
        }
        ...
        this.setBlockAndMetadata(world, 2, sectionTopHeight + 16, 0, this.roofSlabBlock, this.roofSlabMeta);
        for (i13 = -1; i13 <= 1; ++i13) {
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 17, -1, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i13, sectionTopHeight + 17, 1, this.roofStairBlock, 3);
        }
        ...
        for (j1 = sectionTopHeight + 10; j1 <= sectionTopHeight + 14; ++j1) {
            this.setBlockAndMetadata(world, 0, j1, 0, Blocks.fence, 2);
        }
        for (i13 = -2; i13 <= 2; ++i13) {
            for (k112 = -2; k112 <= 2; ++k112) {
                if (i13 == 0 || k112 == 0) {
                    this.setBlockAndMetadata(world, i13, sectionTopHeight + 10, k112, Blocks.fence, 2);
                }
                if ((i13 != 0 || Math.abs(k112) != 2) && (k112 != 0 || Math.abs(i13) != 2)) continue;
                this.setBlockAndMetadata(world, i13, sectionTopHeight + 9, k112, LOTRMod.chandelier, 10);
            }
        }
