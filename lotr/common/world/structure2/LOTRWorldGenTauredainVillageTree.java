...
public class LOTRWorldGenTauredainVillageTree
        ...
        for (i1 = -3; i1 <= 3; ++i1) {
            for (k1 = -3; k1 <= 3; ++k1) {
                ...
                if (random.nextBoolean()) {
                    this.setBlockAndMetadata(world, i1, 2, k1, (Block)Blocks.tallgrass, 1);
                    continue;
                }
                this.setBlockAndMetadata(world, i1, 2, k1, (Block)Blocks.tallgrass, 2);
            }
        }
        int treeX = 0;
        int treeY = 2;
