...
extends LOTRWorldGenStructureBase2 {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if (this.restrictions) {
            for (i1 = -5; i1 <= 5; ++i1) {
                for (k13 = -8; k13 <= 8; ++k13) {
                    j1 = this.getTopBlock(world, i1, k13);
                    Block block = this.getBlock(world, i1, j1 - 1, k13);
        ...
        for (i1 = -5; i1 <= 5; ++i1) {
            for (k13 = -8; k13 <= 8; ++k13) {
                ...
                int i2 = Math.abs(i1);
                k2 = Math.abs(k13);
                for (j12 = 0; !(j12 != 0 && this.isOpaque(world, i1, j12, k13) || this.getY(j12) < 0); --j12) {
                    this.setBlockAndMetadata(world, i1, j12, k13, Blocks.cobblestone, 0);
                    this.setGrassToDirt(world, i1, j12 - 1, k13);
                }
                if (i2 == 5 && k2 == 8) {
                    for (j12 = 1; j12 <= 5; ++j12) {
                        this.setBlockAndMetadata(world, i1, j12, k13, LOTRMod.woodBeamV1, 1);
                    }
                    continue;
                }
                if (i2 == 5 || k2 == 8) {
                    for (j12 = 1; j12 <= 5; ++j12) {
                        this.setBlockAndMetadata(world, i1, j12, k13, Blocks.planks, 1);
                    }
                    continue;
                }
        ...
        for (k12 = -9; k12 <= 9; ++k12) {
            for (int l = 0; l <= 5; ++l) {
                this.setBlockAndMetadata(world, -6 + l, 5 + l, k12, LOTRMod.stairsReed, 1);
                this.setBlockAndMetadata(world, 6 - l, 5 + l, k12, LOTRMod.stairsReed, 0);
                this.setBlockAndMetadata(world, -6 + l, 4 + l, k12, LOTRMod.stairsReed, 4);
                this.setBlockAndMetadata(world, 6 - l, 4 + l, k12, LOTRMod.stairsReed, 5);
            }
            this.setBlockAndMetadata(world, 0, 10, k12, LOTRMod.thatch, 1);
            this.setBlockAndMetadata(world, 0, 11, k12, LOTRMod.slabSingleThatch, 1);
        }
        for (int l = 0; l <= 5; ++l) {
        ...
        for (k12 = -7; k12 <= 7; ++k12) {
            this.setBlockAndMetadata(world, -5, 5, k12, LOTRMod.woodBeamV1, 9);
            this.setBlockAndMetadata(world, 5, 5, k12, LOTRMod.woodBeamV1, 9);
            this.setBlockAndMetadata(world, -4, 5, k12, Blocks.fence, 0);
            this.setBlockAndMetadata(world, 4, 5, k12, Blocks.fence, 0);
        }
        for (i1 = -5; i1 <= 5; ++i1) {
            int i2 = Math.abs(i1);
        ...
        for (k12 = -7; k12 <= 7; ++k12) {
            ...
            if (k22 == 0 || k22 == 1 || k22 == 5 || k22 == 6) {
                this.setBlockAndMetadata(world, -5, 2, k12, LOTRMod.reedBars, 0);
                this.setBlockAndMetadata(world, -5, 3, k12, LOTRMod.reedBars, 0);
                this.setBlockAndMetadata(world, 5, 2, k12, LOTRMod.reedBars, 0);
                this.setBlockAndMetadata(world, 5, 3, k12, LOTRMod.reedBars, 0);
                continue;
            }
            if (k22 != 3) continue;
            for (j1 = 0; j1 <= 4; ++j1) {
                this.setBlockAndMetadata(world, -5, j1, k12, LOTRMod.woodBeamV1, 1);
                this.setBlockAndMetadata(world, 5, j1, k12, LOTRMod.woodBeamV1, 1);
            }
            this.setBlockAndMetadata(world, -3, 1, k12, Blocks.fence, 1);
            this.setBlockAndMetadata(world, -3, 2, k12, Blocks.torch, 5);
            this.setBlockAndMetadata(world, 3, 1, k12, Blocks.fence, 1);
            this.setBlockAndMetadata(world, 3, 2, k12, Blocks.torch, 5);
        }
        ...
        for (k12 = -7; k12 <= 7; ++k12) {
            ...
            for (k2 = 0; k2 < j1; ++k2) {
                int i13 = k22[k2];
                this.setBlockAndMetadata(world, i13, 1, k12, LOTRMod.planks2, 4);
                if (!random.nextBoolean()) continue;
                this.placeMug(world, random, i13, 2, k12, random.nextInt(4), this.getRandomDrink(random), new LOTRItemMug.Vessel[]{LOTRItemMug.Vessel.GOBLET_GOLD, LOTRItemMug.Vessel.GOBLET_SILVER, LOTRItemMug.Vessel.HORN, LOTRItemMug.Vessel.HORN_GOLD});
            }
        }
        for (i1 = -3; i1 <= 3; ++i1) {
            if (i1 == 0) continue;
