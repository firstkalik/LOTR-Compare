            ...
            for (i1 = -1; i1 <= 1; ++i1) {
                block9: for (int k12 = -1; k12 <= 1; ++k12) {
                    ...
                    for (int j1 = -3; j1 <= 3; ++j1) {
                        ...
                        if (doublegrass) {
                            this.setBlockAndMetadata(world, i1, j2, k12, (Block)Blocks.double_plant, 2);
                            this.setBlockAndMetadata(world, i1, j2 + 1, k12, (Block)Blocks.double_plant, 8);
                            continue block9;
                        }
                        this.setBlockAndMetadata(world, i1, j2, k12, (Block)Blocks.tallgrass, 1);
                        continue block9;
                    }
                }
            }
