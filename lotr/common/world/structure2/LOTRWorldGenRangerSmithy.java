...
public class LOTRWorldGenRangerSmithy
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if (this.restrictions) {
            ...
            for (i1 = -7; i1 <= 9; ++i1) {
                for (int k15 = -5; k15 <= 5; ++k15) {
                    j12 = this.getTopBlock(world, i1, k15) - 1;
                    if (!this.isSurface(world, i1, j12, k15)) {
                        return false;
                    }
                    if (j12 < minHeight) {
                        minHeight = j12;
        ...
        for (i12 = -7; i12 <= 8; ++i12) {
            for (k14 = -4; k14 <= 4; ++k14) {
                ...
                int k2 = Math.abs(k14);
                for (j14 = 1; j14 <= 8; ++j14) {
                    this.setAir(world, i12, j14, k14);
                }
                if (i12 <= 1 || i12 == 2 && k2 == 4) {
                    for (j14 = 0; !(j14 < 0 && this.isOpaque(world, i12, j14, k14) || this.getY(j14) < 0); --j14) {
                        this.setBlockAndMetadata(world, i12, j14, k14, this.cobbleBlock, this.cobbleMeta);
                        this.setGrassToDirt(world, i12, j14 - 1, k14);
                    }
                    continue;
                }
                ...
                if ((i12 == 2 || i12 == 8) && k2 <= 3 || i12 >= 3 && i12 <= 7 && k2 == 4) {
                    ...
                    for (j12 = 1; j12 <= 3; ++j12) {
                        this.setBlockAndMetadata(world, i12, j12, k14, this.wallBlock, this.wallMeta);
                    }
                ...
                for (j14 = 0; !(j14 < 0 && this.isOpaque(world, i12, j14, k14) || this.getY(j14) < 0); --j14) {
                    this.setBlockAndMetadata(world, i12, j14, k14, this.plankBlock, this.plankMeta);
                    this.setGrassToDirt(world, i12, j14 - 1, k14);
                }
        ...
        for (k1 = -2; k1 <= 2; ++k1) {
            ...
            this.setBlockAndMetadata(world, 8, 4, k1, this.woodBeamBlock, this.woodBeamMeta | 8);
        }
        ...
        for (k1 = -1; k1 <= 1; ++k1) {
            this.setBlockAndMetadata(world, 5, 7, k1, this.roofBlock, this.roofMeta);
            this.setBlockAndMetadata(world, 4, 7, k1, this.roofSlabBlock, this.roofSlabMeta);
            this.setBlockAndMetadata(world, 6, 7, k1, this.roofSlabBlock, this.roofSlabMeta);
        }
        ...
        for (l = 0; l <= 1; ++l) {
            ...
            for (k13 = -2 + l; k13 <= 2 - l; ++k13) {
                this.setBlockAndMetadata(world, 3 + l, j1, k13, this.roofSlabBlock, this.roofSlabMeta | 8);
                this.setBlockAndMetadata(world, 7 - l, j1, k13, this.roofSlabBlock, this.roofSlabMeta | 8);
            }
        }
        for (i12 = 7; i12 <= 9; ++i12) {
            for (k14 = -1; k14 <= 1; ++k14) {
                for (int j15 = 5; !(j15 < 0 && this.isOpaque(world, i12, j15, k14) || this.getY(j15) < 0); --j15) {
        ...
        for (k1 = -1; k1 <= 1; ++k1) {
            this.setBlockAndMetadata(world, 9, 5, k1, this.brickStairBlock, 0);
        }
        ...
        for (k1 = -3; k1 <= 3; ++k1) {
            this.setBlockAndMetadata(world, 5, 4, k1, this.woodBeamBlock, this.woodBeamMeta | 8);
        }
        ...
        for (j13 = 1; j13 <= 3; ++j13) {
            for (i13 = -6; i13 <= -3; ++i13) {
                for (k13 = 0; k13 <= 3; ++k13) {
                    this.setBlockAndMetadata(world, i13, j13, k13, this.brickBlock, this.brickMeta);
                }
            }
            this.setBlockAndMetadata(world, -2, j13, 3, this.brickBlock, this.brickMeta);
        }
        for (j13 = 1; j13 <= 3; ++j13) {
            this.setBlockAndMetadata(world, -6, j13, -3, this.fenceBlock, this.fenceMeta);
            this.setBlockAndMetadata(world, -2, j13, -3, this.fenceBlock, this.fenceMeta);
        }
        for (int l2 = 0; l2 <= 1; ++l2) {
            ...
            for (k13 = -2 + l2; k13 <= 2 - l2; ++k13) {
                this.setBlockAndMetadata(world, -6 + l2, j1, k13, this.brickStairBlock, 1);
                this.setBlockAndMetadata(world, -2 - l2, j1, k13, this.brickStairBlock, 0);
            }
        }
        for (k12 = -2; k12 <= 2; ++k12) {
            for (i13 = -5; i13 <= -3; ++i13) {
                this.setBlockAndMetadata(world, i13, 4, k12, this.brickBlock, this.brickMeta);
            }
        }
        for (k12 = -1; k12 <= 1; ++k12) {
            this.setBlockAndMetadata(world, -4, 5, k12, this.brickBlock, this.brickMeta);
        }
