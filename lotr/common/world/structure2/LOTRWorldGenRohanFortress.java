    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
            ...
            for (k12 = -12; k12 <= 12; ++k12) {
                ...
                for (j14 = 0; !(j14 < 0 && this.isOpaque(world, i12, j14, k12) || this.getY(j14) < 0); --j14) {
                    if (i2 == 12 && (k2 == 12 || k2 == 9 || k2 == 2) || k2 == 12 && (i2 == 12 || i2 == 9 || i2 == 2)) {
                        ...
                        if (randomGround == 0) {
                            this.setBlockAndMetadata(world, i12, j14, k12, (Block)Blocks.grass, 0);
        ...
        for (i12 = -12; i12 <= 12; ++i12) {
            for (k12 = -12; k12 <= 12; ++k12) {
                ...
                this.setBlockAndMetadata(world, i12, 5 + yBoost, k12, this.fenceBlock, this.fenceMeta);
                if (i2 == 9 && IntMath.mod((int)k12, (int)3) == 0 || k2 == 9 && IntMath.mod((int)i12, (int)3) == 0) {
        ...
        for (i2 = 0; i2 < k12; ++i2) {
            ...
            for (int k14 : new int[]{-12, 9}) {
                int i22;
                this.setBlockAndMetadata(world, i14 + 1, 8, k14, this.plank2StairBlock, 4);
                this.setBlockAndMetadata(world, i14 + 2, 8, k14, this.plank2StairBlock, 5);
                this.setBlockAndMetadata(world, i14 + 1, 8, k14 + 3, this.plank2StairBlock, 4);
                this.setBlockAndMetadata(world, i14 + 2, 8, k14 + 3, this.plank2StairBlock, 5);
                this.setBlockAndMetadata(world, i14, 8, k14 + 1, this.plank2StairBlock, 7);
                this.setBlockAndMetadata(world, i14, 8, k14 + 2, this.plank2StairBlock, 6);
                this.setBlockAndMetadata(world, i14 + 3, 8, k14 + 1, this.plank2StairBlock, 7);
                this.setBlockAndMetadata(world, i14 + 3, 8, k14 + 2, this.plank2StairBlock, 6);
                for (i22 = i14; i22 <= i14 + 3; ++i22) {
                ...
                for (int k22 = k14; k22 <= k14 + 3; ++k22) {
                    this.setBlockAndMetadata(world, i14 - 1, 9, k22, this.roofSlabBlock, this.roofSlabMeta);
                    this.setBlockAndMetadata(world, i14 + 4, 9, k22, this.roofSlabBlock, this.roofSlabMeta);
                }
                for (i22 = i14; i22 <= i14 + 3; ++i22) {
                    for (int k23 = k14; k23 <= k14 + 3; ++k23) {
                        if (i22 >= i14 + 1 && i22 <= i14 + 2 && k23 >= k14 + 1 && k23 <= k14 + 2) {
        ...
        for (k1 = -12; k1 <= 12; ++k1) {
            ...
            for (i15 = -1; i15 <= 1; ++i15) {
                this.setBlockAndMetadata(world, i15, 1, k1, this.plank2Block, this.plank2Meta);
                this.setBlockAndMetadata(world, i15, 4, k1, this.plank2Block, this.plank2Meta);
                this.setBlockAndMetadata(world, i15, 5, k1, this.woodBeam2Block, this.woodBeam2Meta | 4);
                this.setBlockAndMetadata(world, i15, 6, k1, this.fenceBlock, this.fenceMeta);
                this.setBlockAndMetadata(world, i15, 5, k1 - 1 * Integer.signum(k1), this.plankSlabBlock, this.plankSlabMeta);
            }
        ...
        for (i1 = -12; i1 <= 12; ++i1) {
            ...
            for (k13 = -1; k13 <= 1; ++k13) {
                ...
                this.setBlockAndMetadata(world, i1, 4, k13, this.plank2Block, this.plank2Meta);
                this.setBlockAndMetadata(world, i1, 5, k13, this.woodBeam2Block, this.woodBeam2Meta | 8);
                this.setBlockAndMetadata(world, i1, 6, k13, this.fenceBlock, this.fenceMeta);
                this.setBlockAndMetadata(world, i1 - 1 * Integer.signum(i1), 5, k13, this.plankSlabBlock, this.plankSlabMeta);
            }
        ...
        for (k1 = -12; k1 <= -10; ++k1) {
            for (j1 = 1; j1 <= 4; ++j1) {
                ...
                this.setBlockAndMetadata(world, -2, j1, k1, this.woodBeam2Block, this.woodBeam2Meta);
                this.setBlockAndMetadata(world, 2, j1, k1, this.woodBeam2Block, this.woodBeam2Meta);
            }
            for (i13 = -1; i13 <= 1; ++i13) {
                this.setBlockAndMetadata(world, i13, 4, k1, this.woodBeam2Block, this.woodBeam2Meta | 4);
            }
        }
        for (j13 = 1; j13 <= 3; ++j13) {
            for (i13 = -1; i13 <= 1; ++i13) {
                this.setBlockAndMetadata(world, i13, j13, -11, this.gateBlock, 3);
            }
        }
        for (i1 = -1; i1 <= 1; ++i1) {
            this.setBlockAndMetadata(world, i1, 4, -12, this.plank2StairBlock, 6);
        ...
        for (j12 = 0; j12 < i13; ++j12) {
            i14 = j16[j12];
            this.setBlockAndMetadata(world, i14, 1, 0, this.fenceBlock, this.fenceMeta);
            this.setBlockAndMetadata(world, i14, 2, 0, this.fenceBlock, this.fenceMeta);
            this.setBlockAndMetadata(world, i14, 3, 0, Blocks.torch, 5);
            for (int l = 0; l < 2; ++l) {
                LOTREntityHorse horse = new LOTREntityHorse(world);
                this.spawnNPCAndSetHome((EntityCreature)horse, world, i14 - Integer.signum(i14) * 3, 1, 0, 0);
                horse.setHorseType(0);
                horse.saddleMountForWorldGen();
                horse.detachHome();
                this.leashEntityTo((EntityCreature)horse, world, i14, 2, 0);
            }
        }
        ...
        for (k12 = 5; k12 <= 9; ++k12) {
            for (i15 = -9; i15 <= -5; ++i15) {
                this.setBlockAndMetadata(world, i15, 3, k12, this.plank2SlabBlock, this.plank2SlabMeta);
            }
        }
        this.setBlockAndMetadata(world, -9, 3, 9, this.plank2Block, this.plank2Meta);
        for (j1 = 1; j1 <= 2; ++j1) {
        ...
        for (k12 = 5; k12 <= 10; ++k12) {
            for (i15 = 5; i15 <= 10; ++i15) {
                this.setBlockAndMetadata(world, i15, 0, k12, this.plank2Block, this.plank2Meta);
                this.setAir(world, i15, 1, k12);
                this.setAir(world, i15, 2, k12);
                this.setBlockAndMetadata(world, i15, 3, k12, this.plank2Block, this.plank2Meta);
            }
        }
        for (k12 = 4; k12 <= 9; ++k12) {
        ...
        for (i13 = 5; i13 <= 9; ++i13) {
            this.setBlockAndMetadata(world, i13, 3, 4, this.plank2StairBlock, 2);
        }
        for (k12 = 5; k12 <= 10; ++k12) {
        ...
        for (i13 = 6; i13 <= 10; ++i13) {
            this.setBlockAndMetadata(world, i13, 1, 5, this.plankBlock, this.plankMeta);
            this.setBlockAndMetadata(world, i13, 2, 5, this.plankBlock, this.plankMeta);
        }
        ...
        for (i13 = 6; i13 <= 10; ++i13) {
            if (IntMath.mod((int)i13, (int)2) == 0) {
                this.setBlockAndMetadata(world, i13, 2, 6, Blocks.torch, 3);
                this.setBlockAndMetadata(world, i13, 2, 10, Blocks.torch, 4);
            }
        ...
        for (k1 = -8; k1 <= -7; ++k1) {
            for (i15 = 6; i15 <= 9; ++i15) {
                int stairHeight = i15 - 5;
                for (int j19 = 0; j19 < stairHeight; ++j19) {
                    this.setBlockAndMetadata(world, i15, j19, k1, this.plankBlock, this.plankMeta);
                }
                this.setBlockAndMetadata(world, i15, stairHeight, k1, this.plankStairBlock, 1);
            }
