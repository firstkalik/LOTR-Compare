...
extends LOTRWorldGenRohanStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (j12 = 7; j12 <= 9; ++j12) {
            this.setBlockAndMetadata(world, 0, j12, 3, this.brickBlock, this.brickMeta);
        }
        ...
        for (j12 = 3; j12 <= 4; ++j12) {
            this.setBlockAndMetadata(world, -1, j12, 2, this.brickWallBlock, this.brickWallMeta);
            this.setBlockAndMetadata(world, 1, j12, 2, this.brickWallBlock, this.brickWallMeta);
        }
        ...
        for (j12 = 3; j12 <= 4; ++j12) {
            ...
            this.placeWeaponRack(world, 3, j12, 2, 6, weapon);
        }
