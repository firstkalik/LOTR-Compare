...
public class LOTRWorldGenRohanSmithy
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i1 = -10; i1 <= 5; ++i1) {
            for (int k13 = -3; k13 <= 4; ++k13) {
                ...
                if (corner) {
                    for (j12 = 1; !(j12 < 1 && this.isOpaque(world, i1, j12, k13) || this.getY(j12) < 0); --j12) {
                        this.setBlockAndMetadata(world, i1, j12, k13, this.rockSlabDoubleBlock, this.rockSlabDoubleMeta);
                ...
                for (j12 = 1; !(j12 < 1 && this.isOpaque(world, i1, j12, k13) || this.getY(j12) < 0); --j12) {
                    this.setBlockAndMetadata(world, i1, j12, k13, this.brickBlock, this.brickMeta);
                    this.setGrassToDirt(world, i1, j12 - 1, k13);
                }
            }
        }
        ...
        for (i1 = -4; i1 <= 4; ++i1) {
            ...
            if (i2 == 2) {
                for (j13 = 1; j13 <= 2; ++j13) {
                    this.setBlockAndMetadata(world, i1, j13, -3, this.logBlock, this.logMeta);
                }
                for (j13 = 3; j13 <= 4; ++j13) {
                    this.setBlockAndMetadata(world, i1, j13, -3, this.fenceBlock, this.fenceMeta);
                }
            }
            if (i2 == 3) {
                for (j13 = 2; j13 <= 4; ++j13) {
                    this.setBlockAndMetadata(world, i1, j13, -2, this.plankBlock, this.plankMeta);
                }
            }
            if (i2 == 4) {
                int[] j15 = new int[]{-2, 3};
            ...
            for (k1 = -1; k1 <= 2; ++k1) {
                for (j12 = 2; j12 <= 4; ++j12) {
                    if (k1 >= 0 && k1 <= 1 && j12 >= 3) {
                        this.setBlockAndMetadata(world, i1, j12, k1, this.barsBlock, 0);
                        continue;
                    }
        ...
        for (i1 = -3; i1 <= 3; ++i1) {
            ...
            if (i2 <= 1) {
                for (j13 = 2; j13 <= 6; ++j13) {
                    this.setBlockAndMetadata(world, i1, j13, 3, this.brickBlock, this.brickMeta);
                }
            }
            if (i2 == 2) {
        ...
        for (j14 = 7; j14 <= 9; ++j14) {
            this.setBlockAndMetadata(world, 0, j14, 3, this.brickBlock, this.brickMeta);
        }
        ...
        for (j14 = 3; j14 <= 4; ++j14) {
            this.setBlockAndMetadata(world, -1, j14, 2, this.brickWallBlock, this.brickWallMeta);
            this.setBlockAndMetadata(world, 1, j14, 2, this.brickWallBlock, this.brickWallMeta);
        }
        ...
        for (j14 = 3; j14 <= 4; ++j14) {
            ...
            this.placeWeaponRack(world, 3, j14, 2, 6, weapon);
        }
