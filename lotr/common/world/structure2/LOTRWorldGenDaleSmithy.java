...
public class LOTRWorldGenDaleSmithy
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i1 = -4; i1 <= 4; ++i1) {
            for (k1 = -1; k1 <= 11; ++k1) {
                int j14;
                int i2 = Math.abs(i1);
                if (i2 == 4 && IntMath.mod((int)k1, (int)4) == 3 || i1 == 0 && k1 == 11) {
        ...
        for (k12 = -1; k12 <= 11; ++k12) {
            ...
            if (IntMath.mod((int)k12, (int)2) != 0) continue;
        ...
        for (i1 = -4; i1 <= 4; ++i1) {
            ...
            if (IntMath.mod((int)i1, (int)4) != 2) continue;
        ...
        for (k12 = -1; k12 <= 11; ++k12) {
            ...
            if (IntMath.mod((int)k12, (int)4) != 1) continue;
