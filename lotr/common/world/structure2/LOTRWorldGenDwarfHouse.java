...
extends LOTRWorldGenStructureBase2 {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        if (this.restrictions && this.usingPlayer == null) {
            ...
            int xzRange = 5;
            int yRange = 4;
            for (i13 = -xzRange; i13 <= xzRange; ++i13) {
                for (int j14 = -yRange; j14 <= yRange; ++j14) {
                    for (int k13 = -xzRange; k13 <= xzRange; ++k13) {
                        if (!this.isAir(world, i13, j14, k13)) continue;
                        return false;
                    }
                }
            }
        ...
        for (i1 = -7; i1 <= 7; ++i1) {
            for (k12 = -7; k12 <= 7; ++k12) {
                ...
                int top = 13 - dist;
                for (int j15 = top = Math.min(top, 7); !(j15 < -5 && this.isOpaque(world, i1, j15, k12) || this.getY(j15) < 0); --j15) {
                    if (this.isOpaque(world, i1, j15, k12)) continue;
                    Block block = null;
                    int meta = -1;
                    if (j15 >= top - 4) {
                        if (this.isOpaque(world, i1, j15 + 1, k12)) {
                    ...
                    this.setBlockAndMetadata(world, i1, j15, k12, block, meta);
                    this.setGrassToDirt(world, i1, j15 - 1, k12);
                }
            }
        }
        for (j13 = 1; j13 <= 3; ++j13) {
            ...
            for (i13 = -i22; i13 <= i22; ++i13) {
                this.setBlockAndMetadata(world, i13, j13, -7, this.stoneBlock, this.stoneMeta);
            }
        }
        for (i1 = -11; i1 <= 11; ++i1) {
            for (k12 = -11; k12 <= 11; ++k12) {
                ...
                while (!this.isOpaque(world, i1, j16, k12) && this.getY(j16) >= 0) {
                    Block block = null;
                    int meta = -1;
                    if (j16 >= top - 4) {
                        if (this.isOpaque(world, i1, j16 + 1, k12)) {
                            block = this.fillerBlock;
                            meta = this.fillerMeta;
                        } else {
                            block = this.topBlock;
                    ...
                    if (block != null) {
                        this.setBlockAndMetadata(world, i1, j16, k12, block, meta);
        ...
        for (i1 = -6; i1 <= 6; ++i1) {
            for (k12 = -6; k12 <= 6; ++k12) {
                for (j12 = -4; j12 <= 4; ++j12) {
                    if (Math.abs(i1) == 6 || Math.abs(k12) == 6) {
                        if (j12 == 2) {
                            this.setBlockAndMetadata(world, i1, j12, k12, this.plankBlock, this.plankMeta);
                            continue;
                        }
                        this.setBlockAndMetadata(world, i1, j12, k12, this.brick2Block, this.brick2Meta);
                        continue;
                    }
        ...
        for (k1 = -4; k1 <= -3; ++k1) {
            for (i12 = -3; i12 <= 3; ++i12) {
                this.setBlockAndMetadata(world, i12, 1, k1, this.carpetBlock, this.carpetMeta);
            }
        }
        for (k1 = -1; k1 <= 3; ++k1) {
            for (i12 = -1; i12 <= 1; ++i12) {
                if (Math.abs(i12) == 1 && (k1 == -1 || k1 == 3)) {
                    this.setBlockAndMetadata(world, i12, 1, k1, this.plankBlock, this.plankMeta);
                } else {
                    this.setBlockAndMetadata(world, i12, 1, k1, this.plankSlabBlock, this.plankSlabMeta | 8);
                }
                if (random.nextInt(3) == 0) {
                    this.placeMug(world, random, i12, 2, k1, random.nextInt(4), this.drinkFoods);
                    continue;
                }
                this.placePlate(world, random, i12, 2, k1, this.plateBlock, this.plateFoods);
            }
        }
        ...
        for (i1 = -1; i1 <= 1; ++i1) {
            ...
            this.setBlockAndMetadata(world, i1, 2, 5, (Block)Blocks.fire, 0);
        ...
        for (k1 = -5; k1 <= 5; ++k1) {
            for (j1 = -3; j1 <= -1; ++j1) {
                for (i13 = -1; i13 <= 1; ++i13) {
                    this.setBlockAndMetadata(world, i13, j1, k1, this.plankBlock, this.plankMeta);
                }
            }
        }
        for (j13 = -3; j13 <= -1; ++j13) {
        ...
        for (i1 = 3; i1 <= 4; ++i1) {
            ...
            this.setBlockAndMetadata(world, i1, -1, 5, this.brickStairBlock, 6);
            for (k12 = -2; k12 <= 0; ++k12) {
                this.setBlockAndMetadata(world, i1, -3, k12, this.carpetBlock, this.carpetMeta);
            }
            this.setBlockAndMetadata(world, i1, -3, -3, LOTRMod.dwarvenBed, 2);
            this.setBlockAndMetadata(world, i1, -3, -4, LOTRMod.dwarvenBed, 10);
            this.placeChest(world, random, i1, -2, -5, 3, this.personalContents, MathHelper.getRandomIntegerInRange((Random)random, (int)2, (int)4));
        }
        for (k1 = -4; k1 <= -3; ++k1) {
            this.setBlockAndMetadata(world, 5, -3, k1, this.plankBlock, this.plankMeta);
            this.setBlockAndMetadata(world, 6, -2, k1, this.plankBlock, this.plankMeta);
