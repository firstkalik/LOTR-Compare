...
extends LOTRWorldGenStructureBase2 {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (int l = 0; l < animals; ++l) {
            Class animalClass = ((BiomeGenBase.SpawnListEntry)WeightedRandom.getRandomItem((Random)world.rand, (Collection)LOTRBiome.shire.getSpawnableList((EnumCreatureType)EnumCreatureType.creature))).entityClass;
            EntityCreature animal = null;
            try {
                animal = (EntityCreature)animalClass.getConstructor(World.class).newInstance(new Object[]{world});
            }
