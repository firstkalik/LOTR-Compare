...
public class LOTRWorldGenBlackUrukFort2
extends LOTRWorldGenCampBase {
    public LOTRWorldGenBlackUrukFort2(boolean flag) {
        super(flag);
    }
    ...
    protected LOTREntityNPC getCampCaptain(World world, Random random) {
        return random.nextBoolean() ? new LOTREntityUtumnoTrader(world) : new LOTREntityUtumnoTrader(world);
    }
