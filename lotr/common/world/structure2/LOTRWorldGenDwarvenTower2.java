...
public class LOTRWorldGenDwarvenTower2
extends LOTRWorldGenStructureBase2 {
    protected Block brickBlock = LOTRMod.brick9;
    protected int brickMeta = 5;
    protected Block brickSlabBlock = LOTRMod.slabSingle120;
    protected int brickSlabMeta = 1;
    protected Block brickStairBlock = LOTRMod.stairsGreyDwarf;
    protected Block brickWallBlock = LOTRMod.wallStone8;
    protected int brickWallMeta = 4;
    protected Block pillarBlock = LOTRMod.pillar4;
    protected int pillarMeta = 4;
    protected Block plankBlock;
    protected int plankMeta;
    protected Block plankSlabBlock;
    protected int plankSlabMeta;
    protected Block barsBlock = LOTRMod.greydwarfBars;
    ...
    public LOTRWorldGenDwarvenTower2(boolean flag) {
        super(flag);
    }
