...
public class LOTRWorldGenDwarfHouse3
extends LOTRWorldGenStructureBase2 {
    ...
    public LOTRWorldGenDwarfHouse3(boolean flag) {
        super(flag);
    }
    ...
    private ItemStack[] getDisplayArmorOrNull(World world, Random random) {
        LOTREntityBlacklockWarrior armorGuard = new LOTREntityBlacklockWarrior(world);
    ...
    protected void setupRandomBlocks(Random random) {
        ...
        this.pillarBlock2 = LOTRMod.slabSingle3;
        this.pillarMeta2 = 6;
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.setBlockAndMetadata(world, -4, 2, -5, LOTRMod.reddwarvenTorchSilver, 2);
        this.setBlockAndMetadata(world, -5, 2, -4, LOTRMod.reddwarvenTorchSilver, 3);
        this.setBlockAndMetadata(world, -4, 2, 5, LOTRMod.reddwarvenTorchSilver, 2);
        this.setBlockAndMetadata(world, -5, 2, 4, LOTRMod.reddwarvenTorchSilver, 4);
        this.setBlockAndMetadata(world, 4, 2, -5, LOTRMod.reddwarvenTorchSilver, 1);
        this.setBlockAndMetadata(world, 5, 2, -4, LOTRMod.reddwarvenTorchSilver, 3);
        this.setBlockAndMetadata(world, 4, 2, 5, LOTRMod.reddwarvenTorchSilver, 1);
        this.setBlockAndMetadata(world, 5, 2, 4, LOTRMod.reddwarvenTorchSilver, 4);
        for (i13 = -4; i13 <= 4; ++i13) {
        ...
        this.setBlockAndMetadata(world, -5, -2, 4, LOTRMod.reddwarvenTorchSilver, 4);
        this.setBlockAndMetadata(world, -2, -2, 4, LOTRMod.reddwarvenTorchSilver, 4);
        this.setBlockAndMetadata(world, -2, -2, -4, LOTRMod.reddwarvenTorchSilver, 3);
        for (k1 = -4; k1 <= 4; ++k1) {
        ...
        for (i13 = -4; i13 <= -3; ++i13) {
            ...
            this.setBlockAndMetadata(world, i13, -3, 5, LOTRMod.dwarvenForge, 2);
            this.setBlockAndMetadata(world, i13, -2, 6, this.plankBlock, this.plankMeta);
