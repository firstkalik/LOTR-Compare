...
extends LOTRWorldGenHobbitStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i12 = -4; i12 <= 3; ++i12) {
            for (k1 = -10; k1 <= -6; ++k1) {
                ...
                for (j14 = 0; !(j14 < 0 && this.isOpaque(world, i12, j14, k1) || this.getY(j14) < 0); --j14) {
                    if (j14 == 0) {
                        this.setBlockAndMetadata(world, i12, j14, k1, (Block)Blocks.grass, 0);
                    } else {
        ...
        for (i12 = 3; i12 <= 5; ++i12) {
            this.setBlockAndMetadata(world, i12, 3, 4, (Block)Blocks.double_stone_slab, 0);
        }
        for (k12 = 1; k12 <= 3; ++k12) {
            this.setBlockAndMetadata(world, 6, 3, k12, (Block)Blocks.double_stone_slab, 0);
        }
