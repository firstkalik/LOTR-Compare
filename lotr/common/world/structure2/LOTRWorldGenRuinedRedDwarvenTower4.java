...
public class LOTRWorldGenRuinedRedDwarvenTower4
extends LOTRWorldGenStructureBase2 {
    ...
    public LOTRWorldGenRuinedRedDwarvenTower4(boolean flag) {
        super(flag);
    }
    ...
    private ItemStack[] getDisplayArmorOrNull(World world, Random random) {
        LOTREntityIronfistWarrior armorGuard = new LOTREntityIronfistWarrior(world);
