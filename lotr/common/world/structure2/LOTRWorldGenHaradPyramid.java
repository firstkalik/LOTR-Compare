...
public class LOTRWorldGenHaradPyramid
extends LOTRWorldGenStructureBase2 {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.originY += MathHelper.getRandomIntegerInRange((Random)random, (int)-2, (int)4);
    ...
    private void placePyramidChest(World world, Random random, int i, int j, int k, int meta, boolean trap) {
        int amount = MathHelper.getRandomIntegerInRange((Random)random, (int)3, (int)5);
        if (trap) {
