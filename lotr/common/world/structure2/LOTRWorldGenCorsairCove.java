...
public class LOTRWorldGenCorsairCove
extends LOTRWorldGenCorsairStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        this.placeChest(world, random, -14, 4, 4, (Block)Blocks.chest, 4, LOTRChestContents.CORSAIR, MathHelper.getRandomIntegerInRange((Random)random, (int)6, (int)12));
