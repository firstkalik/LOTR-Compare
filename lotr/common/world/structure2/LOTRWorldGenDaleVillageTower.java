    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i1 = -3; i1 <= 3; ++i1) {
            for (k1 = -3; k1 <= 3; ++k1) {
                ...
                this.setBlockAndMetadata(world, i1, 12, k1, (Block)Blocks.fire, 0);
        ...
        for (i12 = -2; i12 <= 2; ++i12) {
            this.setBlockAndMetadata(world, i12, 10, -2, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i12, 10, 2, this.roofStairBlock, 3);
        }
        ...
        for (i12 = -1; i12 <= 1; ++i12) {
            this.setBlockAndMetadata(world, i12, 13, -1, this.roofStairBlock, 2);
            this.setBlockAndMetadata(world, i12, 13, 1, this.roofStairBlock, 3);
        }
