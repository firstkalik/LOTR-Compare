...
public class LOTRWorldGenDaleBakery
extends LOTRWorldGenDaleStructure {
    ...
    public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
        ...
        for (i1 = -5; i1 <= 5; ++i1) {
            for (k15 = 0; k15 <= 13; ++k15) {
                j1 = 0;
                while (!this.isOpaque(world, i1, j1, k15) && this.getY(j1) >= 0) {
                    this.setBlockAndMetadata(world, i1, j1, k15, this.brickBlock, this.brickMeta);
                    this.setGrassToDirt(world, i1, j1 - 1, k15);
                    --j1;
                }
                for (j1 = 1; j1 <= 7; ++j1) {
                    this.setAir(world, i1, j1, k15);
                }
                if (Math.abs(i1) == 5 || k15 == 0 || k15 == 13) {
                    for (j1 = 1; j1 <= 3; ++j1) {
                        this.setBlockAndMetadata(world, i1, j1, k15, this.brickBlock, this.brickMeta);
                    }
                    continue;
        ...
        for (i1 = -6; i1 <= 6; ++i1) {
            for (k15 = -1; k15 <= 14; ++k15) {
                if ((Math.abs(i1) != 6 || k15 != -1 && k15 != 14) && (Math.abs(i1) != 1 || k15 != -1)) continue;
                for (j1 = 4; !(j1 < 1 && this.isOpaque(world, i1, j1, k15) || this.getY(j1) < 0); --j1) {
                    this.setBlockAndMetadata(world, i1, j1, k15, this.woodBeamBlock, this.woodBeamMeta);
                    this.setGrassToDirt(world, i1, j1 - 1, k15);
                }
            }
        }
        for (i1 = -1; i1 <= 1; ++i1) {
            if (Math.abs(i1) == 1) {
                k15 = -2;
                for (j1 = 2; !(j1 < 1 && this.isOpaque(world, i1, j1, k15) || this.getY(j1) < 0); --j1) {
                    this.setBlockAndMetadata(world, i1, j1, k15, this.fenceBlock, this.fenceMeta);
                }
                continue;
            }
            if (i1 != 0) continue;
            k15 = -1;
            for (j1 = 0; !(j1 < 0 && this.isOpaque(world, i1, j1, k15) || this.getY(j1) < 0); --j1) {
                this.setBlockAndMetadata(world, i1, j1, k15, this.floorBlock, this.floorMeta);
                this.setGrassToDirt(world, i1, j1 - 1, k15);
            }
        }
        for (i1 = -5; i1 <= 5; ++i1) {
        ...
        for (int i15 : new int[]{-5, 2}) {
            this.setBlockAndMetadata(world, i15, 2, -1, this.trapdoorBlock, 12);
            ...
            this.setBlockAndMetadata(world, i15 + 3, 2, -1, this.trapdoorBlock, 12);
        ...
        for (j1 = 0; j1 < k15; ++j1) {
            int i15;
            i15 = k16[j1];
            this.setBlockAndMetadata(world, i15, 2, 14, this.trapdoorBlock, 13);
            ...
            this.setBlockAndMetadata(world, i15 + 3, 2, 14, this.trapdoorBlock, 13);
        ...
        for (k14 = 0; k14 <= 13; ++k14) {
            if (k14 == 0 || k14 == 3 || k14 == 6 || k14 == 8 || k14 == 13) {
                this.setBlockAndMetadata(world, -6, 2, k14, this.trapdoorBlock, 15);
                ...
                this.setBlockAndMetadata(world, 6, 2, k14, this.trapdoorBlock, 14);
                this.setBlockAndMetadata(world, 6, 3, k14, this.brickSlabBlock, this.brickSlabMeta | 8);
                this.setBlockAndMetadata(world, 7, 4, k14, this.brickBlock, this.brickMeta);
            }
        ...
        for (k14 = 0; k14 <= 13; ++k14) {
            for (i12 = -5; i12 <= 5; ++i12) {
                ...
                this.setBlockAndMetadata(world, i12, 4, k14, this.plankBlock, this.plankMeta);
            }
            for (i12 = -6; i12 <= 6; ++i12) {
                this.setBlockAndMetadata(world, i12, 5, k14, this.roofBlock, this.roofMeta);
            }
            for (i12 = -5; i12 <= 5; ++i12) {
                this.setBlockAndMetadata(world, i12, 6, k14, this.roofBlock, this.roofMeta);
            }
        }
        for (int k17 : new int[]{-1, 14}) {
            int i16;
            for (i16 = -6; i16 <= 6; ++i16) {
                this.setBlockAndMetadata(world, i16, 5, k17, this.plankBlock, this.plankMeta);
            }
            for (i16 = -5; i16 <= 5; ++i16) {
                this.setBlockAndMetadata(world, i16, 6, k17, this.plankBlock, this.plankMeta);
            }
        }
        ...
        for (int k19 = -2; k19 <= 15; ++k19) {
            ...
            for (i12 = -4; i12 <= 4; ++i12) {
                this.setBlockAndMetadata(world, i12, 7, k19, this.roofBlock, this.roofMeta);
            }
            for (i12 = -2; i12 <= 2; ++i12) {
                this.setBlockAndMetadata(world, i12, 8, k19, this.roofSlabBlock, this.roofSlabMeta);
            }
        ...
        for (int j15 : new int[]{1, 8}) {
            ...
            this.setBlockAndMetadata(world, 0, j15 + 1, 12, (Block)Blocks.fire, 0);
        }
        ...
        this.setBlockAndMetadata(world, 2, 3, 4, LOTRMod.chandelier, 3);
        for (i13 = -4; i13 <= 4; ++i13) {
            this.setBlockAndMetadata(world, i13, 1, 7, this.brickBlock, this.brickMeta);
            this.setBlockAndMetadata(world, i13, 3, 7, this.fenceBlock, this.fenceMeta);
        }
        ...
        for (i13 = -2; i13 <= 2; ++i13) {
            for (k15 = 10; k15 <= 12; ++k15) {
                this.setBlockAndMetadata(world, i13, 4, k15, Blocks.brick_block, 0);
            }
        }
        ...
        for (k12 = 2; k12 <= 5; ++k12) {
            this.setBlockAndMetadata(world, -4, 1, k12, this.plankSlabBlock, this.plankSlabMeta | 8);
        }
        ...
        for (k12 = 1; k12 <= 6; ++k12) {
            this.placeRandomCake(world, random, -4, 2, k12);
        }
        for (i13 = -3; i13 <= -2; ++i13) {
            this.placeRandomCake(world, random, i13, 2, 1);
            this.placeRandomCake(world, random, i13, 2, 6);
        }
        ...
        for (i13 = -4; i13 <= -3; ++i13) {
            this.setBlockAndMetadata(world, i13, 1, 8, this.plankBlock, this.plankMeta);
            for (k15 = 9; k15 <= 11; ++k15) {
                this.setBlockAndMetadata(world, i13, 1, k15, this.plankSlabBlock, this.plankSlabMeta | 8);
            }
            this.setBlockAndMetadata(world, i13, 1, 12, this.plankBlock, this.plankMeta);
            for (k15 = 8; k15 <= 12; ++k15) {
                this.placeRandomCake(world, random, i13, 2, k15);
            }
        }
