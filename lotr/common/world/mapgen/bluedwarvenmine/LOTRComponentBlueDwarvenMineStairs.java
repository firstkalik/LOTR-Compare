...
public class LOTRComponentBlueDwarvenMineStairs
extends StructureComponent {
    public LOTRComponentBlueDwarvenMineStairs() {
    }

    public LOTRComponentBlueDwarvenMineStairs(int i, Random random, StructureBoundingBox structureBoundingBox, int j, boolean r) {
        super(i);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        ...
        switch (this.coordBaseMode) {
            case 0: {
                LOTRStructureBlueDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i, false);
                break;
            }
            case 1: {
                LOTRStructureBlueDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, 1, i, false);
                break;
            }
            case 2: {
                LOTRStructureBlueDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i, false);
                break;
            }
            case 3: {
                LOTRStructureBlueDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, 3, i, false);
            }
        }
    }
