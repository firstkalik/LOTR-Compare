...
public class LOTRComponentMoriaDwarvenMineEntrance
extends StructureComponent {
    ...
    public LOTRComponentMoriaDwarvenMineEntrance() {
    }

    public LOTRComponentMoriaDwarvenMineEntrance(World world, int l, Random random, int i, int k, boolean r) {
        super(l);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        ...
        LOTRComponentMoriaDwarvenMineCorridor corridor = new LOTRComponentMoriaDwarvenMineCorridor(0, random, structureBoundingBox, this.direction, this.ruined);
        list.add(corridor);
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBoundingBox) {
        ...
        LOTRComponentMoriaDwarvenMineEntrance.entranceGen.isRuined = this.ruined;
        entranceGen.generateWithSetRotation(world, random, this.posX, this.posY, this.posZ, this.direction);
        return true;
    }

    static {
        LOTRComponentMoriaDwarvenMineEntrance.entranceGen.restrictions = false;
    }
}
