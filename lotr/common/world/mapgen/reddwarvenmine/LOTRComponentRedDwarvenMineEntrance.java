...
import lotr.common.world.mapgen.reddwarvenmine.LOTRWorldGenRedDwarfMineEntrance;
...
public class LOTRComponentRedDwarvenMineEntrance
extends StructureComponent {
    private int posX;
    private int posY = -1;
    private int posZ;
    private static LOTRWorldGenRedDwarfMineEntrance entranceGen = new LOTRWorldGenRedDwarfMineEntrance(false);
    private int direction;
    private boolean ruined;

    public LOTRComponentRedDwarvenMineEntrance() {
    }

    public LOTRComponentRedDwarvenMineEntrance(World world, int l, Random random, int i, int k, boolean r) {
        super(l);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        ...
        LOTRComponentRedDwarvenMineCorridor corridor = new LOTRComponentRedDwarvenMineCorridor(0, random, structureBoundingBox, this.direction, this.ruined);
        list.add(corridor);
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBoundingBox) {
        ...
        LOTRComponentRedDwarvenMineEntrance.entranceGen.isRuined = this.ruined;
        entranceGen.generateWithSetRotation(world, random, this.posX, this.posY, this.posZ, this.direction);
        return true;
    }

    static {
        LOTRComponentRedDwarvenMineEntrance.entranceGen.restrictions = false;
    }
}
