...
import lotr.common.world.mapgen.reddwarvenmine.LOTRStructureRedDwarvenMinePieces;
...
public class LOTRComponentRedDwarvenMineCorridor
extends StructureComponent {
    private int sectionCount;
    private boolean ruined;

    public LOTRComponentRedDwarvenMineCorridor() {
    }

    public LOTRComponentRedDwarvenMineCorridor(int i, Random random, StructureBoundingBox structureBoundingBox, int j, boolean r) {
        super(i);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        block24: {
            ...
            switch (this.coordBaseMode) {
                case 0: {
                    if (j <= 1) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.maxZ + 1, this.coordBaseMode, i, this.ruined);
                        break;
                    }
                    if (j == 2) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.maxZ - 3, 1, i, this.ruined);
                        break;
                    }
                    LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.maxZ - 3, 3, i, this.ruined);
                    break;
                }
                case 1: {
                    if (j <= 1) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i, this.ruined);
                        break;
                    }
                    if (j == 2) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ - 1, 2, i, this.ruined);
                        break;
                    }
                    LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.maxZ + 1, 0, i, this.ruined);
                    break;
                }
                case 2: {
                    if (j <= 1) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ - 1, this.coordBaseMode, i, this.ruined);
                        break;
                    }
                    if (j == 2) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ, 1, i, this.ruined);
                        break;
                    }
                    LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ, 3, i, this.ruined);
                    break;
                }
                case 3: {
                    if (j <= 1) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i, this.ruined);
                        break;
                    }
                    if (j == 2) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.minZ - 1, 2, i, this.ruined);
                        break;
                    }
                    LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + random.nextInt(3), this.boundingBox.maxZ + 1, 0, i, this.ruined);
                }
            }
            ...
            if (this.coordBaseMode != 2 && this.coordBaseMode != 0) {
                ...
                while (k + 3 <= this.boundingBox.maxX) {
                    ...
                    if (l == 0) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, k, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i + 1, this.ruined);
                    } else if (l == 1) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, k, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i + 1, this.ruined);
                    }
                    k += 4;
                }
            } else {
                ...
                while (k + 3 <= this.boundingBox.maxZ) {
                    int l = random.nextInt(5);
                    if (l == 0) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, k, 1, i + 1, this.ruined);
                    } else if (l == 1) {
                        LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY, k, 3, i + 1, this.ruined);
                    }
                    k += 4;
                }
            }
