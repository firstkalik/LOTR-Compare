...
public class LOTRComponentRedDwarvenMineCrossing
extends StructureComponent {
    private int corridorDirection;
    private boolean isMultipleFloors;
    private boolean ruined;

    public LOTRComponentRedDwarvenMineCrossing() {
    }

    public LOTRComponentRedDwarvenMineCrossing(int i, Random random, StructureBoundingBox structureBoundingBox, int j, boolean r) {
        super(i);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        ...
        switch (this.corridorDirection) {
            case 0: {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i, this.ruined);
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i, this.ruined);
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 3, i, this.ruined);
                break;
            }
            case 1: {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i, this.ruined);
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i, this.ruined);
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i, this.ruined);
                break;
            }
        ...
        if (this.isMultipleFloors) {
            if (random.nextBoolean()) {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, 2, i, this.ruined);
            }
            if (random.nextBoolean()) {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, 1, i, this.ruined);
            }
            if (random.nextBoolean()) {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, 3, i, this.ruined);
            }
            if (random.nextBoolean()) {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, 0, i, this.ruined);
            }
        }
    }
