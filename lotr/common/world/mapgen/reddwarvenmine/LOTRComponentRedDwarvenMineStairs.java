...
public class LOTRComponentRedDwarvenMineStairs
extends StructureComponent {
    private boolean ruined;

    public LOTRComponentRedDwarvenMineStairs() {
    }

    public LOTRComponentRedDwarvenMineStairs(int i, Random random, StructureBoundingBox structureBoundingBox, int j, boolean r) {
        super(i);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        ...
        switch (this.coordBaseMode) {
            case 0: {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i, this.ruined);
                break;
            }
            case 1: {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, 1, i, this.ruined);
                break;
            }
            case 2: {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i, this.ruined);
                break;
            }
            case 3: {
                LOTRStructureRedDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, 3, i, this.ruined);
            }
        }
    }
