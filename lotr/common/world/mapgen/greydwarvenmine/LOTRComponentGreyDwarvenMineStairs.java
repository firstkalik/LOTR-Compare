...
public class LOTRComponentGreyDwarvenMineStairs
extends StructureComponent {
    private boolean ruined;

    public LOTRComponentGreyDwarvenMineStairs() {
    }

    public LOTRComponentGreyDwarvenMineStairs(int i, Random random, StructureBoundingBox structureBoundingBox, int j, boolean r) {
        super(i);
    ...
    public void buildComponent(StructureComponent component, List list, Random random) {
        ...
        switch (this.coordBaseMode) {
            case 0: {
                LOTRStructureGreyDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i, this.ruined);
                break;
            }
            case 1: {
                LOTRStructureGreyDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, 1, i, this.ruined);
                break;
            }
            case 2: {
                LOTRStructureGreyDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i, this.ruined);
                break;
            }
            case 3: {
                LOTRStructureGreyDwarvenMinePieces.getNextComponent(component, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, 3, i, this.ruined);
            }
        }
    }
