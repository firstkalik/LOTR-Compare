...
public class LOTRStructureWindDwarvenMineStart
extends StructureStart {
    public LOTRStructureWindDwarvenMineStart() {
    }

    public LOTRStructureWindDwarvenMineStart(World world, Random random, int i, int j, boolean r) {
        LOTRComponenWindDwarvenMineEntrance startComponent = new LOTRComponenWindDwarvenMineEntrance(world, 0, random, (i << 4) + 8, (j << 4) + 8, r);
