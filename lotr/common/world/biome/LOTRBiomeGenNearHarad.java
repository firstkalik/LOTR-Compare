...
extends LOTRBiome {
    ...
    public void decorate(World world, Random random, int i, int k) {
        ...
        if (random.nextInt(50) == 0) {
            ...
            new WorldGenCactus().generate(world, random, i12, j12, k1);
        }
        if (random.nextInt(16) == 0) {
            i12 = i + random.nextInt(16) + 8;
            k1 = k + random.nextInt(16) + 8;
            j12 = world.getHeightValue(i12, k1);
            new WorldGenDeadBush((Block)Blocks.deadbush).generate(world, random, i12, j12, k1);
        }
        if (random.nextInt(120) == 0) {
            ...
            for (l = 0; l < boulders; ++l) {
                ...
                if (random.nextBoolean()) {
                    this.boulderGen.generate(world, random, i1, j1, k12);
                    continue;
                }
                this.boulderGenSandstone.generate(world, random, i1, j1, k12);
            }
        }
