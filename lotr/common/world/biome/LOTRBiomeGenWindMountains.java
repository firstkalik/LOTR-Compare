...
extends LOTRBiome {
    public LOTRBiomeGenWindMountains(int i, boolean major) {
        ...
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.WIND, 100)};
        this.npcSpawnList.newFactionList(600, 0.0f).add(arrspawnListContainer);
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer6 = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.DURMETH_ORCS, 3), LOTRBiomeSpawnList.entry(LOTRSpawnList.WICKED_DWARF_WARRIOR, 2)};
        this.npcSpawnList.newFactionList(1, 2.0f).add(arrspawnListContainer6);
        ...
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer2 = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.DURMETH_WARGS, 3)};
        ...
        this.decorator.addRandomStructure(new LOTRWorldGenDwarvenMineEntranceRuined3(false), 600);
        this.biomeColors.setSky(11653858);
        this.decorator.addRandomStructure(new LOTRWorldGenStoneRuin.WIND(1, 8), 500);
        ...
        this.invasionSpawns.addInvasion(LOTRInvasions.DURMETH_WARG, LOTREventSpawner.EventChance.HALFTIME);
        ...
        this.setBanditChance(LOTREventSpawner.EventChance.BANDIT_HALFTIME);
