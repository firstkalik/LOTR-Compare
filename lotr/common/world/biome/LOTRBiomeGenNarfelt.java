...
public class LOTRBiomeGenNarfelt
extends LOTRBiome {
    ...
    public LOTRBiomeGenNarfelt(int i, boolean major) {
        super(i, major);
        this.setEnableSnow();
        ...
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.BANDITS, 1).setSpawnChance(1000)};
