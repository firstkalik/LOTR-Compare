...
public class LOTRBiomeGenLebennin
extends LOTRBiomeGenGondor {
    ...
    public LOTRBiomeGenLebennin(int i, boolean major) {
        ...
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.LEBENNIN_SOLDIERS, 10).setSpawnChance(100)};
        this.npcSpawnList.newFactionList(100, 0.0f).add(arrspawnListContainer);
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer2 = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.LEBENNIN_SOLDIERS, 10)};
        ...
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer8 = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.UMBARIANS, 2).setConquestThreshold(100.0f), LOTRBiomeSpawnList.entry(LOTRSpawnList.UMBAR_SOLDIERS, 10), LOTRBiomeSpawnList.entry(LOTRSpawnList.CORSAIRS, 20), LOTRBiomeSpawnList.entry(LOTRSpawnList.GONDOR_RENEGADES, 10)};
