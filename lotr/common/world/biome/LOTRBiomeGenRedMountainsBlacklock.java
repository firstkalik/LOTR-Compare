...
public class LOTRBiomeGenRedMountainsBlacklock
extends LOTRBiome {
    public LOTRBiomeGenRedMountainsBlacklock(int i, boolean major) {
        super(i, major);
        ...
        LOTRBiomeSpawnList.SpawnListContainer[] arrspawnListContainer = new LOTRBiomeSpawnList.SpawnListContainer[]{LOTRBiomeSpawnList.entry(LOTRSpawnList.BLACKLOCK, 100)};
    ...
    public LOTRAchievement getBiomeAchievement() {
        return LOTRAchievement.enterRedMountainsCentre;
    }
