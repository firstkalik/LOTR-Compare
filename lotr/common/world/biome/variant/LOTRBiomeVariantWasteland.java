...
public class LOTRBiomeVariantWasteland
extends LOTRBiomeVariant {
    ...
    public void generateVariantTerrain(World world, Random random, Block[] blocks, byte[] meta, int i, int k, int height, LOTRBiome biome) {
        ...
        double d1 = LOTRBiome.biomeTerrainNoise.func_151601_a((double)i * 0.04, (double)k * 0.04);
        double d2 = LOTRBiome.biomeTerrainNoise.func_151601_a((double)i * 0.3, (double)k * 0.3);
        d2 *= 0.3;
