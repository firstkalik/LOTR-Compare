...
public class LOTRWorldGenGondorRuins
extends LOTRWorldGenStructureBase {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        for (int l = 0; l < slabRuinParts; ++l) {
            ...
            if (i12 == i && k13 == k) continue;
            j1 = world.getHeightValue(i12, k13);
            if (world.getBlock(i12, j1 - 1, k13).isOpaqueCube()) {
                this.placeRandomSlab(world, random, i12, j1, k13);
            }
        ...
        for (int l = 0; l < smallRuinParts; ++l) {
            ...
            if (world.getBlock(i1, j12 - 1, k1).isOpaqueCube()) {
                int height = 1 + random.nextInt(3);
                for (int j2 = 0; j2 < height; ++j2) {
                    this.placeRandomBrick(world, random, i1, j12 + j2, k1);
                }
            }
        ...
        for (int l = 0; l < largeRuinParts; ++l) {
            ...
            if (i13 == i && k12 == k) continue;
            int j13 = world.getHeightValue(i13, k12);
            if (world.getBlock(i13, j13 - 1, k12).isOpaqueCube()) {
                int height = 4 + random.nextInt(7);
                for (int j2 = 0; j2 < height; ++j2) {
                    this.placeRandomBrick(world, random, i13, j13 + j2, k12);
                }
            }
        ...
        for (i1 = i - 1; i1 <= i + 8; ++i1) {
            for (j1 = j - 6; j1 >= j - 11; --j1) {
                for (k12 = k - 3; k12 <= k + 3; ++k12) {
                    if (j1 == j - 6 || j1 < j - 9) {
                        world.setBlock(i1, j1, k12, LOTRMod.rock, 1, 2);
                        continue;
                    }
                    world.setBlock(i1, j1, k12, LOTRMod.brick, 1, 2);
                }
            }
        }
        for (i1 = i; i1 <= i + 7; ++i1) {
            for (j1 = j - 7; j1 >= j - 9; --j1) {
                for (k12 = k - 2; k12 <= k + 2; ++k12) {
                    world.setBlock(i1, j1, k12, Blocks.air, 0, 2);
                }
            }
        }
        for (k13 = k - 2; k13 <= k + 2; ++k13) {
            world.setBlock(i + 7, j - 9, k13, LOTRMod.brick, 1, 2);
            world.setBlock(i + 7, j - 7, k13, LOTRMod.slabSingle, 11, 2);
            world.setBlock(i, j - 7, k13, LOTRMod.slabSingle, 11, 2);
        }
