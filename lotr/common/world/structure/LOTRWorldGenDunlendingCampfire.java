...
public class LOTRWorldGenDunlendingCampfire
extends LOTRWorldGenStructureBase {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
            ...
            for (k12 = k - 5; k12 <= k + 5; ++k12) {
                ...
                for (j1 = j; j1 >= j - 2; --j1) {
                    if (LOTRMod.isOpaque(world, i1, j1 + 1, k12)) {
                        ...
                        this.setBlockAndNotifyAdequately(world, i1, j1, k12, (Block)Blocks.grass, 0);
                    }
        ...
        this.setBlockAndNotifyAdequately(world, i, j + 1, k, (Block)Blocks.fire, 0);
