    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        if (this.restrictions) {
            ...
            for (i14 = i - 1; i14 <= i + 16; ++i14) {
                for (k12 = k - 1; k12 <= k + 16; ++k12) {
                    j12 = world.getTopSolidOrLiquidBlock(i14, k12);
                    Block block = world.getBlock(i14, j12 - 1, k12);
        ...
        for (i14 = i; i14 <= i + 15; ++i14) {
            for (k12 = k; k12 <= k + 15; ++k12) {
                for (j12 = j; !(j12 != j && LOTRMod.isOpaque(world, i14, j12, k12) || j12 < 0); --j12) {
                    this.setBlockAndNotifyAdequately(world, i14, j12, k12, LOTRMod.brick3, 2);
                    this.setGrassToDirt(world, i14, j12 - 1, k12);
                }
                for (j12 = j + 1; j12 <= j + 4; ++j12) {
                    this.setBlockAndNotifyAdequately(world, i14, j12, k12, Blocks.air, 0);
                }
                if (i14 < i + 2 || i14 > i + 13 || k12 < k + 2 || k12 > k + 13) {
                    this.setBlockAndNotifyAdequately(world, i14, j + 5, k12, LOTRMod.brick3, 2);
                } else {
                    this.setBlockAndNotifyAdequately(world, i14, j + 5, k12, this.plankBlock, this.plankMeta);
                }
        ...
        for (int j14 = j; j14 <= j + 5; j14 += 5) {
            int j2;
            for (k12 = k; k12 <= k + 15; k12 += 15) {
                int i15;
                for (i15 = i; i15 <= i + 15; i15 += 3) {
                    for (j2 = j14 + 1; j2 <= j14 + 4; ++j2) {
                        this.setBlockAndNotifyAdequately(world, i15, j2, k12, LOTRMod.pillar, 10);
                    }
                    this.setBlockAndNotifyAdequately(world, i15, j14 + 5, k12, LOTRMod.brick3, 2);
                }
                for (i15 = i + 1; i15 <= i + 13; i15 += 3) {
                    this.setBlockAndNotifyAdequately(world, i15, j14 + 5, k12, LOTRMod.stairsHighElvenBrick, 5);
                    this.setBlockAndNotifyAdequately(world, i15 + 1, j14 + 5, k12, LOTRMod.stairsHighElvenBrick, 4);
                }
            }
            ...
            for (k12 = k; k12 <= k + 15; k12 += 3) {
                this.setBlockAndNotifyAdequately(world, i + 1, j14 + 4, k12, LOTRMod.highElvenTorch, 1);
                this.setBlockAndNotifyAdequately(world, i + 14, j14 + 4, k12, LOTRMod.highElvenTorch, 2);
            }
        }
        int roofWidth = 18;
        int roofX = i - 1;
        ...
        while (roofWidth > 2) {
            ...
            for (i13 = roofX + 1; i13 < roofX + roofWidth - 2; ++i13) {
                for (k14 = roofZ + 1; k14 < roofZ + roofWidth - 2; ++k14) {
                    this.setBlockAndNotifyAdequately(world, i13, roofY, k14, Blocks.air, 0);
                }
            }
        ...
        for (i13 = roofX; i13 < roofX + roofWidth; ++i13) {
            for (k14 = roofZ; k14 < roofZ + roofWidth; ++k14) {
                this.setBlockAndNotifyAdequately(world, i13, roofY - 1, k14, LOTRMod.glass, 0);
            }
        }
