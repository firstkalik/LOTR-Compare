...
public class LOTRWorldGenRuinedAvariElfTower
extends LOTRWorldGenStructureBase {
    public LOTRWorldGenRuinedAvariElfTower(boolean flag) {
        super(flag);
    }
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        if (this.restrictions) {
            for (int i12 = i - radiusPlusOne; i12 <= i + radiusPlusOne; ++i12) {
                for (int k13 = k - radiusPlusOne; k13 <= k + radiusPlusOne; ++k13) {
                    ...
                    int i2 = i12 - i;
                    int k2 = k13 - k;
                    if (i2 * i2 + k2 * k2 > radiusPlusOne * radiusPlusOne || (block = world.getBlock(i12, j13 = world.getTopSolidOrLiquidBlock(i12, k13) - 1, k13)) == Blocks.grass || block == Blocks.dirt || block == Blocks.stone || block.isWood((IBlockAccess)world, i12, j13, k13) || block.isLeaves((IBlockAccess)world, i12, j13, k13)) continue;
                    return false;
                }
            }
        }
        ...
        for (int spiders = net.minecraft.util.MathHelper.getRandomIntegerInRange((Random)random, (int)4, (int)6); spiders > 0; --spiders) {
            LOTREntityMirkwoodSpider spider = new LOTREntityMirkwoodSpider(world);
            spider.setLocationAndAngles((double)(i - 1) + 0.5, (double)(j - sectionHeight - 5), (double)k + 0.5, 0.0f, 0.0f);
        ...
        this.setBlockAndNotifyAdequately(world, i + 4, j - sectionHeight - 5, k - 1, (Block)Blocks.chest, 0);
