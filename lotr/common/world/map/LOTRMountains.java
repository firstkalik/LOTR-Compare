...
public enum LOTRMountains {
    ...
    MINDOLLUIN((float)LOTRWaypoint.MINAS_TIRITH.getX() - 4.0f, LOTRWaypoint.MINAS_TIRITH.getY(), 1.0f, 200),
    TIRITH_HILL((float)LOTRWaypoint.MINAS_TIRITH.getX() - 2.5f, LOTRWaypoint.MINAS_TIRITH.getY(), 3.5f, 170),
