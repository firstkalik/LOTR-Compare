...
public class LOTRCommandAlignmentSee2
extends CommandBase {
    ...
    public String getCommandUsage(ICommandSender sender) {
        return "commands.lotr.unitSee.usage";
    }
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        if (args.length >= 1) {
            ...
            if (profile == null || profile.getId() == null) {
                throw new PlayerNotFoundException("commands.lotr.unitSee.noPlayer", new Object[]{username});
            }
            if (sender instanceof EntityPlayerMP) {
                LOTRPlayerData playerData = LOTRLevelData.getData(profile.getId());
                LOTRPacketAlignmentSee2 packet = new LOTRPacketAlignmentSee2(username, playerData);
