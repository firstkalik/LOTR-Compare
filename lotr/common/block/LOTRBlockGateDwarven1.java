...
public class LOTRBlockGateDwarven1
extends LOTRBlockGate {
    public LOTRBlockGateDwarven1() {
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
        LOTRConnectedTextures.registerNonConnectedGateIcons(iconregister, this, 0, LOTRMod.rock.getIcon(0, 0).getIconName());
    }
    ...
    public IIcon getIcon(IBlockAccess world, int i, int j, int k, int side) {
        ...
        return LOTRMod.rock.getIcon(side, 0);
    }
