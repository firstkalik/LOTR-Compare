...
public class LOTRBlockGateDwarven8
extends LOTRBlockGate {
    public LOTRBlockGateDwarven8() {
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
        LOTRConnectedTextures.registerNonConnectedGateIcons(iconregister, this, 0, LOTRMod.rock.getIcon(0, 7).getIconName());
    }
    ...
    public IIcon getIcon(IBlockAccess world, int i, int j, int k, int side) {
        ...
        return LOTRMod.rock.getIcon(side, 7);
    }

    @SideOnly(value=Side.CLIENT)
    @Override
    public IIcon getIcon(int i, int j) {
        return LOTRMod.rock.getIcon(i, 7);
    }
