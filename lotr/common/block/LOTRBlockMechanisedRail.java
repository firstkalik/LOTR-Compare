...
extends BlockRailBase {
    ...
    public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer entityplayer, int side, float f, float f1, float f2) {
        ...
        world.playSoundEffect((double)((float)i + 0.5f), (double)((float)j + 0.5f), (double)((float)k + 0.5f), "random.click", 0.3f, isNowPowered ? 0.6f : 0.5f);
        return true;
    }
    ...
    public boolean onShiftClickActivateFirst(World world, int i, int j, int k, EntityPlayer entityplayer, int side) {
        ...
        world.setBlock(i, j, k, setBlock, this.getBasicRailMetadata((IBlockAccess)world, null, i, j, k), 3);
    ...
    public void randomDisplayTick(World world, int i, int j, int k, Random rand) {
        ...
        if (power) {
            int dir = meta & 7;
            Vec3 corner1 = Vec3.createVectorHelper((double)0.0, (double)0.0, (double)0.0);
            Vec3 corner2 = Vec3.createVectorHelper((double)0.0, (double)0.0, (double)0.0);
            Vec3 corner3 = Vec3.createVectorHelper((double)0.0, (double)0.0, (double)0.0);
            Vec3 corner4 = Vec3.createVectorHelper((double)0.0, (double)0.0, (double)0.0);
            if (dir == 0) {
                corner1 = Vec3.createVectorHelper((double)-0.4, (double)0.0, (double)-0.5);
                corner2 = Vec3.createVectorHelper((double)-0.4, (double)0.0, (double)0.5);
                corner3 = Vec3.createVectorHelper((double)0.4, (double)0.0, (double)-0.5);
                corner4 = Vec3.createVectorHelper((double)0.4, (double)0.0, (double)0.5);
            } else if (dir == 1) {
                corner1 = Vec3.createVectorHelper((double)-0.5, (double)0.0, (double)-0.4);
                corner2 = Vec3.createVectorHelper((double)0.5, (double)0.0, (double)-0.4);
                corner3 = Vec3.createVectorHelper((double)-0.5, (double)0.0, (double)0.4);
                corner4 = Vec3.createVectorHelper((double)0.5, (double)0.0, (double)0.4);
            } else if (dir == 2) {
                corner1 = Vec3.createVectorHelper((double)-0.5, (double)0.0, (double)-0.4);
                corner2 = Vec3.createVectorHelper((double)0.5, (double)1.0, (double)-0.4);
                corner3 = Vec3.createVectorHelper((double)-0.5, (double)0.0, (double)0.4);
                corner4 = Vec3.createVectorHelper((double)0.5, (double)1.0, (double)0.4);
            } else if (dir == 3) {
                corner1 = Vec3.createVectorHelper((double)-0.5, (double)1.0, (double)-0.4);
                corner2 = Vec3.createVectorHelper((double)0.5, (double)0.0, (double)-0.4);
                corner3 = Vec3.createVectorHelper((double)-0.5, (double)1.0, (double)0.4);
                corner4 = Vec3.createVectorHelper((double)0.5, (double)0.0, (double)0.4);
            } else if (dir == 4) {
                corner1 = Vec3.createVectorHelper((double)-0.4, (double)1.0, (double)-0.5);
                corner2 = Vec3.createVectorHelper((double)-0.4, (double)0.0, (double)0.5);
                corner3 = Vec3.createVectorHelper((double)0.4, (double)1.0, (double)-0.5);
                corner4 = Vec3.createVectorHelper((double)0.4, (double)0.0, (double)0.5);
            } else if (dir == 5) {
                corner1 = Vec3.createVectorHelper((double)-0.4, (double)0.0, (double)-0.5);
                corner2 = Vec3.createVectorHelper((double)-0.4, (double)1.0, (double)0.5);
                corner3 = Vec3.createVectorHelper((double)0.4, (double)0.0, (double)-0.5);
                corner4 = Vec3.createVectorHelper((double)0.4, (double)1.0, (double)0.5);
            }
            for (int l = 0; l < 1; ++l) {
                float t1 = rand.nextFloat();
                float t2 = rand.nextFloat();
                Vec3 edge1 = this.lerp(corner1, corner2, t1).addVector((double)i + 0.5, (double)j, (double)k + 0.5);
                Vec3 edge2 = this.lerp(corner3, corner4, t2).addVector((double)i + 0.5, (double)j, (double)k + 0.5);
    ...
    private Vec3 lerp(Vec3 vec1, Vec3 vec2, float t) {
        return Vec3.createVectorHelper((double)(vec1.xCoord + (vec2.xCoord - vec1.xCoord) * (double)t), (double)(vec1.yCoord + (vec2.yCoord - vec1.yCoord) * (double)t), (double)(vec1.zCoord + (vec2.zCoord - vec1.zCoord) * (double)t));
    }
