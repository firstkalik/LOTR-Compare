...
public class LOTRBlockGateDwarven4
extends LOTRBlockGate {
    public LOTRBlockGateDwarven4() {
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
        LOTRConnectedTextures.registerNonConnectedGateIcons(iconregister, this, 0, LOTRMod.rock.getIcon(0, 3).getIconName());
    }
    ...
    public IIcon getIcon(IBlockAccess world, int i, int j, int k, int side) {
        ...
        return LOTRMod.rock.getIcon(side, 3);
    }
