...
extends LOTRBlockSaplingBase {
    ...
    public void growTree(World world, int i, int j, int k, Random random) {
        ...
        if (meta == 1) {
            ...
            if (treeGen == null && (tree4x4 = LOTRBlockSaplingBase.findSaplingSquare(world, i, j, k, (Block)this, meta, -1, 2, -2, 1)) != null) {
            ...
            if (treeGen == null && (tree3x3 = LOTRBlockSaplingBase.findPartyTree(world, i, j, k, (Block)this, meta)) != null) {
            ...
            if (treeGen == null && (tree2x2 = LOTRBlockSaplingBase.findSaplingSquare(world, i, j, k, (Block)this, meta, 0, 1, -1, 0)) != null) {
