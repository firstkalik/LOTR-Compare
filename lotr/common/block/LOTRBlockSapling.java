...
extends LOTRBlockSaplingBase {
    ...
    public void growTree(World world, int i, int j, int k, Random random) {
        ...
        if (meta == 1) {
            ...
            if (treeGen == null && (partyTree = LOTRBlockSaplingBase.findPartyTree(world, i, j, k, (Block)this, meta)) != null) {
            ...
            if (treeGen == null && (boughTree = LOTRBlockSaplingBase.findCrossShape(world, i, j, k, (Block)this, meta)) != null) {
