...
public class LOTRBlockWeaponRack
extends BlockContainer {
    ...
    public boolean canPlaceBlockOnSide(World world, int i, int j, int k, int side) {
        ...
        if (side != 0) {
            ...
            return world.getBlock(i1, j, k1).isSideSolid((IBlockAccess)world, i1, j, k1, dir);
        }
        return false;
    }
    ...
    public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase entity, ItemStack itemstack) {
        int meta = world.getBlockMetadata(i, j, k);
        if ((meta & 4) == 0) {
            int rotation = MathHelper.floor_double((double)((double)(entity.rotationYaw * 4.0f / 360.0f) + 2.5)) & 3;
