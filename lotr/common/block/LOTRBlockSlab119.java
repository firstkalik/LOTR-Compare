...
public class LOTRBlockSlab119
extends LOTRBlockSlabBase {
    public LOTRBlockSlab119(boolean flag) {
    ...
    public IIcon getIcon(int i, int j) {
        if ((j &= 7) == 0) {
            return LOTRMod.pillar4.getIcon(i, 0);
        }
        if (j == 1) {
        ...
        if (j == 4) {
            return LOTRMod.pillar4.getIcon(i, 1);
        }
        if (j == 5) {
        ...
        if (j == 7) {
            return LOTRMod.pillar4.getIcon(i, 2);
        }
