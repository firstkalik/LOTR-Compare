...
extends Block {
    ...
    protected static boolean canLanternStayAt(World world, int x, int y, int z) {
        ...
        if (meta == 1) {
            return world.getBlock(x, y + 1, z).isSideSolid((IBlockAccess)world, x, y + 1, z, ForgeDirection.DOWN) || LanternMorgul.canSustainLanternOnBottom(world, x, y + 1, z);
        }
        return world.getBlock(x, y - 1, z).isSideSolid((IBlockAccess)world, x, y - 1, z, ForgeDirection.UP) || LanternMorgul.canSustainLanternOnTop(world, x, y - 1, z);
    }

    public boolean canPlaceBlockAt(World world, int x, int y, int z) {
        return world.getBlock(x, y + 1, z).isSideSolid((IBlockAccess)world, x, y + 1, z, ForgeDirection.DOWN) || LanternMorgul.canSustainLanternOnBottom(world, x, y + 1, z) || world.getBlock(x, y - 1, z).isSideSolid((IBlockAccess)world, x, y - 1, z, ForgeDirection.UP) || LanternMorgul.canSustainLanternOnTop(world, x, y - 1, z);
    }

    public int onBlockPlaced(World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ, int meta) {
        if (world.getBlock(x, y + 1, z).isSideSolid((IBlockAccess)world, x, y + 1, z, ForgeDirection.DOWN) || LanternMorgul.canSustainLanternOnBottom(world, x, y + 1, z)) {
            if (side == 0) {
                return 1;
            }
            if (!world.getBlock(x, y - 1, z).isSideSolid((IBlockAccess)world, x, y - 1, z, ForgeDirection.UP) && !LanternMorgul.canSustainLanternOnTop(world, x, y - 1, z)) {
                return 1;
            }
        }
        return 0;
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block neighborBlock) {
        if (!LanternMorgul.canLanternStayAt(world, x, y, z)) {
            if (!world.isRemote) {
    ...
    public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB mask, List list, Entity entity) {
        if (world.getBlockMetadata(x, y, z) == 1) {
            LanternMorgul.setBlockBoundsWithState(this, 1, true);
            super.addCollisionBoxesToList(world, x, y, z, mask, list, entity);
            LanternMorgul.setBlockBoundsWithState(this, 1, false);
            super.addCollisionBoxesToList(world, x, y, z, mask, list, entity);
        } else {
            LanternMorgul.setBlockBoundsWithState(this, 0, true);
            super.addCollisionBoxesToList(world, x, y, z, mask, list, entity);
            LanternMorgul.setBlockBoundsWithState(this, 0, false);
            super.addCollisionBoxesToList(world, x, y, z, mask, list, entity);
        }
        LanternMorgul.setBlockBoundsWithState(this, 0, true);
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World world, int x, int y, int z) {
        LanternMorgul.setBlockBoundsWithState(this, world.getBlockMetadata(x, y, z), true);
