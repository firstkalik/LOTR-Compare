...
public class LOTRBlockChandelier2
extends Block {
    @SideOnly(value=Side.CLIENT)
    private IIcon[] chandelierIcons;
    private String[] chandelierNames = new String[]{"windDwarf", "redDwarf", "avari"};

    public LOTRBlockChandelier2() {
    ...
    private void spawnChandelierParticles(World world, double d, double d1, double d2, Random random, int meta) {
        if (meta == 5 || meta == 13 || meta == 14 || meta == 2) {
            ...
            if (meta == 5) {
                ...
                torchBlock = (LOTRBlockTorch)LOTRMod.avariTorch;
            }
