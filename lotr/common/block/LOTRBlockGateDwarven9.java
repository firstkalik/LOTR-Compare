...
public class LOTRBlockGateDwarven9
extends LOTRBlockGate {
    public LOTRBlockGateDwarven9() {
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
        LOTRConnectedTextures.registerNonConnectedGateIcons(iconregister, this, 0, LOTRMod.rock.getIcon(0, 8).getIconName());
    }
    ...
    public IIcon getIcon(IBlockAccess world, int i, int j, int k, int side) {
        ...
        return LOTRMod.rock.getIcon(side, 8);
    }

    @SideOnly(value=Side.CLIENT)
    @Override
    public IIcon getIcon(int i, int j) {
        return LOTRMod.rock.getIcon(i, 8);
    }
