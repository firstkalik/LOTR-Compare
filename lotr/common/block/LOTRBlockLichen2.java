...
public class LOTRBlockLichen2
extends Block
implements IShearable {
    public LOTRBlockLichen2() {
        super(Material.vine);
    ...
    private boolean canAttachTo(Block block) {
        return block.isOpaqueCube() && block.getMaterial().blocksMovement() && !(block instanceof LOTRBlockLeavesBase) && block.getMaterial() != Material.snow && block.getMaterial() != Material.ice;
    }
