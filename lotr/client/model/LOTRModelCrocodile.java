...
public class LOTRModelCrocodile
extends ModelBase {
    private ModelRenderer body = new ModelRenderer((ModelBase)this, 18, 83).setTextureSize(128, 128);
    ...
    public LOTRModelCrocodile() {
        ...
        this.spines = new ModelRenderer((ModelBase)this, 46, 45).setTextureSize(128, 128);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.legBackRight.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1;
        this.legBackLeft.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1;
        this.legFrontRight.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1;
        this.legFrontLeft.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1;
        this.tail1.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1 * 0.5f;
        this.tail2.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1 * 0.5625f;
        this.tail3.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * f1 * 0.59375f;
    }
}
