...
public class LOTRModelMoredainLionHelmet
extends LOTRModelBiped {
    ...
    public LOTRModelMoredainLionHelmet(float f) {
        ...
        this.panelRight = new ModelRenderer((ModelBase)this, 32, 0);
        ...
        this.panelBack = new ModelRenderer((ModelBase)this, 44, 0);
        this.panelBack.addBox(-4.0f, -8.0f, 4.8f + f, 8, 10, 0, 0.0f);
        this.panelBack.rotateAngleX = (float)Math.toRadians(4.0);
        this.panelTop = new ModelRenderer((ModelBase)this, 52, 25);
