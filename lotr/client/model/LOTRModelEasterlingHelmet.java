...
public class LOTRModelEasterlingHelmet
extends LOTRModelBiped {
    ...
    public LOTRModelEasterlingHelmet(float f, boolean kineHorns) {
        ...
        ModelRenderer horn = new ModelRenderer((ModelBase)this, 44, 16);
        ...
        ModelRenderer crest = new ModelRenderer((ModelBase)this, 32, 0);
