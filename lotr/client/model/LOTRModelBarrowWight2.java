...
public class LOTRModelBarrowWight2
extends LOTRModelBiped {
    public LOTRModelBarrowWight2() {
        this(0.0f);
    }

    public LOTRModelBarrowWight2(float f) {
        super(f);
        ...
        this.bipedBody = new ModelRenderer((ModelBase)this, 0, 16);
        this.bipedBody.setRotationPoint(0.0f, -8.0f, 0.0f);
        this.bipedBody.addBox(-4.0f, 0.0f, -3.0f, 8, 32, 6, f);
        this.bipedRightArm = new ModelRenderer((ModelBase)this, 28, 16);
        ...
        this.bipedLeftArm = new ModelRenderer((ModelBase)this, 28, 16);
