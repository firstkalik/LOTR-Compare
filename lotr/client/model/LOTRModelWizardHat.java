...
public class LOTRModelWizardHat
extends LOTRModelBiped {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.hat2.rotateAngleX = (float)Math.toRadians(-(10.0 + (double)f1 * 10.0));
        this.hat3.rotateAngleX = (float)Math.toRadians(-(10.0 + (double)f1 * 10.0));
    }
}
