...
extends ModelBase {
    ...
    public LOTRModelRabbit() {
        ...
        ModelRenderer rightEar = new ModelRenderer((ModelBase)this, 16, 0);
        ...
        ModelRenderer leftEar = new ModelRenderer((ModelBase)this, 16, 0);
        leftEar.mirror = true;
        ...
        ModelRenderer tail = new ModelRenderer((ModelBase)this, 32, 30);
        ...
        this.rightLeg = new ModelRenderer((ModelBase)this, 32, 8);
        this.rightLeg.addBox(-1.0f, -2.0f, -2.0f, 2, 4, 4);
        this.rightLeg.setRotationPoint(-3.0f, 21.5f, 1.0f);
        ModelRenderer rightFoot = new ModelRenderer((ModelBase)this, 32, 16);
        ...
        ModelRenderer leftFoot = new ModelRenderer((ModelBase)this, 32, 16);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (((LOTREntityRabbit)entity).isRabbitEating()) {
            ...
            this.head.rotateAngleY = MathHelper.cos((float)this.head.rotateAngleX) * f3 / 57.295776f;
            this.head.rotateAngleZ = MathHelper.sin((float)this.head.rotateAngleX) * f3 / 57.295776f;
        }
        this.rightArm.rotateAngleX += MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * f1;
