...
public class LOTRModelKebabStand
extends ModelBase {
    ...
    public LOTRModelKebabStand() {
        ...
        ModelRenderer panelRight = new ModelRenderer((ModelBase)this, 18, 15);
        ...
        ModelRenderer panelLeft = new ModelRenderer((ModelBase)this, 18, 15);
        ...
        for (int i = 0; i < this.kebab.length; ++i) {
            ModelRenderer kb = new ModelRenderer((ModelBase)this, 0, 0);
