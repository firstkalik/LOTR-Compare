...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.isChild) {
            ...
            float f8 = 6.0f;
            GL11.glPushMatrix();
            GL11.glTranslatef((float)0.0f, (float)(f7 * f5), (float)(f8 * f5));
            this.head.render(f5);
            GL11.glPopMatrix();
            GL11.glPushMatrix();
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.head.rotateAngleX += MathHelper.cos((float)(f * 0.2f)) * f1 * 0.4f;
        ...
        this.leg1.rotateAngleX = MathHelper.cos((float)(f * 0.4f)) * f1 * 0.8f;
        this.leg2.rotateAngleX = MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * f1 * 0.8f;
        this.leg3.rotateAngleX = MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * f1 * 0.8f;
        this.leg4.rotateAngleX = MathHelper.cos((float)(f * 0.4f)) * f1 * 0.8f;
    }
}
