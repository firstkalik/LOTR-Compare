...
extends ModelBase {
    ...
    public LOTRModelCamel(float f) {
        ...
        this.humps = new ModelRenderer((ModelBase)this, 34, 0);
        ...
        this.tail = new ModelRenderer((ModelBase)this, 54, 52);
        ...
        this.leg1 = new ModelRenderer((ModelBase)this, 0, 52);
        ...
        this.leg3 = new ModelRenderer((ModelBase)this, 0, 52);
        ...
        this.chest = new ModelRenderer((ModelBase)this, 40, 22);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.head.rotateAngleX += MathHelper.cos((float)(f * 0.3331f)) * 0.1f * f1;
        this.leg1.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 0.8f * f1;
        this.leg2.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 0.8f * f1;
        this.leg3.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 0.8f * f1;
        this.leg4.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 0.8f * f1;
        this.tail.rotateAngleZ = 0.1f * MathHelper.cos((float)(f * 0.3331f + 3.1415927f)) * f1;
    }
}
