...
extends ModelBase {
    ...
    public LOTRModelSwan() {
        ...
        this.tail = new ModelRenderer((ModelBase)this, 24, 20);
        ...
        this.neck = new ModelRenderer((ModelBase)this, 44, 11);
        this.neck.setRotationPoint(0.0f, 0.0f, -5.5f);
        this.neck.addBox(-1.0f, -11.0f, -3.0f, 2, 13, 2);
        this.body.addChild(this.neck);
        this.head = new ModelRenderer((ModelBase)this, 44, 0);
        ...
        this.wingRight = new ModelRenderer((ModelBase)this, 0, 20);
        ...
        this.legRight = new ModelRenderer((ModelBase)this, 24, 33);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        float flapping = (MathHelper.sin((float)f6) + 1.0f) * f7;
        ...
        this.tail.rotateAngleX += MathHelper.cos((float)(f * 0.4f)) * f1 * 0.5f;
        this.tail.rotateAngleX += MathHelper.cos((float)(f2 * 0.1f)) * 0.1f;
        float wingX = (float)Math.toRadians(10.0);
        float wingY = (1.0f + MathHelper.cos((float)(f * 0.4f + 3.1415927f))) * f1 * 0.5f;
        wingY += (1.0f + MathHelper.cos((float)(f2 * 0.15f))) * 0.1f;
        float wingZ = MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * f1 * 0.2f;
        ...
        this.legRight.rotateAngleX = MathHelper.cos((float)(f * 0.7f + 3.1415927f)) * f1 * 1.0f;
        this.legLeft.rotateAngleX = MathHelper.cos((float)(f * 0.7f)) * f1 * 1.0f;
    }
}
