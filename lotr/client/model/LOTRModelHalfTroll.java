...
public class LOTRModelHalfTroll
extends LOTRModelBiped {
    ...
    public LOTRModelHalfTroll(float f) {
        ...
        ModelRenderer nose = new ModelRenderer((ModelBase)this, 30, 0);
        nose.addBox(-1.0f, -4.5f, -8.0f, 2, 3, 3, f);
        nose.rotateAngleX = (float)Math.toRadians(-20.0);
        this.bipedHead.addChild(nose);
        ModelRenderer teeth = new ModelRenderer((ModelBase)this, 60, 7);
        ...
        this.hornRight2 = new ModelRenderer((ModelBase)this, 50, 2);
        ...
        this.bipedBody = new ModelRenderer((ModelBase)this, 0, 20);
        this.bipedBody.setRotationPoint(0.0f, -8.0f, 0.0f);
        this.bipedBody.addBox(-6.0f, 0.0f, -4.0f, 12, 16, 8, f);
        this.bipedRightArm = new ModelRenderer((ModelBase)this, 20, 50);
        ...
        this.bipedLeftArm = new ModelRenderer((ModelBase)this, 20, 50);
        ...
        this.bipedRightLeg = new ModelRenderer((ModelBase)this, 40, 28);
        this.bipedRightLeg.setRotationPoint(-3.2f, 8.0f, 0.0f);
        this.bipedRightLeg.addBox(-3.0f, 0.0f, -3.0f, 6, 16, 6, f);
        this.bipedLeftLeg = new ModelRenderer((ModelBase)this, 40, 28);
