...
extends ModelBase {
    ...
    public LOTRModelBalrog2() {
        this(0.0f);
    }

    public LOTRModelBalrog2(float f) {
        this.textureWidth = 128;
        this.textureHeight = 256;
        this.body = new ModelRenderer((ModelBase)this, 0, 38);
        ...
        this.head = new ModelRenderer((ModelBase)this, 92, 48);
        ...
        ModelRenderer rightHorn1 = new ModelRenderer((ModelBase)this, 57, 47);
        ...
        ModelRenderer rightHorn2 = new ModelRenderer((ModelBase)this, 57, 35);
        ...
        ModelRenderer leftHorn1 = new ModelRenderer((ModelBase)this, 57, 47);
        ...
        ModelRenderer leftHorn2 = new ModelRenderer((ModelBase)this, 57, 35);
        ...
        this.rightArm = new ModelRenderer((ModelBase)this, 59, 136);
        ...
        this.leftArm = new ModelRenderer((ModelBase)this, 59, 136);
        ...
        this.rightLeg = new ModelRenderer((ModelBase)this, 46, 230);
        ...
        ModelRenderer rightFoot = new ModelRenderer((ModelBase)this, 0, 243);
        ...
        this.leftLeg = new ModelRenderer((ModelBase)this, 46, 230);
        ...
        ModelRenderer leftFoot = new ModelRenderer((ModelBase)this, 0, 243);
        ...
        this.tail = new ModelRenderer((ModelBase)this, 79, 200);
        ...
        this.rightWing = new ModelRenderer((ModelBase)this, 0, 137);
        ...
        this.leftWing = new ModelRenderer((ModelBase)this, 0, 137);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.body.rotateAngleX += MathHelper.cos((float)(f2 * 0.03f)) * 0.15f;
        this.rightArm.rotateAngleX = 0.0f;
        this.leftArm.rotateAngleX = 0.0f;
        this.rightArm.rotateAngleZ = 0.0f;
        this.leftArm.rotateAngleZ = 0.0f;
        this.rightArm.rotateAngleX += MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * 0.8f * f1;
        this.leftArm.rotateAngleX += MathHelper.cos((float)(f * 0.4f)) * 0.8f * f1;
        ...
        if (this.onGround > -9990.0f) {
            ...
            f6 *= f6;
            f6 = 1.0f - f6;
            float f7 = MathHelper.sin((float)(f6 * 3.1415927f));
        ...
        this.rightLeg.rotateAngleX += MathHelper.sin((float)(f * 0.4f)) * 1.2f * f1;
        this.leftLeg.rotateAngleX += MathHelper.sin((float)(f * 0.4f + 3.1415927f)) * 1.2f * f1;
        ...
        this.rightWing.rotateAngleY += MathHelper.cos((float)(f2 * 0.04f)) * 0.5f;
        this.leftWing.rotateAngleY -= MathHelper.cos((float)(f2 * 0.04f)) * 0.5f;
        this.tail.rotateAngleX = (float)Math.toRadians(-40.0);
        this.tail.rotateAngleY = 0.0f;
        this.tail.rotateAngleY += MathHelper.cos((float)(f2 * 0.05f)) * 0.15f;
        this.tail.rotateAngleY += MathHelper.sin((float)(f * 0.1f)) * 0.6f * f1;
    }
}
