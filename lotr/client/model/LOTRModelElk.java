...
extends ModelBase {
    ...
    public LOTRModelElk(float f) {
        ...
        ModelRenderer tail = new ModelRenderer((ModelBase)this, 0, 54);
        tail.addBox(-1.0f, -5.0f, 2.0f, 2, 2, 8, f);
        tail.rotateAngleX = (float)Math.toRadians(-60.0);
        this.body.addChild(tail);
        this.leg1 = new ModelRenderer((ModelBase)this, 42, 37);
        ...
        this.leg3 = new ModelRenderer((ModelBase)this, 0, 37);
        ...
        this.head = new ModelRenderer((ModelBase)this, 50, 0);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.head.rotateAngleX = (float)((double)this.head.rotateAngleX + Math.toRadians(f4));
        this.head.rotateAngleY = (float)((double)this.head.rotateAngleY + Math.toRadians(f3));
        this.head.rotateAngleX = antiRearAmount * this.head.rotateAngleX;
        this.head.rotateAngleY = antiRearAmount * this.head.rotateAngleY;
        if (f1 > 0.2f) {
            this.head.rotateAngleX += MathHelper.cos((float)(f * 0.3f)) * 0.1f * f1;
        }
        ...
        float legRotation = MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * f1;
        float f17 = -1.0471976f;
        float f18 = 0.2617994f * rearAmount;
        float f19 = MathHelper.cos((float)(f2 * 0.4f + 3.1415927f));
