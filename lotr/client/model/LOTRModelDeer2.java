...
extends ModelBase {
    ...
    public LOTRModelDeer2(float f) {
        ...
        this.tail = new ModelRenderer((ModelBase)this, 20, 58);
        ...
        ModelRenderer earRight = new ModelRenderer((ModelBase)this, 0, 22);
        ...
        ModelRenderer earLeft = new ModelRenderer((ModelBase)this, 0, 22);
        ...
        this.antlers = new ModelRenderer((ModelBase)this, 0, 0);
        this.antlers.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.head.addChild(this.antlers);
        ModelRenderer antlerRight1 = new ModelRenderer((ModelBase)this, 0, 33);
        ...
        ModelRenderer antlerRight2 = new ModelRenderer((ModelBase)this, 4, 33);
        ...
        ModelRenderer antlerLeft1 = new ModelRenderer((ModelBase)this, 0, 33);
        ...
        ModelRenderer antlerLeft2 = new ModelRenderer((ModelBase)this, 4, 33);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.leg3.rotateAngleX = MathHelper.cos((float)(f * 0.8f + 3.1415927f)) * f1 * 1.4f;
        this.leg4.rotateAngleX = MathHelper.cos((float)(f * 0.8f)) * f1 * 1.4f;
