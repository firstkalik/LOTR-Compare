...
extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.finRight.rotateAngleY += MathHelper.cos((float)(f2 * 0.5f + 3.1415927f)) * (float)Math.toRadians(10.0);
