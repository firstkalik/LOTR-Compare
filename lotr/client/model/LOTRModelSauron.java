...
public class LOTRModelSauron
extends LOTRModelBiped {
    private ModelRenderer bipedCape;

    public LOTRModelSauron() {
        this.bipedHead = new ModelRenderer((ModelBase)this, 0, 0).setTextureSize(64, 64);
        ...
        this.bipedBody = new ModelRenderer((ModelBase)this, 40, 42).setTextureSize(64, 64);
        this.bipedBody.addBox(-4.0f, 0.0f, -2.0f, 8, 18, 4);
        this.bipedBody.setRotationPoint(0.0f, -12.0f, 0.0f);
        this.bipedRightArm = new ModelRenderer((ModelBase)this, 0, 43).setTextureSize(64, 64);
        ...
        this.bipedLeftArm = new ModelRenderer((ModelBase)this, 0, 43).setTextureSize(64, 64);
        ...
        this.bipedRightLeg = new ModelRenderer((ModelBase)this, 0, 16).setTextureSize(64, 64);
        this.bipedRightLeg.addBox(-2.0f, 0.0f, -2.0f, 4, 18, 4);
        this.bipedRightLeg.setRotationPoint(-2.0f, 6.0f, 0.0f);
        this.bipedLeftLeg = new ModelRenderer((ModelBase)this, 0, 16).setTextureSize(64, 64);
        this.bipedLeftLeg.mirror = true;
        this.bipedLeftLeg.addBox(-2.0f, 0.0f, -2.0f, 4, 18, 4);
        this.bipedLeftLeg.setRotationPoint(2.0f, 6.0f, 0.0f);
        this.bipedCape = new ModelRenderer((ModelBase)this, 38, 0).setTextureSize(64, 64);
