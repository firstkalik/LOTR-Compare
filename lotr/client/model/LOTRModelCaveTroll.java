...
public class LOTRModelCaveTroll
extends ModelBase {
    ...
    public LOTRModelCaveTroll() {
        this(0.0f);
    }

    public LOTRModelCaveTroll(float f) {
        ...
        this.headHurt = new ModelRenderer((ModelBase)this, 48, 44);
        ...
        this.body = new ModelRenderer((ModelBase)this, 48, 0);
        ...
        this.rightLeg = new ModelRenderer((ModelBase)this, 0, 78);
        ...
        this.leftLeg = new ModelRenderer((ModelBase)this, 0, 78);
        ...
        this.woodenClub = new ModelRenderer((ModelBase)this, 0, 0);
        this.woodenClub.addBox(-9.0f, 5.0f, 21.0f, 6, 24, 6, f);
        this.woodenClub.setRotationPoint(-12.0f, -23.0f, 0.0f);
        this.woodenClubSpikes = new ModelRenderer((ModelBase)this, 24, 0);
        ...
        this.warhammer = new ModelRenderer((ModelBase)this, 52, 29);
        ...
        this.battleaxe = new ModelRenderer((ModelBase)this, 64, 0);
    ...
    public LOTRModelCaveTroll(float f, int i) {
        this(f);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (entity instanceof LOTREntityTroll && ((LOTREntityTroll)entity).sniffTime > 0) {
            f6 = ((float)((LOTREntityTroll)entity).sniffTime - (f2 - (float)entity.ticksExisted)) / 8.0f;
            this.head.rotateAngleY = MathHelper.sin((float)(f6 *= 6.2831855f)) * 0.5f;
        }
        this.rightArm.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 2.0f * f1 * 0.5f;
        ...
        if (this.onGround > -9990.0f) {
            f6 = this.onGround;
            this.body.rotateAngleY = MathHelper.sin((float)(MathHelper.sqrt_float((float)f6) * 3.1415927f * 2.0f)) * 0.2f;
            this.rightArm.rotationPointZ = MathHelper.sin((float)this.body.rotateAngleY) * 5.0f;
            this.rightArm.rotationPointX = -MathHelper.cos((float)this.body.rotateAngleY) * 12.0f;
            this.leftArm.rotationPointZ = -MathHelper.sin((float)this.body.rotateAngleY) * 5.0f;
            this.leftArm.rotationPointX = MathHelper.cos((float)this.body.rotateAngleY) * 12.0f;
        ...
        if (entity instanceof EntityLivingBase) {
            float f62 = MathHelper.sin((float)(f * 0.2f)) * 0.3f * f1;
            this.head.rotationPointX += MathHelper.sin((float)f62) * 27.0f;
            this.head.rotationPointY += 27.0f - MathHelper.cos((float)f62) * 27.0f;
            this.head.rotateAngleZ += f62;
            this.body.rotateAngleZ += f62;
            float armRotationOffsetX = MathHelper.sin((float)f62) * 23.0f + MathHelper.cos((float)f62) * 12.0f - 12.0f;
            float armRotationOffsetY = MathHelper.cos((float)f62) * -23.0f + MathHelper.sin((float)f62) * 12.0f + 23.0f;
