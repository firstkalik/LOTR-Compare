...
public class LOTRModelUnsmeltery
extends ModelBase {
    ...
    public LOTRModelUnsmeltery() {
        ...
        this.standRight = new ModelRenderer((ModelBase)this, 56, 6);
        this.standRight.setRotationPoint(-7.0f, 23.0f, 0.0f);
        this.standRight.addBox(-0.9f, -12.0f, -1.0f, 1, 12, 2);
        ModelRenderer panelRight = new ModelRenderer((ModelBase)this, 56, 0);
