...
public class LOTRModelSpider
extends ModelBase
implements LOTRGlowingEyes.Model {
    protected ModelRenderer head = new ModelRenderer((ModelBase)this, 32, 0);
    ...
    public LOTRModelSpider(float f) {
        ...
        this.leg3 = new ModelRenderer((ModelBase)this, 36, 16);
        ...
        this.leg5 = new ModelRenderer((ModelBase)this, 36, 16);
        ...
        this.leg7 = new ModelRenderer((ModelBase)this, 36, 16);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.abdomen.rotateAngleY = MathHelper.cos((float)(f * 0.6662f)) * 0.5f * f1;
        ...
        float f16 = Math.abs(MathHelper.sin((float)(f * 0.6662f + 4.712389f)) * 0.4f) * f1;
