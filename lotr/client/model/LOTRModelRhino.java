...
extends ModelBase {
    ...
    public LOTRModelRhino(float f) {
        ...
        this.tail = new ModelRenderer((ModelBase)this, 100, 63);
        this.tail.setRotationPoint(0.0f, 7.0f, 21.0f);
        this.tail.addBox(-1.5f, -1.0f, -1.0f, 3, 8, 2, f);
        this.leg1 = new ModelRenderer((ModelBase)this, 30, 76);
        ...
        this.leg2 = new ModelRenderer((ModelBase)this, 30, 76);
        ...
        this.leg3 = new ModelRenderer((ModelBase)this, 0, 76);
        ...
        this.leg4 = new ModelRenderer((ModelBase)this, 0, 76);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.isChild) {
            float f6 = 2.0f;
            GL11.glPushMatrix();
            GL11.glTranslatef((float)0.0f, (float)(8.0f * f5), (float)(12.0f * f5));
            this.head.render(f5);
            GL11.glPopMatrix();
            GL11.glPushMatrix();
            GL11.glScalef((float)(1.0f / f6), (float)(1.0f / f6), (float)(1.0f / f6));
            GL11.glTranslatef((float)0.0f, (float)(24.0f * f5), (float)(0.0f * f5));
            this.body.render(f5);
            this.tail.render(f5);
            this.leg1.render(f5);
            this.leg2.render(f5);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.head.rotateAngleX += MathHelper.cos((float)(f * 0.2f)) * 0.3f * f1;
        ...
        this.tail.rotateAngleX += MathHelper.cos((float)(f * 0.3f)) * 0.5f * f1;
        this.leg1.rotateAngleX = MathHelper.cos((float)(f * 0.4f)) * 1.0f * f1;
        this.leg2.rotateAngleX = MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * 1.0f * f1;
        this.leg3.rotateAngleX = MathHelper.cos((float)(f * 0.4f + 3.1415927f)) * 1.0f * f1;
        this.leg4.rotateAngleX = MathHelper.cos((float)(f * 0.4f)) * 1.0f * f1;
    }
}
