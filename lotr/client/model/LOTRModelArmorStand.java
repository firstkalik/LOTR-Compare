...
public class LOTRModelArmorStand
extends ModelBase {
    ...
    public LOTRModelArmorStand() {
        ...
        this.spine = new ModelRenderer((ModelBase)this, 60, 0);
        this.spine.addBox(-0.5f, 0.0f, -0.5f, 1, 25, 1);
        this.spine.setRotationPoint(0.0f, -3.0f, 0.0f);
        this.rightArm = new ModelRenderer((ModelBase)this, 44, 12);
        ...
        this.rightHip = new ModelRenderer((ModelBase)this, 42, 30);
        ...
        this.rightLeg = new ModelRenderer((ModelBase)this, 50, 23);
        ...
        this.rightFoot = new ModelRenderer((ModelBase)this, 54, 27);
