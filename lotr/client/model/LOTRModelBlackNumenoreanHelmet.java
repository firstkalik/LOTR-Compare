...
public class LOTRModelBlackNumenoreanHelmet
extends LOTRModelBiped {
    ...
    public LOTRModelBlackNumenoreanHelmet(float f) {
        ...
        ModelRenderer wingLeft = new ModelRenderer((ModelBase)this, 33, 0);
        ...
        ModelRenderer wingRight = new ModelRenderer((ModelBase)this, 33, 0);
