...
public class LOTRModelBird
extends ModelBase {
    public ModelRenderer body = new ModelRenderer((ModelBase)this, 0, 7);
    ...
    public LOTRModelBird() {
        ...
        this.wingRight = new ModelRenderer((ModelBase)this, 16, 7);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (bird.isBirdStill()) {
            ...
            this.wingRight.rotateAngleZ = bird.flapTime > 0 ? (float)Math.toRadians(90.0) + MathHelper.cos((float)(f2 * 1.5f)) * (float)Math.toRadians(30.0) : (float)Math.toRadians(30.0);
            ...
            this.legRight.rotateAngleX += MathHelper.cos((float)(f * 0.6662f)) * f1;
            this.legLeft.rotateAngleX += MathHelper.cos((float)(f * 0.6662f + 3.141593f)) * f1;
            this.legRight.rotationPointY = 1.0f;
            this.legLeft.rotationPointY = 1.0f;
        } else {
            this.body.rotateAngleX = 0.0f;
            this.head.rotateAngleX = 0.0f;
            this.wingRight.rotateAngleZ = (float)Math.toRadians(90.0) + MathHelper.cos((float)(f2 * 1.5f)) * (float)Math.toRadians(30.0);
            this.wingLeft.rotateAngleZ = -this.wingRight.rotateAngleZ;
