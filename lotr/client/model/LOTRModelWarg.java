...
implements LOTRGlowingEyes.Model {
    ...
    public LOTRModelWarg(float f) {
        ...
        this.tail = new ModelRenderer((ModelBase)this, 98, 55).setTextureSize(128, 64);
        this.tail.addBox(-1.0f, -1.0f, 0.0f, 2, 1, 8, f);
        this.tail.setRotationPoint(0.0f, 4.0f, 18.0f);
        this.head = new ModelRenderer((ModelBase)this, 92, 0).setTextureSize(128, 64);
        ...
        this.leg2 = new ModelRenderer((ModelBase)this, 62, 0).setTextureSize(128, 64);
        ...
        this.leg4 = new ModelRenderer((ModelBase)this, 62, 0).setTextureSize(128, 64);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.leg1.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 0.9f * f1;
        this.leg2.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 0.9f * f1;
        this.leg3.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 0.9f * f1;
        this.leg4.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 0.9f * f1;
