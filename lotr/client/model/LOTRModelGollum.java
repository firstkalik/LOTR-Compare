...
public class LOTRModelGollum
extends ModelBase {
    public ModelRenderer head = new ModelRenderer((ModelBase)this, 0, 0);
    ...
    public LOTRModelGollum() {
        ...
        this.body = new ModelRenderer((ModelBase)this, 20, 17);
        ...
        this.rightShoulder = new ModelRenderer((ModelBase)this, 0, 23);
        ...
        this.rightArm = new ModelRenderer((ModelBase)this, 12, 22);
        ...
        this.rightThigh = new ModelRenderer((ModelBase)this, 0, 23);
        ...
        this.rightLeg = new ModelRenderer((ModelBase)this, 12, 22);
        this.rightLeg.addBox(0.0f, 4.0f, -2.5f, 2, 8, 2);
        this.rightLeg.setRotationPoint(2.0f, 12.0f, 4.0f);
        this.leftThigh = new ModelRenderer((ModelBase)this, 0, 23);
        ...
        this.leftLeg = new ModelRenderer((ModelBase)this, 12, 22);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (((LOTREntityGollum)entity).isGollumSitting()) {
            float f6 = f2 / 20.0f;
            this.rightArm.rotateAngleX = MathHelper.sin((float)(f6 *= 6.2831855f)) * 3.0f;
            this.leftArm.rotateAngleX = MathHelper.sin((float)f6) * -3.0f;
            this.rightLeg.rotateAngleX = MathHelper.sin((float)f6) * 0.5f;
            this.leftLeg.rotateAngleX = MathHelper.sin((float)f6) * -0.5f;
        } else if (((LOTREntityGollum)entity).isGollumFleeing()) {
            this.rightArm.rotateAngleX += 3.1415927f;
            this.leftArm.rotateAngleX += 3.1415927f;
        }
        this.body.rotateAngleZ = MathHelper.cos((float)(f * 0.6662f)) * 0.25f * f1;
