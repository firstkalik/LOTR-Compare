...
extends ModelBiped {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        this.bipedRightArm.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 2.0f * f1 * 0.5f;
        this.bipedLeftArm.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 2.0f * f1 * 0.5f;
        this.bipedRightArm.rotateAngleZ = 0.0f;
        this.bipedLeftArm.rotateAngleZ = 0.0f;
        this.bipedRightLeg.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 1.4f * f1;
        this.bipedLeftLeg.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 1.4f * f1;
        ...
        if (this.onGround > -9990.0f) {
            ...
            this.bipedRightArm.rotationPointZ = MathHelper.sin((float)this.bipedBody.rotateAngleY) * this.base_armX;
            this.bipedRightArm.rotationPointX = -MathHelper.cos((float)this.bipedBody.rotateAngleY) * this.base_armX;
            this.bipedLeftArm.rotationPointZ = -MathHelper.sin((float)this.bipedBody.rotateAngleY) * this.base_armX;
            this.bipedLeftArm.rotationPointX = MathHelper.cos((float)this.bipedBody.rotateAngleY) * this.base_armX;
        ...
        this.bipedRightArm.rotateAngleZ += MathHelper.cos((float)(f2 * 0.09f)) * 0.05f + 0.05f;
        this.bipedLeftArm.rotateAngleZ -= MathHelper.cos((float)(f2 * 0.09f)) * 0.05f + 0.05f;
        this.bipedRightArm.rotateAngleX += MathHelper.sin((float)(f2 * 0.067f)) * 0.05f;
        this.bipedLeftArm.rotateAngleX -= MathHelper.sin((float)(f2 * 0.067f)) * 0.05f;
        if (this.aimedBow) {
            f6 = 0.0f;
            f7 = 0.0f;
            this.bipedRightArm.rotateAngleZ = 0.0f;
        ...
        if (entity instanceof LOTREntityNPC && (npc = (LOTREntityNPC)entity).isDrunkard()) {
            ...
            float f8 = MathHelper.sin((float)(f62 *= 6.2831855f)) * 0.5f;
            float f9 = MathHelper.sin((float)(f72 *= 6.2831855f)) * 0.5f;
        ...
        if (bowing) {
            ...
            float bowCos = MathHelper.cos((float)bowAmountRad);
            float bowSin = MathHelper.sin((float)bowAmountRad);
