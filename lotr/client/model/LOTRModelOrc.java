...
public class LOTRModelOrc
extends LOTRModelBiped
implements LOTRGlowingEyes.Model {
    private ModelRenderer nose = new ModelRenderer((ModelBase)this, 14, 17);
    ...
    public LOTRModelOrc(float f) {
        ...
        this.earRight = new ModelRenderer((ModelBase)this, 0, 0);
        ...
        this.earLeft = new ModelRenderer((ModelBase)this, 24, 0);
