...
public class LOTRModelFlamingo
extends ModelBase {
    private ModelRenderer head = new ModelRenderer((ModelBase)this, 8, 24);
    ...
    public LOTRModelFlamingo() {
        ...
        this.legRight = new ModelRenderer((ModelBase)this, 30, 0);
        ...
        this.head_child = new ModelRenderer((ModelBase)this, 0, 24);
        ...
        this.legRight_child = new ModelRenderer((ModelBase)this, 27, 0);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if (this.isChild) {
            ...
            this.legLeft_child.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 0.9f * f1;
            this.legRight_child.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 0.9f * f1;
            ...
            this.legLeft.rotateAngleX = MathHelper.cos((float)(f * 0.6662f)) * 0.9f * f1;
            this.legRight.rotateAngleX = MathHelper.cos((float)(f * 0.6662f + 3.1415927f)) * 0.9f * f1;
