...
public class LOTRTextBody {
    ...
    public void set(int i, String s) {
        this.list.get((int)i).text = s;
    }

    public void set(int i, String s, int c) {
        this.list.get((int)i).text = s;
        this.list.get((int)i).color = c;
    }

    public String getText(int i) {
        return this.list.get((int)i).text;
    }

    public int getColor(int i) {
        return this.list.get((int)i).color;
    }
    ...
    public float renderAndReturnScroll(FontRenderer fr, int x, int yTop, int yBottom, float scroll) {
        ...
        scroll = Math.min(scroll, (float)(numLines - MathHelper.floor_double((double)((float)ySize / (float)lineHeight))));
