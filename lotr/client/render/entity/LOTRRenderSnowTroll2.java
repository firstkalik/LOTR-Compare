...
public class LOTRRenderSnowTroll2
extends LOTRRenderTroll {
    private static LOTRRandomSkins mountainTrollSkins;
    private LOTREntityThrownRock2 heldRock;

    public LOTRRenderSnowTroll2() {
        mountainTrollSkins = LOTRRandomSkins.loadSkinsList("lotr:mob/troll/snowTroll");
    }
    ...
    protected void renderTrollWeapon(EntityLivingBase entity, float f) {
        LOTREntityMountainSnowTroll troll = (LOTREntityMountainSnowTroll)entity;
