...
extends LOTRGuiMenuBase {
    ...
    public void initGui() {
        ...
        this.buttonCreate = new GuiButton(0, midX - 100, this.guiTop + 230, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.create"));
        this.buttonList.add(this.buttonCreate);
        this.buttonCreateThis = new GuiButton(1, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.createThis"));
        this.buttonList.add(this.buttonCreateThis);
        this.buttonInvitePlayer = new LOTRGuiButtonFsOption(2, midX, this.guiTop + 232, 0, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.invite"));
        this.buttonList.add(this.buttonInvitePlayer);
        this.buttonInviteThis = new GuiButton(3, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.inviteThis"));
        this.buttonList.add(this.buttonInviteThis);
        this.buttonDisband = new LOTRGuiButtonFsOption(4, midX, this.guiTop + 232, 16, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.disband"));
        this.buttonList.add(this.buttonDisband);
        this.buttonDisbandThis = new GuiButton(5, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.disbandThis"));
        this.buttonList.add(this.buttonDisbandThis);
        this.buttonLeave = new GuiButton(6, midX - 60, this.guiTop + 230, 120, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.leave"));
        this.buttonList.add(this.buttonLeave);
        this.buttonLeaveThis = new GuiButton(7, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.leaveThis"));
        this.buttonList.add(this.buttonLeaveThis);
        this.buttonSetIcon = new LOTRGuiButtonFsOption(8, midX, this.guiTop + 232, 48, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.setIcon"));
        this.buttonList.add(this.buttonSetIcon);
        this.buttonRemove = new GuiButton(9, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.remove"));
        this.buttonList.add(this.buttonRemove);
        this.buttonTransfer = new GuiButton(10, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.transfer"));
        this.buttonList.add(this.buttonTransfer);
        this.buttonRename = new LOTRGuiButtonFsOption(11, midX, this.guiTop + 232, 32, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.rename"));
        this.buttonList.add(this.buttonRename);
        this.buttonRenameThis = new GuiButton(12, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.renameThis"));
        ...
        this.buttonPVP = new LOTRGuiButtonFsOption(15, midX, this.guiTop + 232, 64, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.togglePVP"));
        this.buttonList.add(this.buttonPVP);
        this.buttonHiredFF = new LOTRGuiButtonFsOption(16, midX, this.guiTop + 232, 80, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.toggleHiredFF"));
        this.buttonList.add(this.buttonHiredFF);
        this.buttonMapShow = new LOTRGuiButtonFsOption(17, midX, this.guiTop + 232, 96, 48, StatCollector.translateToLocal((String)"lotr.gui.fellowships.toggleMapShow"));
        this.buttonList.add(this.buttonMapShow);
        this.buttonOp = new GuiButton(18, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.op"));
        this.buttonList.add(this.buttonOp);
        this.buttonDeop = new GuiButton(19, midX - 100, this.guiTop + 170, 200, 20, StatCollector.translateToLocal((String)"lotr.gui.fellowships.deop"));
    ...
    private void refreshFellowshipList() {
        ...
        ArrayList<LOTRFellowshipClient> fellowships = new ArrayList<LOTRFellowshipClient>(LOTRLevelData.getData((EntityPlayer)this.mc.thePlayer).getClientFellowships());
        ...
        this.allFellowshipInvites.addAll(LOTRLevelData.getData((EntityPlayer)this.mc.thePlayer).getClientFellowshipInvites());
    }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        String s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.title");
        ...
        if (this.page == Page.LIST) {
            ...
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.leading");
            ...
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.member");
            this.drawCenteredString(s, this.guiLeft + this.xSize / 2, y, 16777215);
            y += this.fontRendererObj.FONT_HEIGHT + 10;
            ...
            if (this.buttonInvites.func_146115_a()) {
                this.renderIconTooltip(i, j, StatCollector.translateToLocal((String)"lotr.gui.fellowships.invitesTooltip"));
            }
            if (!canCreateNew && this.buttonCreate.func_146115_a()) {
                s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.createLimit");
            ...
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.createName");
            ...
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.nameAndPlayers", (Object[])new Object[]{this.viewingFellowship.getName(), this.viewingFellowship.getMemberCount()});
            this.drawCenteredString(s, this.guiLeft + this.xSize / 2, y, 16777215);
            ...
            if (i >= iconPVPX && i < iconPVPX + iconSize && j >= iconY && j < iconY + iconSize) {
                this.renderIconTooltip(i, j, StatCollector.translateToLocal((String)(preventPVP ? "lotr.gui.fellowships.pvp.prevent" : "lotr.gui.fellowships.pvp.allow")));
            }
            if (i >= iconHFFX && i < iconHFFX + iconSize && j >= iconY && j < iconY + iconSize) {
                this.renderIconTooltip(i, j, StatCollector.translateToLocal((String)(preventHiredFF ? "lotr.gui.fellowships.hiredFF.prevent" : "lotr.gui.fellowships.hiredFF.allow")));
            }
            if (i >= iconMapX && i < iconMapX + iconSize && j >= iconY && j < iconY + iconSize) {
                this.renderIconTooltip(i, j, StatCollector.translateToLocal((String)(mapShow ? "lotr.gui.fellowships.mapShow.on" : "lotr.gui.fellowships.mapShow.off")));
            }
            y += iconSize;
            y += 10;
            int titleOffset = 0;
            ...
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.inviteName", (Object[])new Object[]{this.viewingFellowship.getName()});
            ...
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.disbandCheck1", (Object[])new Object[]{this.viewingFellowship.getName()});
            this.drawCenteredString(s, x, y, 16777215);
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.disbandCheck2");
            this.drawCenteredString(s, x, y += this.fontRendererObj.FONT_HEIGHT, 16777215);
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.disbandCheck3");
            this.drawCenteredString(s, x, y += this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
            y += this.fontRendererObj.FONT_HEIGHT;
        } else if (this.page == Page.LEAVE) {
            int x = this.guiLeft + this.xSize / 2;
            int y = this.guiTop + 30;
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.leaveCheck1", (Object[])new Object[]{this.viewingFellowship.getName()});
            this.drawCenteredString(s, x, y, 16777215);
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.leaveCheck2");
            this.drawCenteredString(s, x, y += this.fontRendererObj.FONT_HEIGHT, 16777215);
            y += this.fontRendererObj.FONT_HEIGHT * 2;
        } else if (this.page == Page.REMOVE) {
            int x = this.guiLeft + this.xSize / 2;
            int y = this.guiTop + 30;
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.removeCheck", (Object[])new Object[]{this.viewingFellowship.getName(), this.removingPlayer});
            List lines = this.fontRendererObj.listFormattedStringToWidth(s, this.xSize);
            ...
            int x = this.guiLeft + this.xSize / 2;
            int y = this.guiTop + 30;
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.opCheck1", (Object[])new Object[]{this.viewingFellowship.getName(), this.oppingPlayer});
            List lines = this.fontRendererObj.listFormattedStringToWidth(s, this.xSize);
            for (String line : lines) {
                this.drawCenteredString(line, x, y, 16777215);
                y += this.fontRendererObj.FONT_HEIGHT;
            ...
            y += this.fontRendererObj.FONT_HEIGHT;
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.opCheck2", (Object[])new Object[]{this.viewingFellowship.getName(), this.oppingPlayer});
            ...
            int x = this.guiLeft + this.xSize / 2;
            int y = this.guiTop + 30;
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.deopCheck", (Object[])new Object[]{this.viewingFellowship.getName(), this.deoppingPlayer});
            List lines = this.fontRendererObj.listFormattedStringToWidth(s, this.xSize);
            for (String line : lines) {
                this.drawCenteredString(line, x, y, 16777215);
                y += this.fontRendererObj.FONT_HEIGHT;
            ...
            int x = this.guiLeft + this.xSize / 2;
            int y = this.guiTop + 30;
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.transferCheck1", (Object[])new Object[]{this.viewingFellowship.getName(), this.transferringPlayer});
            List lines = this.fontRendererObj.listFormattedStringToWidth(s, this.xSize);
            for (String line : lines) {
                this.drawCenteredString(line, x, y, 16777215);
                y += this.fontRendererObj.FONT_HEIGHT;
            }
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.transferCheck2");
            this.drawCenteredString(s, x, y += this.fontRendererObj.FONT_HEIGHT, 16777215);
            y += this.fontRendererObj.FONT_HEIGHT;
        } else if (this.page == Page.RENAME) {
            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.renameName", (Object[])new Object[]{this.viewingFellowship.getName()});
            ...
            int x = this.guiLeft;
            int y = this.guiTop + 10;
            s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.invites");
            this.drawCenteredString(s, this.guiLeft + this.xSize / 2, y, 16777215);
            y += this.fontRendererObj.FONT_HEIGHT + 10;
            if (this.allFellowshipInvites.isEmpty()) {
                s = StatCollector.translateToLocal((String)"lotr.gui.fellowships.invitesNone");
    ...
    private void drawFellowshipIcon(LOTRFellowshipClient fsClient, int x, int y, float scale) {
        ...
        if (fsIcon != null) {
            ...
            renderItem.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), fsIcon, Math.round((float)x / scale), Math.round((float)y / scale));
            GL11.glPopMatrix();
            GL11.glDisable((int)2896);
        }
    }
    ...
    private String checkValidFellowshipName(String name) {
        if (!StringUtils.isWhitespace((CharSequence)name)) {
            if (LOTRLevelData.getData((EntityPlayer)this.mc.thePlayer).anyMatchingFellowshipNames(name, true)) {
                return StatCollector.translateToLocal((String)"lotr.gui.fellowships.nameExists");
            }
            return null;
        }
        return "";
    ...
    private String checkValidPlayerName(String name) {
        if (!StringUtils.isWhitespace((CharSequence)name)) {
            if (this.viewingFellowship.isPlayerIn(name)) {
                return StatCollector.translateToLocalFormatted((String)"lotr.gui.fellowships.playerExists", (Object[])new Object[]{name});
            }
            return null;
        }
        return "";
