...
public class LOTRGuiCapeArrows2
extends GuiButton {
    public LOTRGuiCapeArrows2(int p_i1020_1_, int p_i1020_2_, int p_i1020_3_, String p_i1020_4_) {
        this(p_i1020_1_, p_i1020_2_, p_i1020_3_, 200, 20, p_i1020_4_);
    }

    public LOTRGuiCapeArrows2(int id, int x, int y, int w, int h, String s) {
        super(id, x, y, w, h, s);
        this.width = 200;
        this.height = 20;
        this.enabled = true;
