...
public class LOTRGuiNPCRespawner
extends LOTRGuiScreenBase {
    ...
    public void initGui() {
        ...
        this.sliderCheckHorizontal = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 180, this.guiTop + 70, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.checkHorizontal"));
        ...
        this.sliderCheckVerticalMin = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 180, this.guiTop + 95, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.checkVerticalMin"));
        ...
        this.sliderCheckVerticalMax = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 180, this.guiTop + 120, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.checkVerticalMax"));
        ...
        this.sliderSpawnCap = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 180, this.guiTop + 145, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnCap"));
        ...
        this.sliderBlockEnemy = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 180, this.guiTop + 170, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.blockEnemy"));
        ...
        this.sliderSpawnHorizontal = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 + 20, this.guiTop + 70, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnHorizontal"));
        ...
        this.sliderSpawnVerticalMin = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 + 20, this.guiTop + 95, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnVerticalMin"));
        ...
        this.sliderSpawnVerticalMax = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 + 20, this.guiTop + 120, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnVerticalMax"));
        ...
        this.sliderHomeRange = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 + 20, this.guiTop + 145, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.homeRange"));
        ...
        this.buttonMounts = new LOTRGuiButtonOptions(0, this.guiLeft + this.xSize / 2 + 20, this.guiTop + 170, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.mounts"));
        this.buttonList.add(this.buttonMounts);
        this.sliderSpawnIntervalM = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 100 - 5, this.guiTop + 195, 100, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnIntervalM"));
        ...
        this.sliderSpawnIntervalS = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 + 5, this.guiTop + 195, 100, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnIntervalS"));
        ...
        this.sliderNoPlayerRange = new LOTRGuiSlider(0, this.guiLeft + this.xSize / 2 - 80, this.guiTop + 220, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.noPlayerRange"));
        ...
        this.buttonDestroy = new GuiButton(0, this.guiLeft + this.xSize / 2 - 50, this.guiTop + 255, 100, 20, StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.destroy"));
        this.buttonList.add(this.buttonDestroy);
    }

    public void drawScreen(int i, int j, float f) {
        this.drawDefaultBackground();
        String s = StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.title");
        ...
        s = StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnClass1");
        ...
        s = StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnClass2");
        ...
        if (this.theSpawner.mountSetting == 0) {
            this.buttonMounts.setState(StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.mounts.0"));
        } else if (this.theSpawner.mountSetting == 1) {
            this.buttonMounts.setState(StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.mounts.1"));
        } else {
            this.buttonMounts.setState(StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.mounts.2"));
        }
        if (!this.theSpawner.blockEnemySpawns()) {
            this.sliderBlockEnemy.setOverrideStateString(StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.blockEnemy.off"));
        } else {
            this.sliderBlockEnemy.setOverrideStateString(null);
        }
        if (!this.theSpawner.hasHomeRange()) {
            this.sliderHomeRange.setOverrideStateString(StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.homeRange.off"));
        } else {
            this.sliderHomeRange.setOverrideStateString(null);
        }
        String timepre = StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.spawnInterval");
        ...
        if (this.sliderBlockEnemy.enabled && this.sliderBlockEnemy.func_146115_a() && !this.sliderBlockEnemy.dragging) {
            String tooltip = StatCollector.translateToLocal((String)"lotr.gui.npcRespawner.blockEnemy.tooltip");
            int border = 3;
