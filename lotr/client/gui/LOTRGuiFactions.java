...
import lotr.client.gui.LOTRGuiButtonFactionsMap;
import lotr.client.gui.LOTRGuiButtonFactionsPage;
import lotr.client.gui.LOTRGuiButtonPledge;
...
extends LOTRGuiMenuBase {
    ...
    public void initGui() {
        ...
        prevDimension = currentDimension = LOTRDimension.getCurrentDimensionWithFallback((World)this.mc.theWorld);
        this.currentFaction = LOTRLevelData.getData((EntityPlayer)this.mc.thePlayer).getViewingFaction();
        prevRegion = currentRegion = this.currentFaction.factionRegion;
        currentFactionList = LOTRGuiFactions.currentRegion.factionList;
        this.prevFactionIndex = this.currentFactionIndex = currentFactionList.indexOf((Object)this.currentFaction);
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (!this.isPledging && !this.isUnpledging) {
            ...
            if (!this.isOtherPlayer && currentPage == Page.FRONT) {
                if (clientPD.isPledgedTo(this.currentFaction)) {
                    ...
                    this.buttonPledge.setDisplayLines(StatCollector.translateToLocal((String)"lotr.gui.factions.unpledge"));
                } else {
                    ...
                    String desc1 = StatCollector.translateToLocal((String)"lotr.gui.factions.pledge");
                    String desc2 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pledgeReq", (Object[])new Object[]{LOTRAlignmentValues.formatAlignForDisplay(this.currentFaction.getPledgeAlignment())});
            ...
            if (this.isPledging) {
                ...
                this.buttonPledgeConfirm.setDisplayLines(StatCollector.translateToLocal((String)"lotr.gui.factions.pledge"));
                this.buttonPledgeRevoke.enabled = false;
                this.buttonPledgeRevoke.visible = false;
                ...
                this.buttonPledgeRevoke.setDisplayLines(StatCollector.translateToLocal((String)"lotr.gui.factions.unpledge"));
            }
        }
        ...
        String title = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.title", (Object[])new Object[]{currentDimension.getDimensionName()});
        if (this.isOtherPlayer) {
            title = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.titleOther", (Object[])new Object[]{this.otherPlayerName});
        }
        ...
        if (this.currentFaction != null) {
            float alignment = this.isOtherPlayer && this.playerAlignmentMap != null ? this.playerAlignmentMap.get((Object)this.currentFaction).floatValue() : clientPD.getAlignment(this.currentFaction);
            ...
            if (!this.isPledging && !this.isUnpledging) {
                ...
                if (currentPage == Page.FRONT) {
                    if (this.isOtherPlayer) {
                        s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pageOther", (Object[])new Object[]{this.otherPlayerName});
                        this.fontRendererObj.drawString(s, x, y, 8019267);
                        y += this.fontRendererObj.FONT_HEIGHT * 2;
                    }
                    String alignmentInfo = StatCollector.translateToLocal((String)"lotr.gui.factions.alignment");
                    ...
                    rankName = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.alignment.state", (Object[])new Object[]{rankName});
                    ...
                    if (!this.isOtherPlayer) {
                        ...
                        if (alignment >= 0.0f) {
                            float conq;
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.data.enemiesKilled", (Object[])new Object[]{factionData.getEnemiesKilled()});
                            this.fontRendererObj.drawString(s, x, y, 8019267);
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.data.trades", (Object[])new Object[]{factionData.getTradeCount()});
                            this.fontRendererObj.drawString(s, x, y += this.fontRendererObj.FONT_HEIGHT, 8019267);
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.data.hires", (Object[])new Object[]{factionData.getHireCount()});
                            this.fontRendererObj.drawString(s, x, y += this.fontRendererObj.FONT_HEIGHT, 8019267);
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.data.miniquests", (Object[])new Object[]{factionData.getMiniQuestsCompleted()});
                            this.fontRendererObj.drawString(s, x, y += this.fontRendererObj.FONT_HEIGHT, 8019267);
                            ...
                            if (clientPD.isPledgedTo(this.currentFaction) && (conq = factionData.getConquestEarned()) != 0.0f) {
                                ...
                                s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.data.conquest", (Object[])new Object[]{conqInt});
                                this.fontRendererObj.drawString(s, x, y, 8019267);
                                y += this.fontRendererObj.FONT_HEIGHT;
                            }
                        }
                        if (alignment <= 0.0f) {
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.data.npcsKilled", (Object[])new Object[]{factionData.getNPCsKilled()});
                            this.fontRendererObj.drawString(s, x, y, 8019267);
                            y += this.fontRendererObj.FONT_HEIGHT;
                        }
                        if (this.buttonPledge.visible && clientPD.isPledgedTo(this.currentFaction)) {
                            s = StatCollector.translateToLocal((String)"lotr.gui.factions.pledged");
                    ...
                    for (index = minMax[0]; index <= minMax[1]; ++index) {
                        ...
                        if (listObj instanceof String) {
                            ...
                            if (!clientPD.isPledgedTo(this.currentFaction) && rank.alignment > this.currentFaction.getPledgeAlignment() && rank.alignment > this.currentFaction.getRankAbove((LOTRFactionRank)curRank).alignment) {
                                hiddenRankName = true;
                            }
                            if (hiddenRankName) {
                                rankName = StatCollector.translateToLocal((String)"lotr.gui.factions.rank?");
                            }
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.listRank", (Object[])new Object[]{rankName, rankAlign});
                            if (rank == curRank) {
                    ...
                    for (index = minMax[0]; index <= minMax[1]; ++index) {
                        ...
                        if (listObj instanceof LOTRFactionRelations.Relation) {
                            LOTRFactionRelations.Relation rel = (LOTRFactionRelations.Relation)((Object)listObj);
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.relationHeader", (Object[])new Object[]{rel.getDisplayName()});
                            this.fontRendererObj.drawString(s, x, y, 8019267);
                        } else if (listObj instanceof LOTRFaction) {
                            LOTRFaction fac = (LOTRFaction)((Object)listObj);
                            s = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.list", (Object[])new Object[]{fac.factionName()});
                    ...
                    if (facsPreventingPledge.isEmpty()) {
                        if (clientPD.canMakeNewPledge()) {
                            if (clientPD.canPledgeTo(this.currentFaction)) {
                                String desc2 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pledgeDesc1", (Object[])new Object[]{this.currentFaction.factionName()});
                                displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc2, stringWidth2));
                                displayLines.add("");
                                desc2 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pledgeDesc2", (Object[])new Object[0]);
                                displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc2, stringWidth2));
                            }
                        } else {
                            LOTRFaction brokenPledge = clientPD.getBrokenPledgeFaction();
                            String brokenPledgeName = brokenPledge == null ? StatCollector.translateToLocal((String)"lotr.gui.factions.pledgeUnknown") : brokenPledge.factionName();
                            String desc3 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pledgeBreakCooldown", (Object[])new Object[]{this.currentFaction.factionName(), brokenPledgeName});
                            ...
                            this.drawTexturedModalRect(this.guiLeft + this.pageWidth / 2 - 75, this.guiTop + this.pageY + 60, 22, 232, MathHelper.ceiling_float_int((float)(cdFrac * 150.0f)), 8);
                        }
                    } else {
                        ...
                        if (facsPreventingPledge.size() == 1) {
                            facNames = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.enemies1", (Object[])new Object[]{facsPreventingPledge.get(0).factionName()});
                        } else if (facsPreventingPledge.size() == 2) {
                            facNames = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.enemies2", (Object[])new Object[]{facsPreventingPledge.get(0).factionName(), facsPreventingPledge.get(1).factionName()});
                        } else if (facsPreventingPledge.size() == 3) {
                            facNames = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.enemies3", (Object[])new Object[]{facsPreventingPledge.get(0).factionName(), facsPreventingPledge.get(1).factionName(), facsPreventingPledge.get(2).factionName()});
                        } else if (facsPreventingPledge.size() > 3) {
                            facNames = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.enemies3+", (Object[])new Object[]{facsPreventingPledge.get(0).factionName(), facsPreventingPledge.get(1).factionName(), facsPreventingPledge.get(2).factionName(), facsPreventingPledge.size() - 3});
                        }
                        String desc4 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pledgeEnemies", (Object[])new Object[]{this.currentFaction.factionName(), facNames});
                        displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc4, stringWidth2));
                        displayLines.add("");
                    }
                } else if (this.isUnpledging) {
                    String desc5 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.unpledgeDesc1", (Object[])new Object[]{this.currentFaction.factionName()});
                    displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc5, stringWidth2));
                    displayLines.add("");
                    desc5 = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.unpledgeDesc2", (Object[])new Object[0]);
                    displayLines.addAll(this.fontRendererObj.listFormattedStringToWidth(desc5, stringWidth2));
                }
        ...
        if (this.hasScrollBar()) {
            ...
            for (int index = 0; index < factions; ++index) {
                ...
                float minU = (float)(0 + this.scrollBarBorder) / 256.0f;
                float maxU = (float)(0 + this.scrollBarWidth - this.scrollBarBorder) / 256.0f;
                ...
                tessellator.addVertexWithUV((double)xMin, (double)yMax, (double)this.zLevel, (double)minU, (double)maxV);
                tessellator.addVertexWithUV((double)xMax, (double)yMax, (double)this.zLevel, (double)maxU, (double)maxV);
                tessellator.addVertexWithUV((double)xMax, (double)yMin, (double)this.zLevel, (double)maxU, (double)minV);
                tessellator.addVertexWithUV((double)xMin, (double)yMin, (double)this.zLevel, (double)minU, (double)minV);
                tessellator.draw();
            }
            this.mc.getTextureManager().bindTexture(factionsTexture);
            GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        ...
        if (this.buttonFactionMap.enabled && this.buttonFactionMap.func_146115_a()) {
            float z = this.zLevel;
            String s = StatCollector.translateToLocal((String)"lotr.gui.factions.viewMap");
            stringWidth = 200;
        ...
        if (mouseOverAlignLock) {
            ...
            String lockDesc = StatCollector.translateToLocalFormatted((String)"lotr.gui.factions.pledgeLocked", (Object[])new Object[]{alignLimit, clientPD.getPledgeFaction().factionName()});
        ...
        if (mouseOverWarCrimes) {
            ...
            warCrimes = StatCollector.translateToLocal((String)warCrimes);
            stringWidth = 200;
    ...
    private void setupScrollBar(int i, int j) {
        ...
        if (currentPage == Page.ALLIES || currentPage == Page.ENEMIES || currentPage == Page.RANKS) {
            if (currentPage == Page.ALLIES) {
                ...
                this.currentAlliesEnemies = new ArrayList();
                this.currentAlliesEnemies.add(StatCollector.translateToLocal((String)"lotr.gui.factions.rankHeader"));
                if (LOTRLevelData.getData((EntityPlayer)this.mc.thePlayer).getAlignment(this.currentFaction) <= 0.0f) {
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button == this.buttonRegions) {
                ...
                this.mc.displayGuiScreen((GuiScreen)factionGuiMap);
            } else if (button == this.buttonPledge) {
                if (LOTRLevelData.getData((EntityPlayer)this.mc.thePlayer).isPledgedTo(this.currentFaction)) {
