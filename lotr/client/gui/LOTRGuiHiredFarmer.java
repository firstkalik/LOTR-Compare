...
extends LOTRGuiHiredNPC {
    ...
    public void initGui() {
        super.initGui();
        this.buttonGuardMode = new LOTRGuiButtonOptions(0, this.guiLeft + this.xSize / 2 - 80, this.guiTop + 70, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.farmer.mode"));
        this.buttonList.add(this.buttonGuardMode);
        this.buttonGuardMode.setState(this.theNPC.hiredNPCInfo.isGuardMode());
        this.sliderGuardRange = new LOTRGuiSlider(1, this.guiLeft + this.xSize / 2 - 80, this.guiTop + 94, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.farmer.range"));
        ...
        this.buttonList.add(new LOTRGuiButtonOptions(2, this.guiLeft + this.xSize / 2 - 80, this.guiTop + 142, 160, 20, StatCollector.translateToLocal((String)"lotr.gui.farmer.openInv")));
    }
