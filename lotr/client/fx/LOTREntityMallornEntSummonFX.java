...
public class LOTREntityMallornEntSummonFX
extends EntityDiggingFX {
    ...
    private void updateArcPos() {
        ...
        double[] posA = new double[]{this.summoner.posX, this.summoner.boundingBox.minY + (double)this.summoner.height * 0.7, this.summoner.posZ};
        double[] posC = new double[]{this.summoned.posX, this.summoned.boundingBox.minY + (double)this.summoned.height * 0.7, this.summoned.posZ};
